...
* [Los Términos de Servicio de GitHub](#los-términos-de-servicio-de-github)

* [A. Definiciones](#a-definiciones)

* [B. Términos de la Cuenta](#b-términos-de-la-cuenta)

* [C. Uso aceptable](#c-uso-aceptable)

* [D. Contenido Generado por el Usuario](#d-contenido-generado-por-el-usuario)

* [E. Repositorios Privados](#e-repositorios-privados)

* [F. Infracción de Derechos de Autor y Directiva de DMCA](#f-infracción-de-derechos-de-autor-y-directiva-de-dmca)

* [G. Aviso de Propiedad Intelectual](#g-aviso-de-propiedad-intelectual)

* [H. Términos de la API](#h-términos-de-la-api)

* [I. Términos Adicionales para los Productos de GitHub](#i-términos-adicionales-para-los-productos-de-github)

* [J. Versiones Preliminares Beta](#j-versiones-preliminares-beta)

* [K. Pago](#k-pago)

* [L. Cancelación y Resolución](#l-cancelación-y-resolución)

* [M. Comunicaciones con GitHub](#m-comunicaciones-con-github)

* [N. Renuncia de Garantías](#n-renuncia-de-garantías)

* [O. Limitación de Responsabilidad](#o-limitación-de-responsabilidad)

* [P. Liberación e Indemnización](#p-liberación-e-indemnización)

* [Q. Modificaciones de estos Términos](#q-modificaciones-de-estos-términos)

* [R. Disposiciones adicionales](#r-disposiciones-adicionales)
...
### [](#2-información-requerida)[]()2. Información Requerida ###
...
### [](#3-requisitos-de-la-cuenta)[]()3. Requisitos de la Cuenta ###
...
### [](#5-términos-adicionales)[]()5. Términos Adicionales ###
...
Si usted es un Usuario del gobierno de EE. UU. u obtiene acceso al Servicio de GitHub o lo usa en calidad de miembro de dicho gobierno, se aplicará la [Enmienda del Gobierno de EE. UU. a los Términos de Servicio de GitHub](/es/articles/amendment-to-github-terms-of-service-applicable-to-u-s-federal-government-users) y usted acepta sus cláusulas.

Si se ha registrado en GitHub Enterprise Cloud, se le aplicará el [Anexo de Enterprise Cloud](/es/articles/github-enterprise-cloud-addendum) y usted acepta sus cláusulas.
...
Usted acuerda que, bajo ninguna circunstancia, incumplirá nuestras [Directrices de Uso Aceptable](/es/articles/github-acceptable-use-policies) o las [Directrices de la Comunidad](/es/articles/github-community-guidelines).
...
### [](#2-github-puede-eliminar-contenido)[]()2. GitHub Puede Eliminar Contenido ###

Tenemos derecho a rechazar o eliminar cualquier Contenido Generado por el Usuario que, a nuestra exclusiva discreción, incumpla cualquier ley o los [términos o directivas de GitHub](/es/github/site-policy). El Contenido Generado por el Usuario que se muestra en GitHub Mobile puede estar sujeto a los términos adicionales de las tiendas de aplicaciones móviles.

### [](#3-propiedad-del-contenido-derecho-de-publicación-y-concesión-de-licencias)[]()3. Propiedad del Contenido, Derecho de Publicación y Concesión de Licencias ###
...
### [](#4-concesión-de-licencia-a-nosotros)[]()4. Concesión de Licencia a Nosotros ###
...
### [](#5-concesión-de-licencia-a-otros-usuarios)[]()5. Concesión de Licencia a Otros Usuarios ###
...
### [](#7-derechos-morales)[]()7. Derechos Morales ###
...
### [](#1-control-de-repositorios-privados)[]()1. Control de Repositorios Privados ###

Algunas Cuentas podrían tener repositorios privados, lo que permite al Usuario controlar el acceso al Contenido.

### [](#2-confidencialidad-de-los-repositorios-privados)[]()2. Confidencialidad de los Repositorios Privados ###
...
El personal de GitHub solo puede obtener acceso al contenido de sus repositorios privados en las situaciones que se describen en nuestra [Declaración de Privacidad](/es/github/site-policy/github-privacy-statement#repository-contents).
...
### [](#1-sujeto-a-cambios)[]()1 Sujeto a cambios ###
...
### [](#2-cambios-a-planes-superiores-e-inferiores-y-modificaciones)[]()2. Cambios a Planes Superiores e Inferiores y Modificaciones ###
...
### [](#3-calendario-de-pagos-no-se-realizan-reembolsos)[]()3. Calendario de Pagos; No se Realizan Reembolsos ###
...
### [](#5-responsabilidad-por-el-pago)[]()5. Responsabilidad por el Pago ###
...
### [](#1-cancelación-de-la-cuenta)[]()1. Cancelación de la Cuenta ###

Es su responsabilidad cancelar correctamente su Cuenta de GitHub. Puede [cancelar su Cuenta en cualquier momento](/es/articles/how-do-i-cancel-my-account) yendo a la sección Configuración de la barra de navegación global de la parte superior de la pantalla. La pantalla Cuenta contiene un enlace de cancelación muy sencillo en el que no se le hará ninguna pregunta. No podemos cancelar Cuentas en respuesta a un correo electrónico o una solicitud telefónica.

### [](#2-tras-la-cancelación)[]()2. Tras la Cancelación ###
...
### [](#3-rescisión-por-parte-de-github)[]()3. Rescisión por Parte de GitHub ###
...
### [](#3-sin-soporte-telefónico)[]()3. Sin Soporte Telefónico ###
...
### [](#3-títulos-de-apartados-y-resúmenes)[]()3. Títulos de Apartados y Resúmenes ###
...
### [](#4-divisibilidad-no-renuncia-y-supervivencia)[]()4. Divisibilidad, No Renuncia y Supervivencia ###
...
### [](#5-enmiendas-acuerdo-completo)[]()5. Enmiendas; Acuerdo Completo ###
