GitHub Richtlinie zum Entfernen privater Informationen - GitHub-Dokumentation
...
[](#what-is-private-information)Was sind private Informationen?
----------
...
### [](#private-information-removal-requests-are-appropriate-for)Anträge auf Entfernung privater Informationen sind geeignet für: ###
...
### [](#private-information-removal-requests-are-not-appropriate-for)Anträge auf Entfernung privater Informationen sind *nicht* geeignet für: ###
...
[](#things-to-know)Wichtige Hinweise
----------
...
[](#how-does-this-actually-work)Wie funktioniert das eigentlich?
----------
...
### [](#what-about-forks-or-whats-a-fork)Was ist mit Abspaltungen (Forks)? (oder Was ist eine Abspaltung?) ###
...
[](#sending-a-private-information-removal-request)Senden eines Antrags zum Entfernen privater Informationen
----------
...
### [](#your-request-must-include)Ihr Antrag muss Folgendes enthalten: ###
...
[](#how-to-submit-your-request)So übermitteln Sie Ihren Antrag
----------
