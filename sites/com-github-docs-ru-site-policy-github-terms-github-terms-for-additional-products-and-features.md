...
Для GitHub Copilot для бизнес-пользователей использование GitHub Copilot регулируется [GitHub Copilot условиями для конкретных продуктов](https://github.com/customer-terms/github-copilot-product-specific-terms).
