...
[](#what-is-private-information)Что такое личная информация?
----------
...
### [](#private-information-removal-requests-are-appropriate-for)Запросы на удаление личной информации подходят для: ###
...
### [](#private-information-removal-requests-are-not-appropriate-for)Запросы на удаление личной информации *не* подходят для: ###
...
[](#how-does-this-actually-work)Как это на самом деле работает?
----------
...
### [](#what-about-forks-or-whats-a-fork)Что насчет «вилок»? (или Что такое «вилка»?) ###
...
[](#sending-a-private-information-removal-request)Отправка запроса на удаление личной информации
----------
...
### [](#your-request-must-include)Ваш запрос должен включать: ###
...
[](#how-to-submit-your-request)Как отправить запрос
----------
