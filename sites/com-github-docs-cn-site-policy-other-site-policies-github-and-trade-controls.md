...
根据我们的[服务条款](/cn/articles/github-terms-of-service)，用户必须按照相关法律访问和使用 GitHub.com，包括美国出口管制和制裁法律。
...
### [](#on-which-countries-and-territories-are-us-government-sanctions-applied)美国政府对哪些国家和地区实行制裁？ ###
...
### [](#how-is-github-ensuring-that-folks-not-living-in-andor-having-professional-links-to-the-sanctioned-countries-and-territories-still-have-access-or-ability-to-appeal)GitHub 如何确保不在受制裁国家及地区生活和/或与受制裁国家及地区有专业联系的民间团体仍然能够访问或申诉？ ###
...
### [](#what-is-available-and-not-available)什么可用？什么不可用？ ###
...
### [](#how-are-organization-accounts-impacted)组织帐户受到何种影响？ ###
...
### [](#can-trade-restricted-users-private-repositories-be-made-public)是否可将受交易限制的用户私有存储库设为公共？ ###
...
### [](#can-trade-restricted-users-access-private-repository-data-eg-downloading-or-deletion-of-repository-data)受贸易限制的用户能否访问私有存储库数据（例如下载或删除存储库数据）？ ###
...
### [](#can-you-clarify-availability-of-github-to-cuban-developers)您能向古巴开发人员说明 GitHub 的可用性吗？ ###
