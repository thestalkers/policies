Directives pour les Demandes Légales de Données Utilisateurs - Documentation GitHub
...
* [**Dépôt**](/fr/get-started/quickstart/github-glossary#repository) : un dépôt est l’un des éléments GitHub les plus basiques.
