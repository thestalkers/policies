...
* [GitHub のプライバシーに関する声明](#github-のプライバシーに関する声明)

* [誰がお客様の情報の処理に責任を負いますか?](#誰がお客様の情報の処理に責任を負いますか)

* [お客様の代理で活動する GitHub](#お客様の代理で活動する-github)

* [GitHub が収集する情報](#github-が収集する情報)

* [GitHub はお客様の情報をどのように使用するか](#github-はお客様の情報をどのように使用するか)

* [当社は収集した情報をどのように共有するか](#当社は収集した情報をどのように共有するか)

* [お客様の個人データの処理に関するお客様の選択](#お客様の個人データの処理に関するお客様の選択)

* [当社による Cookie の使用と追跡技術](#当社による-cookie-の使用と追跡技術)

* [個人データの保持](#個人データの保持)

* [GitHub はお客様の情報をどのように保護するか](#github-はお客様の情報をどのように保護するか)

* [プライバシーに関する声明の変更](#プライバシーに関する声明の変更)

* [ライセンス](#ライセンス)

* [GitHub への連絡](#github-への連絡)

* [翻訳](#翻訳)

* [GitHub のカリフォルニア州住民への通知](#github-のカリフォルニア州住民への通知)
...
すべての用語については、本書に別途規定する場合を除き、[GitHub のサービス条件](/ja/github/site-policy/github-terms-of-service)内に別途定義するとおりとします。
...
### [](#ユーザーが-github-に直接提供する情報)[]()ユーザーが GitHub に直接提供する情報 ###
...
### [](#github-が自動的に収集する情報)[]()GitHub が自動的に収集する情報 ###
...
### [](#サードパーティ-アプリケーション)[]()サードパーティ アプリケーション ###
...
As a GitHub User, you can always take your data with you. You can [](/ja/desktop/contributing-to-projects/cloning-a-repository-from-github-to-github-desktop)[clone your repositories to your desktop](/ja/desktop/contributing-to-projects/cloning-a-repository-from-github-to-github-desktop), for example, or you can use our [](https://developer.github.com/changes/2018-05-24-user-migration-api/)[Data Portability tools](https://developer.github.com/changes/2018-05-24-user-migration-api/) to download information we have about you.
...
#### [](#cookie-および類似のテクノロジとは)[]()Cookie および類似のテクノロジとは? ####
...
#### [](#当社および当社パートナーが-cookie-および類似のテクノロジを使用する方法)[]()当社および当社パートナーが Cookie および類似のテクノロジを使用する方法 ####
...
#### [](#cookie-に関するお客様の選択肢とコントロール)[]()Cookie に関するお客様の選択肢とコントロール ####
...
当社の[個人情報削除ポリシー](/ja/site-policy/content-removal-policies/github-private-information-removal-policy)に従い、拠出者が個人データの削除を要求する場合、一般的にリポジトリ所有者への通知とリポジトリ所有者の活動が必要となることにご注意ください。

### [](#当社の個人情報の取り扱い)[]()当社の個人情報の取り扱い ###

下の表には当社が収集、処理、共有する個人情報のカテゴリに関する情報が記載されていますが、詳細については、当社の「[GitHub のプライバシーに関する声明](/ja/github/site-policy/github-privacy-statement)」をご覧ください。
