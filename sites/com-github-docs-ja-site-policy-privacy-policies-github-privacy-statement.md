...
* [欧州のデータ保護の権利に関する通知](#欧州のデータ保護の権利に関する通知)

* [米国州のデータのプライバシー](#米国州のデータのプライバシー)
...
#### [](#フィードバックと評価)[]()フィードバックと評価 ####

当社は、書面による通信やアンケートなどを通じて、お客様から提供されたフィードバックや評価を収集します。

### [](#github-で自動的に収集される情報)[]()GitHub で自動的に収集される情報 ###

お客様が当社のサービスを訪問または利用する際、当社はいくつかの情報を自動的に収集します。 次に例を示します。

#### [](#取引情報サブスクリプションライセンス-データ)[]()取引情報、サブスクリプション、ライセンス データ ####
