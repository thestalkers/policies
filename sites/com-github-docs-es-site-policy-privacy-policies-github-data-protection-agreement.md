...
#### [](#processing-to-provide-customer-the-online-services)Procesamiento para proporcionar los Servicios en Línea al Cliente ####
...
### [](#how-to-contact-github)Cómo Contactar a GitHub ###
...
### [](#c-competent-supervisory-authority)C. AUTORIDAD SUPERVISORA COMPETENTE ###
...
4. Contacto de privacidad de datos. Podrá contactarse al encargado de la privacidad de los datos que designe el importador de datos en la siguiente dirección:
...
5. **Condiciones de indemnización**. La indemnización bajo la sección 2 es condicional al establecimiento del sujeto de datos, para la satisfacción razonable de GitHub, que:
...
### [](#clause-2-details-of-the-transfer)Cláusula 2: Detalles de la transferencia ###
...
### [](#clause-3-third-party-beneficiary-clause)Cláusula 3: Cláusula de beneficiario tercero ###
...
### [](#clause-4-obligations-of-the-data-exporter)Cláusula 4: Las obligaciones del exportador de los datos ###
...
### [](#clause-5-obligations-of-the-data-importer)Cláusula 5: Obligaciones del importador de los datos ###
...
8. poner a disposición para el titular de los datos bajo solicitud una copia de las Cláusulas, o de cualquier contrato existente para el subprocesamiento, a menos de que dichas Cláusulas o contrato contengan información compercial, en cuyo caso pudiera eliminar dicha información comercial, con excepción del Apéndice 2, el cual se deberá reemplazar con un resumen descriptivo de las medidas de seguridad en esos casos donde el titular de los datos no puede obtener una copia del exportador de los datos;
9. que, en caso de subprocesamiento, se ha informado previamente al exportador de los datos y se ha obtenido una aprobación previa por escrito;
10. que los servicios de procesamiento del subprocesador se llevarán acabo de acuerdo con la Cláusula 11; y
11. enviar al exportador de los datos oportunamente una copia de cualquier contrato de subprocesamiento que se concluya bajo las Cláusulas.
...
### [](#clause-9-governing-law)Cláusula 9: Ley Aplicable. ###
...
### [](#appendix-1-to-the-standard-contractual-clauses-uk)Apéndice 1 para las Cláusulas Contractuales Estándar (UK) ###
...
### [](#appendix-2-to-the-standard-contractual-clauses-uk)Apéndice 2 para las Cláusulas Contractuales Estándar (UK) ###
...
### [](#appendix-3-to-the-standard-contractual-clauses-uk)Apéndice 3 para las Cláusulas Contractuales Estándar (UK) ###
