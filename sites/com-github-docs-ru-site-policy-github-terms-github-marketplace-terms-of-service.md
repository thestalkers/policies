Условия обслуживания GitHub Marketplace - Документация по GitHub
...
[](#a-githubcoms-terms-of-service)А. Условия обслуживания GitHub.com
----------
...
[](#b-use-requirements)B. Требования к использованию
----------
...
[](#c-developer-products-and-product-providers)C. Продукты разработчиков и поставщики продуктов
----------
...
[](#d-payment-billing-schedule-and-cancellation)D. Оплата, график выставления счетов и отмена
----------
...
[](#e-your-data-and-githubs-privacy-policy)Е. Ваши данные и политика конфиденциальности GitHub
----------
...
[](#f-rights-to-developer-products)F. Права на Продукты разработчиков
----------
...
[](#g-updates-to-developer-products)G. Обновление Продуктов разработчиков
----------
...
[](#h-developer-product-blocking)H. Блокировка Продукта разработчика
----------
...
[](#i-disclaimer-limitation-of-liability-release-and-indemnification)I. Отказ от гарантий; Ограничение ответственности; Освобождение от ответственности и возмещение ущерба
----------
