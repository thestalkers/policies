Условия предоставления услуг GitHub - Документация по GitHub
...
[](#the-github-terms-of-service)Условия обслуживания GitHub
----------
...
### [](#2-required-information)2. Необходимая информация ###
...
### [](#3-account-requirements)3. Требования к учетной записи ###
...
### [](#4-account-security)4. Безопасность учетной записи ###
...
### [](#5-additional-terms)5. Дополнительные условия ###
...
[](#c-acceptable-use)C. Допустимое использование.
----------
...
[](#d-user-generated-content)D. Пользовательский контент
----------
...
### [](#2-github-may-remove-content)2. GitHub может удалить контент ###
...
### [](#3-ownership-of-content-right-to-post-and-license-grants)3. Право собственности на контент, право на публикацию и предоставление лицензий ###
...
### [](#4-license-grant-to-us)4. Предоставление лицензии нам ###
...
### [](#5-license-grant-to-other-users)5. Предоставление лицензии другим пользователям ###
...
### [](#6-contributions-under-repository-license)6. Вклады по лицензии репозитория ###
...
### [](#7-moral-rights)7. Моральные права ###
...
### [](#1-control-of-private-repositories)1. Контроль частных репозиториев ###

Некоторые Учетные записи могут иметь частные репозитории, которые позволяют Пользователю контролировать доступ к Контенту.

### [](#2-confidentiality-of-private-repositories)2. Конфиденциальность частных репозиториев ###
...
[](#f-copyright-infringement-and-dmca-policy)F. Нарушение авторских прав и политика DMCA
----------
...
Мы аннулируем Учетные записи [повторных нарушителей](/ru/site-policy/content-removal-policies/dmca-takedown-policy#e-repeated-infringement) этой политики.

[](#g-intellectual-property-notice)G. Уведомление об интеллектуальной собственности
----------
...
[](#h-api-terms)H. Условия использования API
----------
...
[](#i-github-additional-product-terms)I. Дополнительные условия для продуктов GitHub
----------
...
[](#j-beta-previews)J. Предварительные бета-версии
----------
...
### [](#1-subject-to-change)1. Возможные изменения ###
...
### [](#2-upgrades-downgrades-and-changes)2. Обновления, понижения и изменения ###
...
### [](#3-billing-schedule-no-refunds)3. График выставления счетов; невозможность возврата средств ###
...
### [](#5-responsibility-for-payment)5. Ответственность за оплату ###
...
[](#l-cancellation-and-termination)L. Отмена и прекращение
----------
...
### [](#1-account-cancellation)1. Аннулирование учетной записи ###
...
### [](#2-upon-cancellation)2. При отмене ###
...
### [](#3-github-may-terminate)3. GitHub может отменить действие ###
...
### [](#4-survival)4. Сохранение юридической силы ###
...
[](#m-communications-with-github)M. Взаимодействие с GitHub
----------
...
### [](#3-no-phone-support)3. Отсутствие поддержки по телефон ###
...
[](#n-disclaimer-of-warranties)N. Отказ от гарантий
----------
...
[](#o-limitation-of-liability)O. Ограничение ответственности
----------
...
[](#p-release-and-indemnification)P. Освобождение от ответственности и возмещение ущерба
----------
...
[](#q-changes-to-these-terms)Вопрос. Изменение этих условий
----------
...
[](#r-miscellaneous)R. Прочие условия
----------
...
### [](#2-non-assignability)2. Непереуступаемость ###
...
### [](#3-section-headings-and-summaries)3. Заголовки разделов и резюме ###
...
### [](#4-severability-no-waiver-and-survival)4. Независимость положений соглашения, оговорка о неотказе и сохранение юридической силы ###
...
### [](#5-amendments-complete-agreement)5. Поправки; Полное соглашение ###
...
### [](#6-questions)6. Ответы на вопросы ###
