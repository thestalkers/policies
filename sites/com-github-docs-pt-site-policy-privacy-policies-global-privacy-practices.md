...
* **Recurso, execução e responsabilidade**
  ...
  * No caso improvável de controvérsia que não possamos resolver, você terá acesso à arbitragem legal sem nenhum custo para você. Consulte nossa [Política de Privacidade](/pt/articles/github-privacy-statement) para obter mais informações.
...
Consulte nossa [Política de Privacidade](/pt/articles/github-privacy-statement) para obter mais informações.
