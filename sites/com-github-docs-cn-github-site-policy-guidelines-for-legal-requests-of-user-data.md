...
* [**Users**](/cn/articles/github-glossary#user) —
...
* [**Collaborators**](/cn/articles/github-glossary#collaborator) —
...
* [**Organizations**](/cn/articles/github-glossary#organization) —
...
* [**Repositories**](/cn/articles/github-glossary#repository) —
...
* [**Pages**](/cn/articles/what-is-github-pages) —
...
* [**Gists**](/cn/articles/creating-gists) —
...
* []()**Private account data** —
  GitHub also collects and maintains certain private information about users as outlined in our [Privacy Policy](/cn/articles/github-privacy-statement).
  This may include:
  ...
  * Data about interactions with private repositories
    ...
    To get a sense of the type of private account information that GitHub collects, you can visit your [个人仪表板](https://github.com/dashboard) and browse through the sections in the left-hand menubar.
