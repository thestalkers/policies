...
se refiere al Contenido que el Cliente crea, posee o sobre el cual el Cliente tiene los derechos.
...
**"Comentarios"**
se refiere a cualquier idea, conocimiento, algoritmo, contribución de código, sugerencia, solicitud de mejora, recomendación o cualquier otro comentario sobre los productos o servicios de GitHub.
...
**“Organización”**
se refiere a un espacio de trabajo compartido que se puede asociar con una única entidad o con uno o más Usuarios donde múltiples Usuarios pueden colaborar en muchos proyectos a la vez. Un Usuario puede ser miembro de más de una Organización.
...
**“Extracción”**
se refiere a extraer datos del Servicio a través de un proceso automatizado, como un bot o agente de búsqueda, y que no incluye la recopilación de información a través de la API de GitHub.
...
or a person subject to similar blocking or denied party prohibitions. Para obtener más información, consulta nuestra
...
[U.S. Federal Government Amendment](/es/articles/amendment-to-github-terms-of-service-applicable-to-us-federal-government-users)
...
[Enterprise Service Level Agreement](/es/github/site-policy/github-enterprise-service-level-agreement)
...
Si GitHub tiene razones para creer que el Contenido de un Repositorio privado incumple la ley o este Acuerdo, GitHub tiene derecho a acceder, revisar y eliminar ese Contenido. Además, GitHub puede estar
[obligado por la ley](/es/github/site-policy/github-privacy-statement#for-legal-disclosure)
a divulgar el contenido de los repositorios privados del cliente. A menos que los requisitos previstos por la ley indiquen lo contrario o que sea en respuesta a una amenaza de seguridad u otro riesgo para la seguridad, GitHub dará aviso de tales acciones.
...
**Usos de las Vistas previas Beta por parte del Cliente a su propio riesgo.**
