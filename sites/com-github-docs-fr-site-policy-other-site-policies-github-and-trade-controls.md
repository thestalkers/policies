GitHub et les contrôles des échanges commerciaux - Documentation GitHub
...
[](#export-overview)Vue d’ensemble sur les exportations
----------
...
### [](#on-which-countries-and-territories-are-us-government-sanctions-applied)Sur quels pays et territoires le gouvernement américain applique-t-il des sanctions ? ###
...
### [](#how-is-github-ensuring-that-folks-not-living-in-andor-having-professional-links-to-the-sanctioned-countries-and-territories-still-have-access-or-ability-to-appeal)Comment GitHub s’assure-t-elle que les personnes qui ne vivent pas dans les pays et territoires sanctionnés et/ou qui n’ont pas de liens professionnels avec ces pays et territoires ont toujours accès ou la possibilité de faire appel ? ###
...
### [](#will-traveling-in-these-regions-be-impacted)Les déplacements dans ces régions seront-ils concernés ? ###
...
### [](#what-is-available-and-not-available)Quels sont les éléments disponibles et non disponibles ? ###
...
### [](#how-do-you-define-these-specific-users)Comment définissez-vous ces utilisateurs spécifiques ? ###
...
### [](#how-are-organization-accounts-impacted)Comment les comptes des organisations sont-ils affectés ? ###
...
### [](#can-trade-restricted-users-private-repositories-be-made-public)Les dépôts privés des utilisateurs soumis à des restrictions commerciales peuvent-ils être rendus publics ? ###
...
### [](#can-trade-restricted-users-access-private-repository-data-eg-downloading-or-deletion-of-repository-data)Les utilisateurs soumis à des restrictions commerciales peuvent-ils accéder aux données privées du dépôt (par exemple, téléchargement ou suppression de données du dépôt) ? ###
...
### [](#under-the-license-github-has-received-from-ofac-which-types-of-accounts-will-be-available-in-iran)Selon la licence que GitHub a reçue de l’OFAC, quels types de comptes seront disponibles en Iran ? ###
...
### [](#will-iranian-github-users-be-able-to-use-paid-services-under-the-license)Les utilisateurs iraniens de GitHub pourront-ils utiliser des services payants dans le cadre de la licence ? ###
...
### [](#can-you-clarify-availability-of-github-to-cuban-developers)Pouvez-vous clarifier la disponibilité de GitHub pour les développeurs cubains ? ###
