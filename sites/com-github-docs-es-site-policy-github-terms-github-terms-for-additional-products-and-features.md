Términos de GitHub para Productos y Características Adicionales - GitHub Docs
...
Términos de GitHub para Productos y Características Adicionales
==========
...
* [Base de datos consultiva](#base-de-datos-consultiva)

* [Codespaces](#codespaces)

* [Connect](#connect)

* [Copiloto de GitHub](#copiloto-de-github)
...
* [Versiones Preliminares](#versiones-preliminares)

* [Programa de Patrocinadores](#programa-de-patrocinadores)
...
GitHub Actions enables you to create custom software development lifecycle workflows directly in your GitHub repository. Actions is billed on a usage basis. The [](/es/actions)[Actions documentation](/es/actions) includes details, including compute and storage quantities (depending on your Account plan), and how to monitor your Actions minutes usage and set usage limits.
...
*Nota: El servicio github.dev, que está disponible presionando `.` en un repositorio o navegando directamente a github.dev, se rige por los [Términos de Servicio de la Versión Beta de GitHub](/es/github/site-policy/github-terms-of-service#j-beta-previews).*
...
GitHub Packages is a software package hosting service that allows you to host your software packages privately or publicly and use packages as dependencies in your projects. GitHub Packages is billed on a usage basis. The [](/es/packages/learn-github-packages/introduction-to-github-packages)[Packages documentation](/es/packages/learn-github-packages/introduction-to-github-packages) includes details, including bandwidth and storage quantities (depending on your Account plan), and how to monitor your Packages usage and set usage limits. Packages bandwidth usage is limited by the [](/es/github/site-policy/github-acceptable-use-policies)[GitHub Acceptable Use Polices](/es/github/site-policy/github-acceptable-use-policies).

[](#pages)[]()Pages
----------

Each Account comes with access to the [](/es/github/working-with-github-pages/about-github-pages)[GitHub Pages static hosting service](/es/github/working-with-github-pages/about-github-pages). GitHub Pages is intended to host static web pages, but primarily as a showcase for personal and organizational projects.
...
GitHub Pages are subject to some specific bandwidth and usage limits, and may not be appropriate for some high-bandwidth uses. Please see our [](/es/github/working-with-github-pages/about-github-pages)[GitHub Pages limits](/es/github/working-with-github-pages/about-github-pages) for more information.
