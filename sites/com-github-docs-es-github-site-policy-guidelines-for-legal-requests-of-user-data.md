...
* [**Users**](/es/articles/github-glossary#user) —
...
* [**Collaborators**](/es/articles/github-glossary#collaborator) —
...
* [**Organizations**](/es/articles/github-glossary#organization) —
...
* [**Repositories**](/es/articles/github-glossary#repository) —
...
* [**Pages**](/es/articles/what-is-github-pages) —
...
* []()**Private account data** —
  GitHub also collects and maintains certain private information about users as outlined in our [Privacy Policy](/es/articles/github-privacy-statement).
  This may include:
  ...
  * Data about interactions with private repositories
    ...
    To get a sense of the type of private account information that GitHub collects, you can visit your [tablero personal](https://github.com/dashboard) and browse through the sections in the left-hand menubar.
