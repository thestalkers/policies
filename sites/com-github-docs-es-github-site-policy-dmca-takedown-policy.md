...
(Si solo deseas enviar un aviso, puedes
[ir al final del documento](#f-submitting-notices)
.)
...
GitHub no necesariamente respalda ninguno de los puntos de vista en esos artículos. Proporcionamos los enlaces para invitarte a conocer más, formar tus propias opiniones y posteriormente llegar a tu(s) representante(s) electos (por ejemplo, en el
...
) para buscar los cambios que consideras que deberían llevarse a cabo. Congress or
