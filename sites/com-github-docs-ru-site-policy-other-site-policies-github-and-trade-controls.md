...
[](#export-overview)Общие сведения об экспорте
----------
...
### [](#on-which-countries-and-territories-are-us-government-sanctions-applied)В отношении каких стран и территорий применяются санкции правительства США? ###
...
### [](#how-is-github-ensuring-that-folks-not-living-in-andor-having-professional-links-to-the-sanctioned-countries-and-territories-still-have-access-or-ability-to-appeal)Как GitHub гарантирует, что люди, не проживающие в странах и территориях, на которые распространяются санкции, и/или не имеющие профессиональных связей с ними, по-прежнему имеют доступ или возможность подать апелляцию? ###
...
### [](#will-traveling-in-these-regions-be-impacted)Будут ли затронуты поездки в эти регионы? ###
...
### [](#what-is-available-and-not-available)Что доступно, а что нет? ###
...
### [](#how-do-you-define-these-specific-users)Как вы определяете этих конкретных пользователей? ###
...
### [](#how-are-organization-accounts-impacted)Как это влияет на учетные записи организаций? ###
...
### [](#can-trade-restricted-users-private-repositories-be-made-public)Можно ли сделать публичными частные репозитории пользователей, в отношении которых действуют торговые ограничения? ###
...
### [](#can-trade-restricted-users-access-private-repository-data-eg-downloading-or-deletion-of-repository-data)Могут ли пользователи с торговыми ограничениями получить доступ к данным частного репозитория (например, загрузка или удаление данных репозитория)? ###
...
### [](#under-the-license-github-has-received-from-ofac-which-types-of-accounts-will-be-available-in-iran)Какие типы учетных записей будут доступны в Иране в соответствии с лицензией, полученной GitHub от OFAC? ###
...
### [](#will-iranian-github-users-be-able-to-use-paid-services-under-the-license)Смогут ли иранские пользователи GitHub использовать платные услуги по лицензии? ###
...
### [](#can-you-clarify-availability-of-github-to-cuban-developers)Можете ли вы уточнить доступность GitHub для кубинских разработчиков? ###
