GitHub и торговый контроль - Документация по GitHub
...
* [Вопросы и ответы](#github-copilot)
...
### [В отношении каких стран и территорий применяются санкции правительства США?](#frequently-asked-questions) ###
...
### [Как GitHub гарантирует, что люди, не проживающие в странах и территориях, на которые распространяются санкции, и/или не имеющие профессиональных связей с ними, по-прежнему имеют доступ или возможность подать апелляцию?](#on-which-countries-and-territories-are-us-government-sanctions-applied) ###
...
### [Будут ли затронуты поездки в эти регионы?](#how-is-github-ensuring-that-folks-not-living-in-andor-having-professional-links-to-the-sanctioned-countries-and-territories-still-have-access-or-ability-to-appeal) ###
...
### [Что доступно, а что нет?](#will-traveling-in-these-regions-be-impacted) ###
...
### [Как вы определяете этих конкретных пользователей?](#what-is-available-and-not-available) ###
...
### [Как это влияет на учетные записи организаций?](#how-do-you-define-these-specific-users) ###
...
### [Можно ли сделать публичными частные репозитории пользователей, в отношении которых действуют торговые ограничения?](#how-are-organization-accounts-impacted) ###
...
### [Могут ли пользователи с торговыми ограничениями получить доступ к данным частного репозитория (например, загрузка или удаление данных репозитория)?](#can-trade-restricted-users-private-repositories-be-made-public) ###
...
### [Какие типы учетных записей будут доступны в Иране в соответствии с лицензией, полученной GitHub от OFAC?](#can-trade-restricted-users-access-private-repository-data-eg-downloading-or-deletion-of-repository-data) ###
...
### [Смогут ли иранские пользователи GitHub использовать платные услуги по лицензии?](#under-the-license-github-has-received-from-ofac-which-types-of-accounts-will-be-available-in-iran) ###
...
### [Можете ли вы уточнить доступность GitHub для кубинских разработчиков?](#will-iranian-github-users-be-able-to-use-paid-services-under-the-license) ###
