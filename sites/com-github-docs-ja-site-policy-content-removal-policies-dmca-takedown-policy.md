...
* [DMCA 通知の要約](#dmca-通知の要約)

* [A. どのように機能するのですか?](#a-どのように機能するのですか)

* [B. フォークについて教えてください (またはフォークとは何ですか?)](#b-フォークについて教えてください-またはフォークとは何ですか)

* [C. 回避申し立てとは何ですか?](#c-回避申し立てとは何ですか)

* [D. 変更を行う期間をうっかり逃してしまった場合はどうなりますか?](#d-変更を行う期間をうっかり逃してしまった場合はどうなりますか)

* [E. 透明性](#e-透明性)

* [F. 繰り返される権利侵害](#f-繰り返される権利侵害)
