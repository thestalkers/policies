...
* [3.支援対象開発者の義務](#3支援対象開発者の義務)

* [4.財務条件](#4財務条件)

* [5.表明と保証、責任の制限、補償](#5表明と保証責任の制限補償)

* [6.契約の期間および終了。](#6契約の期間および終了)
...
### [](#21-github-スポンサー-プログラム)[]()2.1. GitHub スポンサー プログラム ###
...
### [](#22-github-スポンサー-マッチング-ファンド)[]()2.2. GitHub スポンサー マッチング ファンド ###
...
#### [](#221-マッチング-ファンドの条件)[]()2.2.1. マッチング ファンドの条件 ####
...
### [](#42-支援対象開発者の支払いの除外)[]()4.2. 支援対象開発者の支払いの除外 ###

以下の金額は、必要に応じて、支援対象開発者の支払いに含まれていないか GitHub により保留される場合があります。

#### [](#421-支援対象開発者の費用)[]()4.2.1. 支援対象開発者の費用 ####
...
#### [](#423-違反に対する支援対象開発者の支払いの保留)[]()4.2.3. 違反に対する支援対象開発者の支払いの保留 ####
...
[](#5表明と保証責任の制限補償)[]()5.表明と保証、責任の制限、補償
----------

### [](#51-支援対象開発者による)[]()5.1. 支援対象開発者による。 ###
