...
* [Häufig gestellte Fragen](#github-copilot)
...
### [Für welche Länder und Gebiete werden Sanktionen der US-Regierung verhängt?](#frequently-asked-questions) ###
...
### [Wie stellt GitHub sicher, dass Personen, die nicht in den sanktionierten Ländern und Gebieten leben und/oder berufliche Verbindungen zu ihnen haben, weiterhin Zugang oder die Möglichkeit haben, Einspruch einzulegen?](#on-which-countries-and-territories-are-us-government-sanctions-applied) ###
...
### [Ist das Reisen in diese Regionen davon betroffen?](#how-is-github-ensuring-that-folks-not-living-in-andor-having-professional-links-to-the-sanctioned-countries-and-territories-still-have-access-or-ability-to-appeal) ###
...
### [Was ist verfügbar und was nicht?](#will-traveling-in-these-regions-be-impacted) ###
...
### [Wie definieren Sie diese spezifischen Benutzer\*innen?](#what-is-available-and-not-available) ###
...
### [Wie sind Organisationskonten betroffen?](#how-do-you-define-these-specific-users) ###
...
### [Können die privaten Repositories von Nutzern, die Handelsbeschränkungen unterliegen, öffentlich gemacht werden?](#how-are-organization-accounts-impacted) ###
...
### [Können Nutzer, die Handelsbeschränkungen unterliegen, auf private Repositorydaten zugreifen (z. B. Repository-Daten herunterladen oder löschen)?](#can-trade-restricted-users-private-repositories-be-made-public) ###
...
### [Welche Arten von Konten werden unter der Lizenz, die GitHub von OFAC erhalten hat, im Iran verfügbar sein?](#can-trade-restricted-users-access-private-repository-data-eg-downloading-or-deletion-of-repository-data) ###
...
### [Werden iranische GitHub Nutzer kostenpflichtige Dienste unter der Lizenz nutzen können?](#under-the-license-github-has-received-from-ofac-which-types-of-accounts-will-be-available-in-iran) ###
...
### [Können Sie die Verfügbarkeit von GitHub für kubanische Entwickler\*innen erläutern?](#will-iranian-github-users-be-able-to-use-paid-services-under-the-license) ###
