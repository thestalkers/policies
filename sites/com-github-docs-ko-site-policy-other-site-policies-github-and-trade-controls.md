...
[](#frequently-asked-questions)질문과 대답
----------

### [](#on-which-countries-and-territories-are-us-government-sanctions-applied)미국 정부의 제재가 적용되는 대상 국가와 영토는 어디인가요? ###
...
### [](#how-is-github-ensuring-that-folks-not-living-in-andor-having-professional-links-to-the-sanctioned-countries-and-territories-still-have-access-or-ability-to-appeal)GitHub가 제재 대상의 국가와 영토에 거주하지 않거나 업무상의 연고가 없는 사람들이 여전히 접근권을 갖거나 이의를 제기할 수 있도록 보장하는 방법이 있다면 무엇인가요? ###
...
### [](#will-traveling-in-these-regions-be-impacted)이들 지역을 여행하는 경우 영향을 받습니까? ###
...
### [](#what-is-available-and-not-available)사용 가능한 것과 사용할 수 없는 것으로는 무엇이 있나요? ###
...
### [](#how-do-you-define-these-specific-users)이러한 특정 사용자를 어떻게 정의하나요? ###
...
### [](#how-are-organization-accounts-impacted)조직 계정은 어떤 영향을 받나요? ###
...
### [](#can-trade-restricted-users-private-repositories-be-made-public)거래가 제한된 사용자의 개인 리포지토리를 공개할 수 있나요? ###
...
### [](#can-trade-restricted-users-access-private-repository-data-eg-downloading-or-deletion-of-repository-data)거래가 제한된 사용자가 개인 리포지토리 데이터에 액세스할 수 있습니까(예: 리포지토리 데이터 다운로드 또는 삭제)? ###
...
### [](#under-the-license-github-has-received-from-ofac-which-types-of-accounts-will-be-available-in-iran)GitHub가 OFAC에서 획득한 라이선스에 따라 이란에서 어떤 유형의 계정을 사용할 수 있습니까? ###
...
### [](#will-iranian-github-users-be-able-to-use-paid-services-under-the-license)이란의 GitHub 사용자는 라이선스에 따라 유료 서비스를 사용할 수 있나요? ###
...
### [](#can-you-clarify-availability-of-github-to-cuban-developers)쿠바의 개발자에게 GitHub의 가용성을 명확히 설명할 수 있습니까? ###
