...
GitHub Copilot 상업용 대량 시장 제품이며 5D992.c의 ECCN(내보내기 제어 분류 번호)이 할당되었으며 NLR(라이선스 필요 없이 대부분의 대상)으로 내보낼 수 있습니다.

GitHub Copilot 국가 그룹 E:1 보충 번호에 나열된 국가로 판매, 수출 또는 다시 수출할 수 없습니다. 1- EAR의 740부 또는 우크라이나의 다음 지역: 크림반도와 도네츠크와 루한스크의 분리주의 지역, 허가없이. 현재 제재 대상국 명단에는 쿠바, 이란, 북한, 시리아, 러시아 및 벨라루스가 포함되지만 이 명단은 변경될 수 있습니다.
