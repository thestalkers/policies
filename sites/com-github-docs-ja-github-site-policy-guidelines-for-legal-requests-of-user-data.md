...
* [**Users**](/ja/articles/github-glossary#user) —
...
* [**Collaborators**](/ja/articles/github-glossary#collaborator) —
...
* [**Organizations**](/ja/articles/github-glossary#organization) —
...
* [**Repositories**](/ja/articles/github-glossary#repository) —
...
* [**Pages**](/ja/articles/what-is-github-pages) —
...
* [**Gists**](/ja/articles/creating-gists) —
...
* []()**Private account data** —
  GitHub also collects and maintains certain private information about users as outlined in our [Privacy Policy](/ja/articles/github-privacy-statement).
  This may include:
  ...
  * Data about interactions with private repositories
    ...
    To get a sense of the type of private account information that GitHub collects, you can visit your [personal dashboard（個人ダッシュボード）](https://github.com/dashboard) and browse through the sections in the left-hand menubar.
