...
Como você mantém a propriedade e a responsabilidade pelo Seu Conteúdo, precisamos que você conceda a nós e a outros Usuários do GitHub determinadas permissões legais, listadas nas Seções D.4 – D.1. Essas outorgas de licença se aplicam ao Seu Conteúdo. Se você carregar Conteúdo que já venha com uma licença que conceda ao GitHub as permissões de que precisamos para executar nosso Serviço, nenhuma licença adicional será necessária. Você entende que não receberá nenhum pagamento por nenhum dos direitos outorgados nas Seções D.4 – D.1. As licenças outorgadas terminarão quando você remover Seu Conteúdo de nossos servidores, a menos que outros Usuários tenham criado fork dele.
