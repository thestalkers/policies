...
|------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                      [A. Definitionen](#a-definitions)                       |                                             Einige grundlegende Begriffe, die so definiert sind, dass Sie Ihnen das Verständnis dieser Vereinbarung erleichtern. In diesem Abschnitt können Sie jederzeit einen Begriff nachsehen.                                              |
|                   [B. Kontobedingungen](#b-account-terms)                    |                                                                                                          Dies sind die Grundvoraussetzungen für ein Konto auf GitHub.                                                                                                           |
|                  [C. Akzeptable Nutzung](#c-acceptable-use)                  |                                                                                             Dies sind die Grundregeln, die Sie bei Verwendung Ihres GitHub Kontos befolgen müssen.                                                                                              |
|           [D. Nutzergenerierte Inhalte](#d-user-generated-content)           |                                Sie sind Eigentümer der Inhalte, die Sie auf GitHub posten. Sie haben jedoch diesbezüglich einige Pflichten, und wir bitten Sie, uns einige Rechte einzuräumen, damit wir Ihnen Dienstleistungen anbieten können.                                |
...
|        [L. Auflösung und Kündigung](#l-cancellation-and-termination)         |                                                                                                    Sie können diese Vereinbarung jederzeit kündigen und Ihr Konto auflösen.                                                                                                     |
...
|      [N. Ausschluss von Gewährleistungen](#n-disclaimer-of-warranties)       |                                  Wir bieten unseren Dienst so an, wie er ist, und wir geben keine Zusicherungen oder Garantien für diesen Dienst. **Bitte lesen Sie diesen Abschnitt sorgfältig durch; Sie sollten wissen, was Sie erwartet.**                                  |
...
[](#the-github-terms-of-service)Die GitHub Nutzungsbedingungen
----------
...
### [](#2-required-information)2. Benötigte Informationen ###
...
### [](#3-account-requirements)3. Kontovoraussetzungen ###
...
### [](#4-account-security)4. Kontosicherheit ###
...
### [](#5-additional-terms)5. Zusätzliche Geschäftsbedingungen ###
...
[](#c-acceptable-use)C. Akzeptable Nutzung
----------
...
[](#d-user-generated-content)D. Benutzergenerierte Inhalte
----------
...
### [](#2-github-may-remove-content)2. GitHub darf Inhalte entfernen ###
...
### [](#3-ownership-of-content-right-to-post-and-license-grants)3. Eigentum an Inhalten, Recht zur Veröffentlichung und Lizenzgewährung ###
...
### [](#4-license-grant-to-us)4. Lizenzgewährung an uns ###
...
### [](#5-license-grant-to-other-users)5. Lizenzgewährung an andere Nutzer ###
...
### [](#7-moral-rights)7. Urheberpersönlichkeitsrechte ###
...
### [](#1-control-of-private-repositories)1. Kontrolle über private Repositories ###
...
### [](#2-confidentiality-of-private-repositories)2. Vertraulichkeit privater Repositories ###
...
[](#f-copyright-infringement-and-dmca-policy)F. Urheberrechtsverletzung und DMCA-Richtlinie
----------
...
[](#g-intellectual-property-notice)G. Hinweis zu Rechten an geistigem Eigentum
----------
...
### [](#3-license-to-github-policies)3. Lizenz für GitHub Richtlinien ###
...
[](#h-api-terms)H. API-Bestimmungen
----------
...
[](#i-github-additional-product-terms)I. Zusätzliche Produktbestimmungen von GitHub
----------
...
[](#j-beta-previews)J. Beta-Vorschauen
----------
...
### [](#1-subject-to-change)1. Änderungen vorbehalten ###
...
### [](#2-upgrades-downgrades-and-changes)2. Upgrades, Downgrades und Änderungen ###
...
### [](#3-billing-schedule-no-refunds)3. Abrechnungsplan; Keine Rückerstattung ###
...
### [](#5-responsibility-for-payment)5. Verantwortung für die Zahlung ###
...
[](#l-cancellation-and-termination)L. Auflösung und Kündigung
----------

**Kurzfassung:** *Sie können Ihr Konto jederzeit schließen. In diesem Fall gehen wir verantwortungsbewusst mit Ihren Daten um.*

### [](#1-account-cancellation)1. Kontoauflösung ###

Es liegt in Ihrer Verantwortung, Ihr Konto bei GitHub ordnungsgemäß zu kündigen. Sie können [Ihr Konto jederzeit auflösen](/de/billing/managing-billing-for-your-github-account/downgrading-your-github-subscription), indem Sie in der globalen Navigationsleiste oben auf dem Bildschirm zu Ihren Einstellungen gehen. Der Kontobildschirm bietet einen einfachen Kündigungslink, bei dem keine Fragen gestellt werden. Wir können Konten nicht als Antwort auf eine E-Mail- oder Telefonanfrage auflösen.

### [](#2-upon-cancellation)2. Bei Auflösung ###
...
### [](#3-github-may-terminate)3. GitHub ist zur Kündigung berechtigt ###
...
[](#m-communications-with-github)m. Kommunikation mit GitHub
----------
...
### [](#3-no-phone-support)3. Kein Telefonsupport ###
...
[](#n-disclaimer-of-warranties)N. Ausschluss von Gewährleistungen
----------
...
[](#o-limitation-of-liability)O. Haftungsbeschränkung
----------
...
[](#p-release-and-indemnification)P. Haftungsfreistellung und Schadenersatz
----------
...
[](#q-changes-to-these-terms)Q. Änderungen an diesen Nutzungsbedingungen
----------
...
### [](#3-section-headings-and-summaries)3. Abschnittsüberschriften und Zusammenfassungen ###
...
### [](#4-severability-no-waiver-and-survival)4. Salvatorische Klausel, kein Verzicht und Fortbestand ###
...
### [](#5-amendments-complete-agreement)5. Änderungen; Vollständige Vereinbarung ###
