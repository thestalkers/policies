...
* [](/ja/articles/github-glossary#repository)[**Repositories**](/ja/articles/github-glossary#repository) — A repository is one of the most basic GitHub elements.
...
* [](/ja/articles/what-is-github-pages)[**Pages**](/ja/articles/what-is-github-pages) — GitHub Pages are public webpages freely hosted by GitHub that users can easily publish through code stored in their repositories.
...
* [](/ja/articles/creating-gists)[**Gists**](/ja/articles/creating-gists) — Gists are snippets of source code or other text that users can use to store ideas or share with friends.
...
* \<a name="private-account-data"\>\</a\>**Private account data** — GitHub also collects and maintains certain private information about users as outlined in our [](/ja/articles/github-privacy-statement)[Privacy Policy](/ja/articles/github-privacy-statement).
  This may include:
