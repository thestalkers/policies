...
对 Actions 和任何 Action 产品或服务元素的使用，不得违反协议、[GitHub 可接受使用政策](/cn/github/site-policy/github-acceptable-use-policies)或 [Actions 文档](/cn/actions/reference/usage-limits-billing-and-administration)规定的 GitHub Actions 服务限制。 Additionally, regardless of whether an Action is using self-hosted runners, Actions should not be used for:
...
Codespaces 的一般版本目前不适用于美国。 政府客户。 美国 government customers may continue to use the Codespaces Beta Preview under separate terms. See [Beta Preview terms](/cn/github/site-policy/github-terms-of-service#j-beta-previews).
...
GitHub Pages 受某些特定带宽和使用限制的约束，可能不适用于某些高带宽用途。 Please see our [GitHub Pages limits](/cn/github/working-with-github-pages/about-github-pages) for more information.
