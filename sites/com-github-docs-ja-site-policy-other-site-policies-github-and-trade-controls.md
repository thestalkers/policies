...
### [米国政府が制裁を適用しているのはどの国および地域ですか?](#frequently-asked-questions) ###
...
### [GitHub は、制裁対象の国および地域に居住していなかったり、専門リンクがない場合でも、どのようにしてアクセスまたは異議申し立てできるようにしているのですか?](#on-which-countries-and-territories-are-us-government-sanctions-applied) ###
...
### [対象地域内の旅行には影響がありますか?](#how-is-github-ensuring-that-folks-not-living-in-andor-having-professional-links-to-the-sanctioned-countries-and-territories-still-have-access-or-ability-to-appeal) ###
...
### [利用できるものとできないものを教えてください。](#will-traveling-in-these-regions-be-impacted) ###
...
### [これらの特定のユーザーをどのように定義していますか?](#what-is-available-and-not-available) ###
...
### [組織アカウントにはどのような影響があるのですか?](#how-do-you-define-these-specific-users) ###
...
### [貿易制限対象ユーザーのプライベート リポジトリは公開できますか?](#how-are-organization-accounts-impacted) ###
...
### [貿易制限対象ユーザーはプライベート リポジトリ データにアクセスできますか (リポジトリ データをダウンロードまたは削除するなど)?](#can-trade-restricted-users-private-repositories-be-made-public) ###
...
### [GitHub が OFAC から得た許可の下、イランで利用できるのはどのようなアカウントですか?](#can-trade-restricted-users-access-private-repository-data-eg-downloading-or-deletion-of-repository-data) ###
...
### [イランの GitHub ユーザーは、この許可この下で有料サービスを利用することができますか?](#under-the-license-github-has-received-from-ofac-which-types-of-accounts-will-be-available-in-iran) ###
...
### [キューバの開発者に GitHub の利用可能性を明言できますか?](#will-iranian-github-users-be-able-to-use-paid-services-under-the-license) ###
