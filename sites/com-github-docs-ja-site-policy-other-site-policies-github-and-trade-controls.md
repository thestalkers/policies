...
### [](#米国政府が制裁を適用しているのはどの国および地域ですか)[]()米国政府が制裁を適用しているのはどの国および地域ですか? ###
...
### [](#github-は制裁対象の国および地域に居住していなかったり専門リンクがない場合でもどのようにしてアクセスまたは異議申し立てできるようにしているのですか)[]()GitHub は、制裁対象の国および地域に居住していなかったり、専門リンクがない場合でも、どのようにしてアクセスまたは異議申し立てできるようにしているのですか? ###
...
### [](#対象地域内の旅行には影響がありますか)[]()対象地域内の旅行には影響がありますか? ###
...
### [](#利用できるものとできないものを教えてください)[]()利用できるものとできないものを教えてください。 ###
...
### [](#これらの特定のユーザーをどのように定義していますか)[]()これらの特定のユーザーをどのように定義していますか? ###
...
### [](#組織アカウントにはどのような影響があるのですか)[]()組織アカウントにはどのような影響があるのですか? ###
...
### [](#貿易制限対象ユーザーのプライベート-リポジトリは公開できますか)[]()貿易制限対象ユーザーのプライベート リポジトリは公開できますか? ###
...
### [](#貿易制限対象ユーザーはプライベート-リポジトリ-データにアクセスできますか-リポジトリ-データをダウンロードまたは削除するなど)[]()貿易制限対象ユーザーはプライベート リポジトリ データにアクセスできますか (リポジトリ データをダウンロードまたは削除するなど)? ###
...
### [](#github-が-ofac-から得た許可の下イランで利用できるのはどのようなアカウントですか)[]()GitHub が OFAC から得た許可の下、イランで利用できるのはどのようなアカウントですか? ###
...
### [](#イランの-github-ユーザーはこの許可この下で有料サービスを利用することができますか)[]()イランの GitHub ユーザーは、この許可この下で有料サービスを利用することができますか? ###
...
### [](#キューバの開発者に-github-の利用可能性を明言できますか)[]()キューバの開発者に GitHub の利用可能性を明言できますか? ###
