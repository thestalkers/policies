...
### [](#will-traveling-in-these-regions-be-impacted)対象地域内の旅行には影響がありますか? ###
...
### [](#what-is-available-and-not-available)利用できるものとできないものを教えてください。 ###
...
### [](#how-do-you-define-these-specific-users)これらの特定のユーザーをどのように定義していますか? ###
...
### [](#how-are-organization-accounts-impacted)組織アカウントにはどのような影響があるのですか? ###
...
### [](#can-trade-restricted-users-private-repositories-be-made-public)貿易制限対象ユーザーのプライベート リポジトリは公開できますか? ###
...
### [](#can-trade-restricted-users-access-private-repository-data-eg-downloading-or-deletion-of-repository-data)貿易制限対象ユーザーはプライベート リポジトリ データにアクセスできますか (リポジトリ データをダウンロードまたは削除するなど)? ###
...
### [](#under-the-license-github-has-received-from-ofac-which-types-of-accounts-will-be-available-in-iran)GitHub が OFAC から得た許可の下、イランで利用できるのはどのようなアカウントですか? ###
...
### [](#will-iranian-github-users-be-able-to-use-paid-services-under-the-license)イランの GitHub ユーザーは、この許可この下で有料サービスを利用することができますか? ###
...
### [](#can-you-clarify-availability-of-github-to-cuban-developers)キューバの開発者に GitHub の利用可能性を明言できますか? ###
