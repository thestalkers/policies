...
Étant donné que vous conservez la propriété et la responsabilité de Votre Contenu, nous avons besoin que vous nous accordiez, ainsi qu’aux autres utilisateurs de GitHub, certaines autorisations légales, énoncées dans les Sections D.4 à D.1. Ces octrois de licence s’appliquent à Votre Contenu. Si vous téléchargez du Contenu qui est déjà accompagné d’une licence accordant à GitHub les autorisations dont nous avons besoin pour exécuter notre Service, aucune licence supplémentaire n’est requise. Vous comprenez que vous ne recevrez aucun paiement pour l’un des droits accordés dans les Sections D.4 à D.1. Les licences que vous nous accordez prennent fin lorsque vous supprimez Votre Contenu de nos serveurs, sauf si d’autres Utilisateurs l’ont forké.
