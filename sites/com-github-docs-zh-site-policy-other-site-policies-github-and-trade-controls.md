...
### [美国政府对哪些国家和地区实行制裁？](#frequently-asked-questions) ###
...
### [GitHub 如何确保不在受制裁国家及地区生活和/或与受制裁国家及地区有专业联系的民间团体仍然能够访问或申诉？](#on-which-countries-and-territories-are-us-government-sanctions-applied) ###
...
### [到这些地区旅行是否会受到影响？](#how-is-github-ensuring-that-folks-not-living-in-andor-having-professional-links-to-the-sanctioned-countries-and-territories-still-have-access-or-ability-to-appeal) ###
...
### [什么可用？什么不可用？](#will-traveling-in-these-regions-be-impacted) ###
...
### [如何定义这些特定用户？](#what-is-available-and-not-available) ###
...
### [组织帐户受到何种影响？](#how-do-you-define-these-specific-users) ###
...
### [是否可将受交易限制的用户私有存储库设为公共？](#how-are-organization-accounts-impacted) ###
...
### [受贸易限制的用户能否访问私有存储库数据（例如下载或删除存储库数据）？](#can-trade-restricted-users-private-repositories-be-made-public) ###
...
### [根据 GitHub 从 OFAC 获得的许可，将在伊朗提供哪些类型的帐户？](#can-trade-restricted-users-access-private-repository-data-eg-downloading-or-deletion-of-repository-data) ###
...
### [伊朗 GitHub 用户能否在许可下使用付费服务？](#under-the-license-github-has-received-from-ofac-which-types-of-accounts-will-be-available-in-iran) ###

根据我们从 OFAC 获得的许可，我们正在为伊朗用户恢复所有云服务，包括付费服务。 我们接受所有主要的信用卡，但是第三方为我们处理付款，因此付款受付款处理方的条款和条件的约束。 这些第三方可能规定阻止伊朗付款的限制。

### [您能向古巴开发人员说明 GitHub 的可用性吗？](#will-iranian-github-users-be-able-to-use-paid-services-under-the-license) ###
