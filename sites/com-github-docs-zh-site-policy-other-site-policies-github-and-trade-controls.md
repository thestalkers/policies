...
GitHub Copilot 是一种商业性的大宗市场产品，已被分配了出口管制分类号码 (ECCN) 5D992.c，并可能出口到大多数目的地，而无需许可证 (NLR)。

在未经授权的情况下，GitHub Copilot 不得出售、出口或再出口到 EAR 第 740 部分补充文件第 1 号的国家/地区组 E:1 中 列出的任何国家/地区，也不得出售、出口或再出口到乌克兰的以下地区：克里米亚以及顿涅茨克和卢甘斯克的分离主义地区。 列出的国家目前包括古巴、伊朗、朝鲜、叙利亚、俄罗斯和白俄罗斯，但此列表可能会发生变化。
