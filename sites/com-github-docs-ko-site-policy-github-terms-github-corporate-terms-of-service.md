...
### [6. Enterprise Cloud 서비스 수준 계약(SLA) #](#6-enterprise-cloud-service-level-agreement) ###
...
### [2. 콘텐츠 소유권, 게시물에 대한 권리 및 라이선스 허여 #](#2-ownership-of-content-right-to-post-and-license-grants) ###
...
### [5. 지적 재산권 보유 #](#5-intellectual-property-rights-reserved) ###
...
일부 서비스 기능에는 [GitHub 추가 제품 약관](/ko/site-policy/github-terms/github-terms-for-additional-products-and-features)에 명시된 추가 약관이 적용될 수 있습니다. 이러한 기능에 액세스하거나 이 기능을 사용함으로써 고객은 GitHub 추가 제품 약관에 동의합니다.
...
### [3. 전문 서비스 크레딧 #](#3-professional-services-credits) ###
