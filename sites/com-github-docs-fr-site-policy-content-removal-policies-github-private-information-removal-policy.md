Politique GitHub de Retrait des Informations Privées - Documentation GitHub
...
[](#what-is-private-information)Que sont les Informations Privées ?
----------
...
### [](#private-information-removal-requests-are-appropriate-for)Les demandes de retrait d’informations privées sont appropriées dans les cas suivants : ###
...
### [](#private-information-removal-requests-are-not-appropriate-for)Les demandes de suppression d’informations privées ne sont *pas* approprié pour : ###
...
[](#how-does-this-actually-work)Comment cela fonctionne-t-il réellement ?
----------
...
### [](#what-about-forks-or-whats-a-fork)Qu’en est-il des forks ? (ou qu’est-ce qu’un fork ?) ###
...
[](#sending-a-private-information-removal-request)Envoi d’une demande de retrait d’informations privées
----------
...
### [](#your-request-must-include)Votre demande doit inclure : ###
...
[](#how-to-submit-your-request)Comment envoyer une demande
----------
