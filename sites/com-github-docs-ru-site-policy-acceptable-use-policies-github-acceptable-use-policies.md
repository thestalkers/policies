...
* использовать наши серверы для любой формы чрезмерной автоматизированной массовой активности, чтобы наложить неоправданную нагрузку на наши серверы с помощью автоматизированных средств, или для ретрансляции любой формы нежелательной рекламы или запроса через наши серверы, таких как схемы get-rich-quick;
* стимулируются (или стимулируют неуверенное взаимодействие с) вознаграждения, такие как криптовалютные воздушные капли, токены, кредиты, подарки или другие поддавки.
