Политика допустимого использования GitHub - Документация по GitHub
...
[](#2-user-safety)2. Безопасность пользователей
----------
...
[](#3-intellectual-property-authenticity-and-private-information)3. Интеллектуальная собственность, аутентичность и личная информация
----------
...
* [представляют любое физическое или юридическое лицо](/ru/site-policy/acceptable-use-policies/github-impersonation), включая любого из наших сотрудников или представителей, в том числе посредством ложной ассоциации с GitHub, или путем обмана, искажающего вашу личность или цели сайта; или
...
[](#4-spam-and-inauthentic-activity-on-github)4. Спам и недостоверная активность на GitHub
----------
...
[](#5-site-access-and-safety)5. Доступ к сайту и безопасность
----------
...
[](#6-services-usage-limits)6. Ограничения на использование услуг
----------
...
[](#7-information-usage-restrictions)7. Ограничения на использование информации
----------
...
[](#8-privacy)8. Конфиденциальность
----------
...
[](#9-excessive-bandwidth-use)9. Чрезмерное использование полосы пропускания
----------
...
[](#10-advertising-on-github)10. Реклама на GitHub
----------
...
[](#11-user-protection)11. Защита пользователя
----------
