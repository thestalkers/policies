...
* [3.リスク、責任、および免責](#3リスク責任および免責)

* [4.契約終了](#4契約終了)

* [5.法および裁判地の選択](#5法および裁判地の選択)
...
[](#1基本的な出席要件---イベントの行動規範を含む)[]()1.基本的な出席要件 - [イベントの行動規範](/ja/articles/github-event-code-of-conduct)を含む
----------
