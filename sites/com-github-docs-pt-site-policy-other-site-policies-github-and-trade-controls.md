...
* [Perguntas frequentes](#github-copilot)
...
### [Como o GitHub está garantindo que as pessoas que não vivem e/ou têm vínculos profissionais com os países e territórios sancionados ainda tenham acesso ou possibilidade de apelar?](#on-which-countries-and-territories-are-us-government-sanctions-applied) ###
...
### [As viagens para essas regiões serão afetadas?](#how-is-github-ensuring-that-folks-not-living-in-andor-having-professional-links-to-the-sanctioned-countries-and-territories-still-have-access-or-ability-to-appeal) ###
...
### [O que está disponível e o que não está disponível?](#will-traveling-in-these-regions-be-impacted) ###
...
### [Como você define esses usuários específicos?](#what-is-available-and-not-available) ###
...
### [Como as contas corporativas são afetadas?](#how-do-you-define-these-specific-users) ###
...
### [Os repositórios privados de usuários com restrição de comércio podem se tornar públicos?](#how-are-organization-accounts-impacted) ###
...
### [Os usuários com restrição de comércio podem acessar os dados do repositório privado (por exemplo, download ou exclusão de dados do repositório)?](#can-trade-restricted-users-private-repositories-be-made-public) ###
...
### [Sob a licença que o GitHub recebeu da OFAC, quais tipos de contas estarão disponíveis no Irã?](#can-trade-restricted-users-access-private-repository-data-eg-downloading-or-deletion-of-repository-data) ###
...
### [Os usuários iranianos do GitHub poderão usar serviços pagos segundo a licença?](#under-the-license-github-has-received-from-ofac-which-types-of-accounts-will-be-available-in-iran) ###
...
### [Você pode esclarecer a disponibilidade do GitHub para desenvolvedores cubanos?](#will-iranian-github-users-be-able-to-use-paid-services-under-the-license) ###
