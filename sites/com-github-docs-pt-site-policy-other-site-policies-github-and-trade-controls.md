...
### [](#on-which-countries-and-territories-are-us-government-sanctions-applied)Em quais países e territórios as sanções do governo americano são aplicadas? ###
...
### [](#will-traveling-in-these-regions-be-impacted)As viagens para essas regiões serão afetadas? ###
...
### [](#what-is-available-and-not-available)O que está disponível e o que não está disponível? ###
...
### [](#how-are-organization-accounts-impacted)Como as contas corporativas são afetadas? ###
...
### [](#can-trade-restricted-users-private-repositories-be-made-public)Os repositórios privados de usuários com restrição de comércio podem se tornar públicos? ###
...
### [](#can-trade-restricted-users-access-private-repository-data-eg-downloading-or-deletion-of-repository-data)Os usuários com restrição de comércio podem acessar os dados do repositório privado (por exemplo, download ou exclusão de dados do repositório)? ###
...
### [](#under-the-license-github-has-received-from-ofac-which-types-of-accounts-will-be-available-in-iran)Sob a licença que o GitHub recebeu da OFAC, quais tipos de contas estarão disponíveis no Irã? ###
...
### [](#will-iranian-github-users-be-able-to-use-paid-services-under-the-license)Os usuários iranianos do GitHub poderão usar serviços pagos segundo a licença? ###
