GitHub e Controle de Comércio - Documentação do GitHub
...
* [Visão geral da exportação](#visão-geral-da-exportação)
...
### [](#em-quais-países-e-territórios-as-sanções-do-governo-americano-são-aplicadas)[]()Em quais países e territórios as sanções do governo americano são aplicadas? ###
...
### [](#como-o-github-está-garantindo-que-as-pessoas-que-não-vivem-eou-têm-vínculos-profissionais-com-os-países-e-territórios-sancionados-ainda-tenham-acesso-ou-possibilidade-de-apelar)[]()Como o GitHub está garantindo que as pessoas que não vivem e/ou têm vínculos profissionais com os países e territórios sancionados ainda tenham acesso ou possibilidade de apelar? ###
...
### [](#as-viagens-para-essas-regiões-serão-afetadas)[]()As viagens para essas regiões serão afetadas? ###
...
### [](#o-que-está-disponível-e-o-que-não-está-disponível)[]()O que está disponível e o que não está disponível? ###
...
### [](#como-você-define-esses-usuários-específicos)[]()Como você define esses usuários específicos? ###
...
### [](#como-as-contas-corporativas-são-afetadas)[]()Como as contas corporativas são afetadas? ###
...
### [](#os-repositórios-privados-de-usuários-com-restrição-de-comércio-podem-se-tornar-públicos)[]()Os repositórios privados de usuários com restrição de comércio podem se tornar públicos? ###
...
### [](#os-usuários-com-restrição-de-comércio-podem-acessar-os-dados-do-repositório-privado-por-exemplo-download-ou-exclusão-de-dados-do-repositório)[]()Os usuários com restrição de comércio podem acessar os dados do repositório privado (por exemplo, download ou exclusão de dados do repositório)? ###
...
### [](#sob-a-licença-que-o-github-recebeu-da-ofac-quais-tipos-de-contas-estarão-disponíveis-no-irã)[]()Sob a licença que o GitHub recebeu da OFAC, quais tipos de contas estarão disponíveis no Irã? ###
...
### [](#os-usuários-iranianos-do-github-poderão-usar-serviços-pagos-segundo-a-licença)[]()Os usuários iranianos do GitHub poderão usar serviços pagos segundo a licença? ###
...
### [](#você-pode-esclarecer-a-disponibilidade-do-github-para-desenvolvedores-cubanos)[]()Você pode esclarecer a disponibilidade do GitHub para desenvolvedores cubanos? ###
