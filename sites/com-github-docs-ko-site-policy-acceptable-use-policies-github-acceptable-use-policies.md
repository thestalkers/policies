...
* 당사 서버를 사용하여 서비스, 장치, 데이터, 계정 또는 네트워크를 방해하거나 방해를 시도하거나 무단으로 액세스하거나 그러한 액세스를 시도하는 경우. [GitHub 버그](https://bounty.github.com) 장려금 프로그램과 같은 버그 장려금 프로그램에서 허용되는 활동은 "권한 없음"으로 간주되지 않지만 버그 현상금 프로그램이 활동을 승인한 organization만 영향을 주어야 합니다.
