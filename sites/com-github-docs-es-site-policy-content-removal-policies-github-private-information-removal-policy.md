...
* Contenido que se rige por nuestras [Directrices de la Comunidad](/es/articles/github-community-guidelines), como malware o herramientas para fines generales. Si tiene preguntas acerca de nuestras Directrices de la Comunidad o cree que el contenido de GitHub podría infringir nuestras directrices, puede usar [Informar sobre contenido](https://github.com/contact/report-content) para ponerse en contacto con nosotros.
