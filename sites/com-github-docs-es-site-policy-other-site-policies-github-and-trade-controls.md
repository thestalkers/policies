...
* [Preguntas más frecuentes](#github-copilot)
...
### [¿A qué países y territorios se aplican las sanciones de la administración pública de EE. UU.?](#frequently-asked-questions) ###
...
### [¿Cómo garantiza GitHub que las personas que no viven en países y territorios sancionados ni tienen vínculos profesionales con ellos dispongan de acceso o capacidad para apelar?](#on-which-countries-and-territories-are-us-government-sanctions-applied) ###
...
### [¿Viajar a estas regiones afecta a la cuenta?](#how-is-github-ensuring-that-folks-not-living-in-andor-having-professional-links-to-the-sanctioned-countries-and-territories-still-have-access-or-ability-to-appeal) ###
...
### [¿Qué está disponible y qué no?](#will-traveling-in-these-regions-be-impacted) ###
...
### [¿Cómo se define a estos usuarios específicos?](#what-is-available-and-not-available) ###
...
### [¿Cómo se ven afectadas las cuentas de organizaciones?](#how-do-you-define-these-specific-users) ###
...
### [¿Pueden hacerse públicos los repositorios privados de usuarios sometidos a restricciones comerciales?](#how-are-organization-accounts-impacted) ###
...
### [¿Los usuarios sometidos a restricciones comerciales pueden obtener acceso a los datos de repositorios privados (por ejemplo, para descargar o eliminar los datos del repositorio)?](#can-trade-restricted-users-private-repositories-be-made-public) ###
...
### [Según la licencia que GitHub recibió de la OFAC, ¿qué tipos de cuentas estarán disponibles en Irán?](#can-trade-restricted-users-access-private-repository-data-eg-downloading-or-deletion-of-repository-data) ###
...
### [¿Los usuarios iraníes de GitHub podrán usar servicios de pago en virtud de la licencia?](#under-the-license-github-has-received-from-ofac-which-types-of-accounts-will-be-available-in-iran) ###
...
### [¿Pueden aclarar la disponibilidad de GitHub para los desarrolladores cubanos?](#will-iranian-github-users-be-able-to-use-paid-services-under-the-license) ###
