...
GitHub Copilot no puede venderse, exportarse ni reexportarse a ningún país que figure en el grupo de países E:1 del suplemento n.º 1 de la parte 740 de las Regulaciones de Administración de Exportaciones (EAR) o a las siguientes regiones de Ucrania: Crimea y las áreas separatistas de Donetsk y Lugansk, sin autorización. Aunque la lista está sujeta a cambios, actualmente incluye Cuba, Irán, Corea del Norte, Siria, Rusia y Bielorrusia.

[Preguntas más frecuentes](#frequently-asked-questions)
----------

### [¿A qué países y territorios se aplican las sanciones de la administración pública de EE. UU.?](#on-which-countries-and-territories-are-us-government-sanctions-applied) ###
...
### [¿Cómo garantiza GitHub que las personas que no viven en países y territorios sancionados ni tienen vínculos profesionales con ellos dispongan de acceso o capacidad para apelar?](#how-is-github-ensuring-that-folks-not-living-in-andor-having-professional-links-to-the-sanctioned-countries-and-territories-still-have-access-or-ability-to-appeal) ###
...
### [¿Viajar a estas regiones afecta a la cuenta?](#will-traveling-in-these-regions-be-impacted) ###
...
### [¿Qué está disponible y qué no?](#what-is-available-and-not-available) ###
...
### [¿Cómo se define a estos usuarios específicos?](#how-do-you-define-these-specific-users) ###
...
### [¿Cómo se ven afectadas las cuentas de organizaciones?](#how-are-organization-accounts-impacted) ###
...
### [¿Pueden hacerse públicos los repositorios privados de usuarios sometidos a restricciones comerciales?](#can-trade-restricted-users-private-repositories-be-made-public) ###
...
### [¿Los usuarios sometidos a restricciones comerciales pueden obtener acceso a los datos de repositorios privados (por ejemplo, para descargar o eliminar los datos del repositorio)?](#can-trade-restricted-users-access-private-repository-data-eg-downloading-or-deletion-of-repository-data) ###
...
### [¿Los usuarios iraníes de GitHub podrán usar servicios de pago en virtud de la licencia?](#will-iranian-github-users-be-able-to-use-paid-services-under-the-license) ###
...
### [¿Pueden aclarar la disponibilidad de GitHub para los desarrolladores cubanos?](#can-you-clarify-availability-of-github-to-cuban-developers) ###
