...
[](#export-overview)Resumen sobre la exportación
----------
...
### [](#on-which-countries-and-territories-are-us-government-sanctions-applied)¿A qué países y territorios se aplican las sanciones de la administración pública de EE. UU.? ###
...
### [](#how-is-github-ensuring-that-folks-not-living-in-andor-having-professional-links-to-the-sanctioned-countries-and-territories-still-have-access-or-ability-to-appeal)¿Cómo garantiza GitHub que las personas que no viven en países y territorios sancionados ni tienen vínculos profesionales con ellos dispongan de acceso o capacidad para apelar? ###
...
### [](#will-traveling-in-these-regions-be-impacted)¿Viajar a estas regiones afecta a la cuenta? ###
...
### [](#what-is-available-and-not-available)¿Qué está disponible y qué no? ###
...
### [](#how-do-you-define-these-specific-users)¿Cómo se define a estos usuarios específicos? ###
...
### [](#how-are-organization-accounts-impacted)¿Cómo se ven afectadas las cuentas de organizaciones? ###
...
### [](#can-trade-restricted-users-private-repositories-be-made-public)¿Pueden hacerse públicos los repositorios privados de usuarios sometidos a restricciones comerciales? ###
...
### [](#can-trade-restricted-users-access-private-repository-data-eg-downloading-or-deletion-of-repository-data)¿Los usuarios sometidos a restricciones comerciales pueden obtener acceso a los datos de repositorios privados (por ejemplo, para descargar o eliminar los datos del repositorio)? ###
...
### [](#under-the-license-github-has-received-from-ofac-which-types-of-accounts-will-be-available-in-iran)Según la licencia que GitHub recibió de la OFAC, ¿qué tipos de cuentas estarán disponibles en Irán? ###
...
### [](#will-iranian-github-users-be-able-to-use-paid-services-under-the-license)¿Los usuarios iraníes de GitHub podrán usar servicios de pago en virtud de la licencia? ###
...
### [](#can-you-clarify-availability-of-github-to-cuban-developers)¿Pueden aclarar la disponibilidad de GitHub para los desarrolladores cubanos? ###
