법적 사용자 데이터 요청을 위한 가이드라인 - GitHub 문서(function(){
...
GitHub에 법적 절차를 제출함으로써 해당 법적 절차가 캘리포니아에서 합법한 낙태 관련 행위에 대한 책임을 지우는 법률 위반과는 관련이 없음을 증명합니다.
...
다른 질문, 의견 또는 제안이 있으십니까? 사이트 관리자가 [GitHub 지원 포털](https://support.github.com)에 문의하세요.
