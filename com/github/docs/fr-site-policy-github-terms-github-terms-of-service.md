...
* [E. Dépôts privés](#9-access-reciprocity)
* [F. Violation des droits d'auteur et politique DMCA](#f-violation-des-droits-dauteur-et-politique-dmca)
* [G. Avis sur la Propriété Intellectuelle](#f-copyright-infringement-and-dmca-policy)
* [H. Conditions du API](#3-license-to-github-policies)
* [I. Conditions des Produits Supplémentaires de GitHub](#h-api-terms)
* [J. Aperçus bêta](#i-github-additional-product-terms)
* [K. Paiement](#3-development-and-improvement-using-your-input-and-output)
* [L. Annulation et résiliation](#3-feedback)
* [m. Communication avec GitHub](#4-authorization)
* [N. Exclusion de garantie](#2-upon-cancellation)
* [O. Limitation de responsabilité.](#3-github-may-terminate)
* [P. Libération et indemnisation](#4-survival)
* [Q. Modifications des présentes Conditions](#n-communications-with-github)
* [R. Dispositions diverses](#1-electronic-communication-required)
...
### [3. Propriété du Contenu, Droit de Publication et Octroi de Licence](#3-ownership-and-license-grants) ###
...
### [8. Réciprocité d’accès](#8-public-repositories-and-lawful-access) ###
...
La présente section D.8 ne s’applique pas uniquement à l’Accès à des fins de recherche académique ou si, à la date à laquelle vous accédez au contenu, le nombre d’utilisateurs actifs mensuels des produits ou services mis à disposition par vous est inférieur à 700 millions au cours du mois calendrier précédent. Dans le cadre de cette section, « vous » fait référence à vous et à toute entité qui contrôle directement ou indirectement, est contrôlée par ou est sous contrôle commun avec vous (affiliés).
...
### [1. Contrôle des Dépôts Privés](#e-private-repositories) ###

Certains comptes peuvent avoir des référentiels privés, qui permettent à l'utilisateur de contrôler l'accès au contenu.

### [2. Confidentialité des Dépôts Privés](#1-control-of-private-repositories) ###
...
### [3. Accès](#2-confidentiality-of-private-repositories) ###
...
### [1. Droits de GitHub sur le Contenu](#g-intellectual-property-notice) ###
...
### [2. Marques commerciale et Logos de GitHub](#1-githubs-rights-to-content) ###
...
### [3. Licence sur les politiques de GitHub](#2-github-trademarks-and-logos) ###
...
### [1. Sous réserve de modifications](#j-ai-features-training-and-your-data) ###
...
### [2. Confidentialité](#1-applicability) ###
...
### [3. Commentaires et avis](#2-ownership) ###
...
### [2. Mises à niveau, rétrogradations et modifications](#5-your-responsibility-and-indemnity) ###
...
### [3. Calendrier de Facturation ; Aucun Remboursement](#k-beta-previews) ###
...
### [4. Autorisation](#1-subject-to-change) ###
...
### [5. Responsabilité du paiement](#2-confidentiality) ###
...
### [1. Annulation du Compte](#l-payment) ###
...
### [2. En cas d’annulation](#1-pricing) ###
...
### [3. Résiliation par GitHub](#2-upgrades-downgrades-and-changes) ###
...
### [4. Maintien en vigueur de certaines clauses](#3-billing-schedule-no-refunds) ###
...
### [1. Communication électronique requise](#5-responsibility-for-payment) ###
...
### [2. Toute notification légale à GitHub doit se faire par écrit](#m-cancellation-and-termination) ###
...
### [3. Aucune assistance téléphonique](#1-account-cancellation) ###
...
### [1. Droit applicable](#2-legal-notice-to-github-must-be-in-writing) ###

Sauf dans la mesure où la loi applicable en dispose autrement, le présent accord entre vous et GitHub et tout accès ou utilisation du site Web ou du service sont régis par les lois fédérales des États-Unis d'Amérique et les lois de l'État de Californie, sans égard aux dispositions relatives aux conflits de lois. Vous et GitHub acceptez de vous soumettre à la juridiction et au lieu exclusifs des tribunaux situés dans la ville et le comté de San Francisco, en Californie. Toutefois, une revendication en cas de mesure injonctive en ce qui concerne une violation de la section D.8 peut être introduite dans toute juridiction.

### [2. Incessibilité](#3-no-phone-support) ###
...
### [3. Titres et résumés des sections](#o-disclaimer-of-warranties) ###
...
### [4. Divisibilité, Absence de renonciation et Maintien en vigueur des Clauses](#p-limitation-of-liability) ###
...
### [5. Modifications ; Intégralité de l’Accord](#q-release-and-indemnification) ###
...
### [6. Questions](#r-changes-to-these-terms) ###
