Conditions Générales d’Utilisation de GitHub - Documentation GitHub(function(){
...
3. [Conditions Générales d’Utilisation de GitHub](/fr/site-policy/github-terms/github-terms-of-service)
...
|             [J. Fonctionnalités IA, entraînement et vos données](#j-ai-features-training-and-your-data)              |Il s’agit des conditions qui s’appliquent à GitHub Copilot et à d’autres Fonctionnalités IA, notamment la façon dont vos données peuvent être utilisées pour le développement et l’amélioration des modèles d’intelligence artificielle et d’apprentissage automatique, ainsi que les contrôles à votre disposition.|
|                                  [K. Versions Bêta Préliminaires](#k-beta-previews)                                  |                                                                                           Voici quelques-uns des termes supplémentaires qui s'appliquent aux fonctionnalités de GitHub qui sont encore en développement.                                                                                           |
|                                              [L. Paiement](#l-payment)                                               |                                                                                                            Vous êtes responsable du paiement. Nous sommes responsables de vous facturer avec précision.                                                                                                            |
|                           [M. Annulation et résiliation](#m-cancellation-and-termination)                            |                                                                                                                        Vous pouvez annuler cet accord et fermer votre compte à tout moment.                                                                                                                        |
|                            [N. Communications avec GitHub](#n-communications-with-github)                            |                                                                Nous utilisons uniquement le courrier électronique et d'autres moyens électroniques pour rester en contact avec nos utilisateurs. Nous ne fournissons pas d'assistance téléphonique.                                                                |
|                               [O. Exclusion de garanties](#o-disclaimer-of-warranties)                               |                                                     Nous fournissons notre service tel quel, et nous ne faisons aucune promesse ou garantie concernant ce service. **Veuillez lire attentivement cette section ; vous devez comprendre à quoi vous attendre.**                                                     |
|                            [P. Limitation de responsabilité](#p-limitation-of-liability)                             |                     Nous ne serons pas responsables des dommages ou des pertes résultant de votre utilisation ou de votre incapacité à utiliser le service ou autrement découlant du présent accord. **Veuillez lire attentivement cette section ; elle limite nos obligations envers vous.**                      |
|                            [Q. Décharge et Indemnisation](#q-release-and-indemnification)                            |                                                                                                                         Vous êtes entièrement responsable de votre utilisation du service.                                                                                                                         |
|      [R. Modifications apportées aux présentes Conditions d’utilisation du service](#r-changes-to-these-terms)       |                                                                                                Nous pouvons modifier cet accord, mais nous vous donnerons un préavis de 30 jours en cas de changements importants.                                                                                                 |
|                                     [S. Dispositions diverses](#s-miscellaneous)                                     |                                                                                                            Veuillez consulter cette section pour les détails juridiques, y compris notre choix de loi.                                                                                                             |
...
3. « Fonctionnalité IA » signifie toute fonctionnalité de GitHub ou de nos affiliés qui utilise l’apprentissage automatique ou l’intelligence artificielle pour générer la sortie, notamment GitHub Copilot, Copilot Autofix et toute autre fonctionnalité identifiée comme exploitant l’apprentissage automatique ou l’intelligence artificielle dans notre documentation.

4. « Affilié » désigne toute entité qui, directement ou indirectement, contrôle, est contrôlée par ou est sous contrôle commun avec une partie, le terme « contrôle » désignant le fait de détenir plus de cinquante pour cent (50 %) de la propriété ou du droit de diriger la gestion de l’entité. Pour dissiper tout doute, Microsoft est un Affilié de GitHub.

5. « Versions Bêta Préliminaires » désigne les logiciels, services ou fonctionnalités identifiés comme alpha, bêta, en version préliminaire, à accès anticipé ou en cours d’évaluation, ou des mots ou des expressions ayant des significations similaires.

6. « Contenu » signifie du code, du texte, des données, de la documentation, des images, des graphiques, des logiciels, des packages et d’autres documents mis à disposition via le Service.

7. « GitHub », « Nous » et « Nous » font référence à GitHub, Inc., ainsi qu’à nos affiliés, administrateurs, filiales, sous-traitants, concédants de licence, dirigeants, agents et employés.

8. « Entrée » désigne tout contenu ou contexte fourni à une Fonctionnalité IA, notamment les invites, les pièces jointes, le code dans votre espace de travail et l’historique des conversations.

9. « Sortie » signifie des réponses et des suggestions, notamment du code ou d’autres éléments, générés par une Fonctionnalité IA.

10. Le « Service » fait référence aux applications, logiciels, produits et services fournis par GitHub, notamment le site web et les aperçus bêta.

11. « Utilisateur », « Vous » et « Votre » font référence à la personne, à l’entreprise ou à l’organisation qui a visité ou utilise le site Web ou le service ; qui accède ou utilise une partie du Compte ; ou qui dirige l’utilisation du Compte dans l’exercice de ses fonctions. Un Utilisateur doit être âgé d'au moins 13 ans. Des conditions spéciales peuvent s’appliquer aux Comptes d’entreprises ou de gouvernements (voir la [Section B(5) : Conditions Supplémentaires](#5-additional-terms)).

12. « Contenu généré par l’utilisateur » signifie le contenu que vous ou d’autres utilisateurs chargez, soumettez ou créez via le Service.

13. Le « Site Web » fait référence au site Web de GitHub situé à l’adresse [github.com](https://github.com/), ainsi qu’à tous les contenus, services et produits fournis par GitHub sur le Site Web ou par l’intermédiaire de celui-ci. Il désigne également les sous-domaines de github.com appartenant à GitHub, notamment [education.github.com](https://education.github.com/) et [pages.github.com](https://pages.github.com/). Les présentes Conditions régissent également les sites web de conférence de GitHub, tels que [githubuniverse.com](https://githubuniverse.com/), et les sites web de produits, tels que [electronjs.org](https://www.electronjs.org/). Parfois, les sites web appartenant à GitHub peuvent fournir des conditions d’utilisation différentes ou supplémentaires. Si ces conditions supplémentaires entrent en conflit avec le présent Contrat, les conditions plus spécifiques s'appliquent à la page ou au service concerné.

14. « Votre contenu » signifie le Contenu généré par l’utilisateur que vous chargez, soumettez ou créez, notamment vos modifications apportées au Contenu que vous avez dupliqués ou clonés. Il n’inclut pas le Contenu sous-jacent créé par d’autres utilisateurs.
...
Vous devez fournir une adresse e-mail valide afin de terminer le processus d'inscription. Toute autre information demandée, comme votre nom réel, est facultative, à moins que vous n’acceptiez ces conditions au nom d’une entité juridique (auquel cas nous avons besoin de plus d’informations sur cette entité) ou si vous optez pour un [Compte payant](#l-payment), auquel cas des informations supplémentaires seront nécessaires à des fins de facturation.

### [3. Exigences relatives aux Comptes](#3-account-requirements) ###

Nous avons quelques règles simples pour les comptes sur le service GitHub.
...
Vous êtes responsable de votre Contenu et de tout dommage qui en résulte. Cela inclut le Contenu que vous publiez, chargez ou mettez à disposition via le Service. Nous ne sommes pas responsables de l’affichage public ou de l’utilisation abusive de votre Contenu.

### [2. GitHub peut supprimer du contenu](#2-github-may-remove-content) ###

Nous pouvons refuser ou supprimer le Contenu généré par l’utilisateur qui enfreint la réglementation applicable ou nos conditions et stratégies. Nous accédons aux référentiels privés uniquement comme décrit dans la section E. Le Contenu affiché sur GitHub Mobile peut être soumis aux conditions de l’App Store.

### [3. Propriété et concessions de licence](#3-ownership-and-license-grants) ###

Vous êtes propriétaire de votre Contenu. Si vous publiez un Contenu que vous n’avez pas créé, vous êtes responsable de veiller à ce que vous avez le droit de le publier et à vous conformer aux licences applicables.

Vous nous accordez, ainsi qu’à d’autres Utilisateurs, les licences dans les Sections D.4 à D.8. Ces licences s’appliquent à Votre Contenu. Si Votre Contenu inclut déjà une licence nous accordant les autorisations dont nous avons besoin, aucune licence supplémentaire n’est requise. Vous ne recevrez pas de paiement pour ces droits. Ces licences prendront fin lorsque vous supprimerez Votre Contenu, à moins que d’autres Utilisateurs ne l’aient dupliqué.

### [4. Octroi d’une Licence en Notre Faveur](#4-license-grant-to-us) ###

Vous accordez à GitHub et à nos Affiliés le droit de stocker, d’héberger, d’archiver, d’analyser, d’afficher et de faire des copies de votre contenu si nécessaire pour fournir, développer et améliorer le Service, notamment par l’entraînement des Fonctionnalités IA, ainsi que pour l’entraînement, le développement et l’amélioration des modèles et technologies d’intelligence artificielle et d’apprentissage automatique de nos Affiliés. Cette licence inclut le droit de faire des choses comme la copier dans notre base de données et faire des sauvegardes ; le montrer à vous et aux autres Utilisateurs ; l’analyser dans un index de recherche ou l’analyser autrement sur nos serveurs ; partagez-le avec d’autres Utilisateurs ; et l’exécuter, au cas où votre contenu serait quelque chose comme de la musique ou une vidéo. Pour dissiper tout doute, l’utilisation de Votre Contenu pour développer, former et améliorer l’intelligence artificielle et les modèles et technologies d’apprentissage automatique de GitHub et de nos Affiliés se trouve dans l’étendue de cette licence et ne constitue pas une vente ou un autre transfert restreint de votre contenu.

### [5. Octroi de licences à d’autres utilisateurs](#5-license-grant-to-other-users) ###

Votre Contenu que vous publiez publiquement, y compris les problèmes, les commentaires et les contributions aux référentiels d’autres utilisateurs, peut être consulté par d’autres. En configurant vos référentiels pour qu’ils soient consultés publiquement, vous acceptez d’autoriser d’autres personnes à visualiser et à « dupliquer » vos référentiels (cela signifie que d’autres peuvent faire leurs propres copies du contenu de vos référentiels dans les référentiels qu’ils contrôlent).

En rendant un référentiel public, vous accordez à d’autres Utilisateurs une licence non exclusive, mondiale pour utiliser, afficher, exécuter et reproduire (en dupliquant) Votre Contenu via le Service, tel qu’il est autorisé par la fonctionnalité de GitHub. Vous pouvez accorder des droits supplémentaires en [adoptant une licence](/fr/communities/setting-up-your-project-for-healthy-contributions/adding-a-license-to-a-repository#including-an-open-source-license-in-your-repository). Si vous publiez du Contenu que vous n’avez pas créé ou possédé, vous êtes responsable de veiller à ce qu’il soit concédé sous licence en vertu des conditions qui autorisent ces utilisations.
...
### [8. Référentiels publics et accès légal](#8-public-repositories-and-lawful-access) ###

En choisissant de contribuer au Contenu à un référentiel public, vous choisissez de nous diriger pour rendre ce Contenu accessible à tout le monde sur Internet. Sauf indication spécifique, ces Conditions ne limitent pas l’accès légal au contenu ou à l’utilisation du contenu des référentiels publics par des tiers, ou par GitHub ou ses Affiliés.

### [9. Réciprocité d’accès](#9-access-reciprocity) ###

En utilisant des moyens automatisés d’accès, de collecte ou de toute autre utilisation (« Accès ») de tout contenu accessible publiquement à partir du service à des fins de développement ou de formation de tout modèle d’intelligence artificielle disponible commercialement, de système machine learning ou de technologie similaire (un « Système d’IA commerciale »), vous renoncez par la présente à toutes les stratégies, conditions, conditions générales ou dispositions contractuelles régissant les produits, services, sites web ou jeux de données que vous possédez ou utilisez qui interdiraient, restreindraient ou placeraient des conditions sur l’accès de GitHub à des données, informations ou contenus accessibles publiquement associés à vos produits ou services, y compris dans le but de développer ou de former tout système d’IA commerciale. Vous acceptez également de ne pas imposer de mesures techniques ou d’autres mesures ciblées pour restreindre ou contre-attaquer ce type d’accès.

La présente Section D.9 ne s’applique pas uniquement à l’Accès à des fins de recherche académique ou si, à la date à laquelle vous accédez au Contenu, le nombre d’utilisateurs actifs mensuels des produits ou services mis à disposition par vous est inférieur à 700 millions au cours du mois calendrier précédent. Dans le cadre de cette section, « vous » fait référence à vous et à toute entité qui contrôle directement ou indirectement, est contrôlée par ou est sous contrôle commun avec vous (affiliés).

[E. Dépôts privés](#e-private-repositories)
----------

**Version courte :***Nous traitons le contenu des dépôts privés comme confidentiel et nous n’y accédons que de la manière décrite dans notre Section E.3 ci-dessous, à savoir à des fins de sécurité, pour aider le propriétaire du dépôt dans le cadre d’une question d’assistance, pour maintenir l’intégrité du Service, pour nous conformer à nos obligations légales, si nous avons des raisons de croire que le contenu est en violation de la loi, ou avec votre consentement.*
...
### [2. Confidentialité des Référentiels Privés](#2-confidentiality-of-private-repositories) ###

GitHub considère que le contenu des référentiels privés est confidentiel pour vous. GitHub protégera le contenu des référentiels privés contre l'utilisation, l'accès ou la divulgation non autorisés de la même manière que nous utiliserions pour protéger nos propres informations confidentielles de nature similaire et en aucun cas avec moins qu'un degré de soin raisonnable.

### [3. Accès](#3-access) ###

Vous contrôlez l’accès au contenu de vos référentiels privés. GitHub considère que le contenu des référentiels privés est confidentiel pour vous, comme indiqué dans la Section E.2, et que le personnel GitHub n’accède pas au contenu du référentiel privé sans votre consentement, sauf dans les circonstances suivantes :
...
* Si vous fournissez votre contenu de référentiel privé en tant qu’entrée aux Fonctionnalités IA, nous pouvons utiliser cette entrée pour fournir, développer, entraîner et améliorer le Service, notamment les Fonctionnalités IA. Votre possibilité de vous désengager conformément à la [Section J.3](#3-development-and-improvement-using-your-input-and-output) s’applique à cette utilisation du contenu du référentiel privé. Nous n’utiliserons pas autrement le contenu de votre référentiel privé pour développer ou améliorer le Service.

En outre, nous pouvons être [contraints par la loi](/fr/site-policy/privacy-policies/github-general-privacy-statement#for-legal-disclosure) de divulguer le contenu de vos dépôts privés.

GitHub fournira un avis concernant notre accès au contenu des dépôts privés, sauf [en cas de divulgation légale](/fr/site-policy/privacy-policies/github-general-privacy-statement#for-legal-disclosure), pour se conformer à nos obligations légales, ou lorsqu’elle est autrement liée par des exigences légales, pour une analyse automatisée, ou en réponse à une menace de sécurité ou à un autre risque pour la sécurité.
...
Nous résilierons les Comptes des [contrevenants répétés](/fr/site-policy/content-removal-policies/dmca-takedown-policy#f-repeated-infringement) de cette stratégie.
...
**Version courte :***Vous acceptez les présentes Conditions d’utilisation du Service, ainsi que la présente Section H, lorsque vous utilisez l’une des API (Application Programming Interface) de GitHub, y compris l’utilisation de l’API par le biais d’un produit tiers qui accède à GitHub.*
...
Cette section s’applique à toutes les Fonctionnalités IA, sauf si une fonctionnalité spécifique a des conditions supplémentaires qui les modifient expressément. Les dispositions d’entraînement et d’utilisation des données de la Section J.3 s’appliquent uniquement aux licences individuelles. Si votre utilisation du Service est régie par un contrat client GitHub ou un contrat de programme de licence en volume, ces contrats régissent l’utilisation de vos données en lien avec les Fonctionnalités IA et la Section J.3 ne s’appliquent pas à vous.

### [2. Propriété](#2-ownership) ###

GitHub ne revendique pas la propriété de votre entrée ou sortie.

La sortie peut contenir des éléments qui ressemblent au code ou au contenu des données d’apprentissage du modèle ou qui sont soumis à des droits d’auteur tiers ou à des conditions de licence open source. Vous êtes responsable de déterminer si votre utilisation de Sortie nécessite une licence tierce et de vous conformer à une telle licence.

### [3. Développement et amélioration à l’aide de vos entrées et sorties](#3-development-and-improvement-using-your-input-and-output) ###

Nous utilisons vos Entrées pour générer des Sorties et fournir les Fonctionnalités IA. Vous accordez également à GitHub et à ses Affiliés une licence pour collecter et utiliser vos Entrées et Sorties pour développer, former et améliorer les modèles et technologies d’intelligence artificielle et d’apprentissage automatique, notamment celles qui alimentent les Fonctionnalités IA, sauf si (a) vous vous désengagez de vos paramètres de compte, ou (b) votre utilisation du Service est régie par un Contrat client GitHub ou un contrat de programme de licence en volume. Si vous vous désengagez, GitHub ne collectera pas ou n’utilisera pas vos Entrées et Sorties aux fins décrites dans le présent paragraphe à partir de la date d’entrée en vigueur de votre désengagement.

Sauf désengagement de votre part, les Affiliés de GitHub peuvent utiliser vos Entrées et Sorties conformément à la présente licence conformément à leurs obligations de confidentialité et contractuelles applicables. Toutefois, cette licence n’autorise pas GitHub ou ses Affiliés à partager vos Entrées ou Sorties avec des fournisseurs de modèles IA tiers à des fins d’entraînement de modèles indépendant.

La licence de cette Section J.3 est en plus, sans s’y limiter, des droits accordés à GitHub et à ses Affiliés dans les Sections D.4 et D.8. Cette licence ne s’étend pas à Votre Contenu stocké dans des référentiels qui ne sont pas fournis en tant qu’Entrée à une Fonctionnalité IA.

Le droit de désactivation décrit dans cette section s’applique uniquement à l’utilisation de vos Entrées et Sorties, comme décrit dans cette section, et ne s’applique pas à la licence accordée dans les Sections D.4-D.8 ou à tout contenu qui ne constitue pas une Entrée ou une Sortie (notamment le Contenu stocké dans des référentiels publics).

### [4. Clauses de non-responsabilité](#4-disclaimers) ###

La Sortie est fournie « en l’état » et soumise aux exclusions de responsabilité dans la Section O. Sans se limiter à la section O : la Sortie peut être inexacte, incomplète ou non fonctionnelle. La Sortie peut ressembler à du code tiers, notamment du code sous licences open source. Nous ne garantissons pas que la Sortie est exempte d’erreurs, de vulnérabilités ou de revendications de propriété intellectuelle.

Vous êtes responsable de la vérification, du test et de la validation d’une Sortie avant l’utilisation.

### [5. Votre Responsabilité et votre Indemnité](#5-your-responsibility-and-indemnity) ###

Vous êtes responsable de votre utilisation de la Sortie, notamment en vous assurant qu’elle est conforme à la réglementation applicable et n’enfreint pas les droits tiers.

Vos obligations d’indemnisation dans la Section Q s’appliquent à votre utilisation des Fonctionnalités IA et Sortie, y compris les revendications découlant de la désactivation que vous incorporez dans vos produits ou services.
...
Nos conditions de prix et de paiement sont disponibles sur [github.com/pricing](https://github.com/pricing). Si vous acceptez un prix d'abonnement, celui-ci restera votre prix pendant toute la durée du délai de paiement ; cependant, les prix sont sujets à changement à la fin d'un délai de paiement.
...
En acceptant ces Conditions, vous nous autorisez à débiter votre carte de crédit enregistrée, votre compte PayPal ou tout autre mode de paiement approuvé pour les frais que vous autorisez pour GitHub.
