...
スポンサード デベロッパーへのすべての支払いは、GitHub ではなく Stripe によって処理および配布されます。 GitHub は、スポンサード デベロッパーに資金を送金したり、資金を譲渡したりすることはありません。 すべての支払いタイミング、方法、およびプロセスは、Stripe 規約に従って Stripe によって制御されます。 GitHub では、Stripe による支払い方法やタイミングを制御できなくなります。
...
* ACH 送金、または電信送金を使用して支払われる場合、当月の第 3 木曜日が受取日になります。 Stripe は、残高が 100 米ドルに達した月について支払いを行います。 GitHub スポンサー マッチング ファンドからの出資はこのしきい値に加算されません。 月末の残高が 100 米ドル未満の場合、月末の残高が次回しきい値を超えるまで残高に利子がつきます。 GitHub スポンサーを辞める場合、Stripe は、残高が100 米ドル未満の場合でも残額に対して支払いを行います。

* プールされた資金からの支払い。 SOSSファンドまたは同様のプールされた資金調達メカニズムに参加しているスポンサードデベロッパーの場合、支払いのタイミングとプロセスは上記のように残ります。 スポンサーシップがファンドプロファイルからあなたに割り当てられるとき: 割り当てはStripeによって保持され、管理されているプールされた資金から引き出されます。GitHub によるスポンサーシップの割り当てを確認すると、Stripe は Stripe 規約に従って Stripe によって決定された標準的な Stripe Connect 決済タイミングに従って、Stripe によってお客様の Stripe Connect アカウントに直ちに送金されます。プールされていないスポンサー プランの場合と同じ支払いスケジュール、支払い方法、銀行口座の要件が適用され、Stripe 規約に従って Stripe によって決定されます。 GitHub は、Stripe からスポンサード デベロッパーへの支払いのタイミング、方法、または実行を制御しません。 すべての支払い処理は、Stripe の使用条件に従います。

* 終了後、当社により本追加条件が終了したと認識される暦月末後から約 90 日以内に、Stripe は、Stripe Connect を通じて、それまでに受領され、未払いとなっている、すべての支援対象開発者の支払いを処理し、お客様に送金します。

### [3.4. 支払い方法。](#34-payment-method) ###

Stripe は、GitHub が随時更新する、その時点で最新の支払ポリシーに指定されるしきい値、方法、および期間に従って、支援対象開発者の支払いを ACH/SEPA または電信でお客様が指定する口座に送金します。 支払方法としきい値は、国およびお客様が提供する口座情報によって異なります。 Stripe は、独自の裁量で、支援対象開発者の支払いと本プログラムに関連してお客様に支払い義務があるその他の支援対象開発者への支払いを組み合わせる場合があります。

### [3.5. 通貨型。](#35-currency) ###

通貨の記述はすべて米ドルです。 お客様がアメリカ合衆国以外に所在している場合、当社は、当社のその時点の換算レートを使用して、米ドルをお客様の支払先住所の現地通貨に換算することができます。
...
支援対象開発者報酬を受け取るには、お客様は、当社が要求する完全かつ正確な財務、税、および銀行に関する情報を提供する必要があります (たとえば、口座の開設などを行うことにより)。 当社は、何らかの通信手段で、必要な情報の変更をお客様に通知します。 お客様がかかる情報を正確に指定 (または正確に管理) しない場合、(a) 当社はお客様の支援対象開発者の支払いから関連する銀行手数料を差し引くことができます。また、(b) この追加条件を終了することができ、お客様は本っプログラムに関連して、お客様に支払う義務がある支援対象開発者の支払いを喪失する場合があります。
...
GitHub スポンサーの支援対象開発者アカウントのスポンサー支払処理サービスは、Stripe により提供され、[Stripe Connected Account 契約](https://stripe.com/connect-account/legal/full)および含まれている [Stripe サービス使用条件](https://stripe.com/legal) (総称して、「Stripe サービス契約」といいます) が適用されます。 これらの条件に同意する、または GitHub スポンサーの支援対象開発者アカウントとして運用し続けることにより、お客様は、Stripe により随時変更される、Stripe サービス契約に拘束されることに同意するものとします。 GitHub が Stripe を使用して支払処理サービスを有効にすることを条件に、お客様は、お客様およびお客様のビジネスに関する正確かつ完全が情報を提供し、GitHub がこの情報および Stripe により提供される支払処理サービスのお客様の使用に関する処理情報を共有することを許可することに同意するものとします。
...
### [3.9. 支払い処理に対する GitHub の責任はありません。](#39-no-github-liability-for-payment-processing) ###

#### [3.9.1 ストライプの単独責任。](#391-stripes-sole-responsibility) ####
...
(e) GitHub は、Stripe の支払処理サービスのパフォーマンスや、Stripe が保有する資金の安全性に関する表明または保証を行いません。

#### [3.9.2 GitHub のロールの制限。](#392-limitation-of-githubs-role) ####
...
* Stripe が保有する資金に対する保険、結合、またはその他の保護を提供する
...
いずれかの当事者が第 5.3 条に基づき契約終了する場合、Stripe の唯一の義務は、終了日までに生じた支援対象開発者の支払いの金額を、かかる支払いが法令により禁止される場合を除き、処理して支援対象開発者に送金することです。
...
GitHub は、[Explore GitHub スポンサー](https://github.com/sponsors/explore)で投資を利用できるスポンサーの依存関係に基づいてプロジェクトを識別します。 スポンサーは、スポンサーとなるプロジェクトとそのスポンサーの金額を含め、独自の裁量でプロジェクトに投資するものとします。
...
### [4.1. 免責](#41-disclaimer) ###

GitHubは、スポンサープログラムを「AS IS」「AS AVAILABLE」で提供し、GitHubは、明示的、黙示的、法定的を問わず、商品性、特定目的への適合性、権原、安全性、正確性、非侵害の黙示の保証など、サービスに関する全ての保証を明示的に否認します。

### [4.1A。 支払い処理に関する免責事項。](#41a-payment-processing-disclaimer) ###
...
(g) Stripe による行為、欠落、表明、または保証。

支払い処理および資金の送金に関するすべての事項は、Stripe 規約によってのみ管理されます。 スポンサーとスポンサー付き開発者は、すべての支払い処理サービスについて、GitHub ではなく Stripe に依存していることを認めます。

### [4.2. 責任制限。](#42-limitation-of-liability) ###
...
本契約の条件は、両当事者の秘密情報です。 いずれの当事者も、本契約で許可されている場合を除き、本契約に基づき相手方当事者から提供された秘密情報を使用しません。

[B. パブリシティ。](#b-publicity)
----------

GitHubは、スポンサー（スポンサーの許可を得て）またはスポンサー開発者のプログラム参加に関連するプレスリリース、ブログ投稿、ソーシャルメディアへの投稿、またはその他の公的コミュニケーションを発行する場合があります。 このような使用に必要な場合を除き、GitHub は、本契約に基づき、当該スポンサーのロゴ、名称、または名前を使用、参照する権利、または利権を取得することはありません。
