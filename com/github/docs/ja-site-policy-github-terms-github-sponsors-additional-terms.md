...
* [3.支援対象開発者の義務](#2-sponsored-developer-obligations)
* [4.財務条件](#3-financial-terms)
* [5.表明と保証、責任の制限、補償](#4-representations-and-warranties-limitation-of-liability-indemnification)
* [6.契約の期間および終了。](#5-term-and-termination)
* [7.雑則](#1-sponsors-program)
...
### [2.1. GitHub スポンサー プログラム](#11-github-sponsors-program) ###
...
### [2.2. GitHub スポンサー マッチング ファンド](#12-github-sponsors-matching-fund) ###
...
#### [2.2.1. マッチング ファンドの条件](#121-matching-fund-terms) ####
...
#### [2.2.2. マッチング期間](#122-matching-period) ####
...
### [3.3. コンテンツの収益化](#23-content-monetization) ###
...
#### [3.3.1. サブスクリプション](#231-subscriptions) ####
...
#### [3.3.2. その他の資金援助](#232-other-sponsorships) ####
...
### [4.2. 支援対象開発者の支払いの除外](#32-sponsored-developer-payment-exclusions) ###

以下の金額は、必要に応じて、支援対象開発者の支払いに含まれていないか GitHub により保留される場合があります。

#### [4.2.1. 支援対象開発者の費用](#321-sponsored-developer-expenses) ####
...
#### [4.2.3. 違反に対する支援対象開発者の支払いの保留](#323-withholding-of-sponsored-developer-payment-for-breach) ####
...
### [5.1. 支援対象開発者による。](#41-by-sponsored-developer) ###
...
### [5.2. 保証の否認、責任の制限、補償](#42-disclaimer-of-warranties-limitation-of-liability-indemnification) ###
...
### [6.4. 契約終了の効果](#54-effect-of-termination) ###
