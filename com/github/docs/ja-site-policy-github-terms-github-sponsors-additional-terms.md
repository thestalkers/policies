...
### [2.2. GitHub スポンサー マッチング ファンド](#22-github-sponsors-matching-fund) ###
...
#### [2.2.1. マッチング ファンドの条件](#221-matching-fund-terms) ####
...
#### [2.2.2. マッチング期間](#222-matching-period) ####
...
### [3.3. コンテンツの収益化](#33-content-monetization) ###
...
#### [3.3.1. サブスクリプション](#331-subscriptions) ####
...
#### [3.3.2. その他の資金援助](#332-other-sponsorships) ####
...
### [4.2. 支援対象開発者の支払いの除外](#42-sponsored-developer-payment-exclusions) ###

以下の金額は、必要に応じて、支援対象開発者の支払いに含まれていないか GitHub により保留される場合があります。

#### [4.2.1. 支援対象開発者の費用](#421-sponsored-developer-expenses) ####
...
#### [4.2.3. 違反に対する支援対象開発者の支払いの保留](#423-withholding-of-sponsored-developer-payment-for-breach) ####
...
### [5.1. 支援対象開発者による。](#51-by-sponsored-developer) ###
...
### [5.2. 保証の否認、責任の制限、補償](#52-disclaimer-of-warranties-limitation-of-liability-indemnification) ###
...
### [6.4. 契約終了の効果](#64-effect-of-termination) ###
