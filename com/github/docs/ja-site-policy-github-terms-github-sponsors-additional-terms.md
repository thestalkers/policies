...
* [1. 定義。](#1-definitions)
* [1.許可される使用。](#1a-payment-processing-by-stripe)
* [2.支援対象開発者の義務。](#11-github-sponsors-program)
* [3. 財務条件。](#23-content-monetization)
* [4.表明と保証、責任の制限、補償](#35-currency)
* [5. 契約期間と契約解除。](#38-stripe-connect)
* [1.Sponsors プログラム](#41-by-sponsored-developer)
* [2. 支払い。](#53-termination)
* [3. 契約の期間および終了。](#12-invoice-creation)
* [4. 免責事項責任の制限。](#2-payment)
* [A. 秘密保持。](#31-term)
* [B. パブリシティ。](#32-termination)
* [C: 注意/特記事項。](#4-disclaimer-limitation-of-liability)
* [D. 準拠法。](#41-disclaimer)
* [E. 割り当て。](#41a-payment-processing-disclaimer)
* [F. 可分性](#42-limitation-of-liability)
* [G. 完全合意。](#421-exclusion-of-indirect-damages)
* [H. 条件の変更。](#422-limitation-of-total-liability)
...
### [1.1. GitHub スポンサー プログラム](#1a1-stripe-as-payment-processor) ###
...
### [1.2. GitHub スポンサー マッチング ファンド](#1a2-direct-relationship-with-stripe) ###
...
#### [1.2.1. マッチング ファンドの条件。](#1a3-githubs-limited-role) ####
...
#### [1.2.2. マッチング期間。](#1-acceptable-use) ####
...
### [2.1. 一般条項。](#12-github-sponsors-matching-fund) ###
...
### [2.2. 登録。](#121-matching-fund-terms) ###
...
### [2.3. コンテンツの収益化。](#122-matching-period) ###
...
#### [2.3.1. サブスクリプション。](#2-sponsored-developer-obligations) ####
...
#### [3.2.3. 違反に対する支援対象開発者の支払いの保留。](#31-payment) ####
...
### [3.3. 支払タイミング。](#32-sponsored-developer-payment-exclusions) ###
...
### [3.4. 支払い方法。](#321-sponsored-developer-expenses) ###
...
### [4.1. 支援対象開発者による。](#36-refund-requirements) ###
...
### [4.2. 保証の否認、責任制限、補償。](#37-requested-payment-information) ###
...
### [5.1. 期間。](#39-no-github-liability-for-payment-processing) ###

この追加条件は、発効日に開始し、お客様がプログラムに参加している限り有効です。

### [5.2. 一時停止。](#391-stripes-sole-responsibility) ###
...
### [5.3. 契約解除。](#392-limitation-of-githubs-role) ###
...
### [5.4. 契約解除の効果](#4-representations-and-warranties-limitation-of-liability-indemnification) ###
...
### [1.1 説明。](#42-disclaimer-of-warranties-limitation-of-liability-indemnification) ###
...
### [1.2 請求書の作成](#5-term-and-termination) ###
...
### [2.1 支払い。](#54-effect-of-termination) ###
...
#### [4.2.2 総責任額の制限。](#3-term-and-termination) ####
