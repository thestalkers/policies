GitHub の異議申し立ておよび復活 - GitHubドキュメント(function(){
...
復活を求める場合、または GitHub や npm での執行措置に対する異議申し立てを希望する場合は、該当するフォームに記入してください。
