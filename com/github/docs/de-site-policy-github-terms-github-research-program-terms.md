Bedingungen des GitHub-Forschungsprogramms - GitHub Dokumente(function(){
...
3. [Bedingungen des GitHub-Forschungsprogramms](/de/site-policy/github-terms/github-research-program-terms)
...
Sie können Ihre Einwilligung jederzeit widerrufen und den Zugriff auf oder die Löschung der personenbezogenen Daten, die wir über Sie gespeichert haben, verlangen. Weitere Informationen darüber, wie Sie auf die personenbezogenen Daten, die GitHub über das Programm erhebt, zugreifen, sie aktualisieren, ändern oder löschen können, finden Sie in der [GitHub Datenschutzerklärung](/de/site-policy/privacy-policies/github-general-privacy-statement) oder kontaktieren Sie uns über unsere [Kontaktformular zum Datenschutz](https://github.com/contact/privacy).
