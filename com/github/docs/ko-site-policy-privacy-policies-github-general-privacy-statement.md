GitHub 일반 개인정보처리방침 - GitHub 문서(function(){
...
3. [GitHub 일반 개인정보처리방침](/ko/site-policy/privacy-policies/github-general-privacy-statement)
...
* 사용자 콘텐츠 및 파일: 사용자가 서비스를 이용할 때, 당사는 코드, 입력, AI 출력, 텍스트, 문서, 이미지 또는 피드백과 같이 사용자가 제공하는 정보에 포함된 개인정보를 수집합니다.
...
* 공개적으로 이용 가능한 출처: 당사는 공개적으로 이용 가능한 출처로부터 사용자의 정보를 수집할 수 있습니다.
...
* 제품 개발 및 개선: 당사는 인공지능 및 머신러닝 기술을 포함하여 자사 제품, 서비스 및 기술을 개발하고 개선하기 위해 개인정보를 사용합니다. 여기에는 기능 개선, 새로운 서비스 개발, 안전 및 보안 기능 강화, 그리고 모델 학습이 포함됩니다. 당사는 이러한 개선을 가능하게 하는 동시에 사용자의 개인 정보를 보호하기 위해, 가능한 경우 집계 및 비식별화 기술을 포함한 적절한 기술적 보호 조치를 적용합니다.
...
* 계열사: 개인정보는 고객 서비스, 마케팅 및 광고, 주문 처리, 청구, 기술 지원, 법적 및 규제 준수 의무, 제품 개발 및 개선(인공지능 및 머신러닝 기술의 학습 및 개선 포함), 그리고 각자의 개인정보 처리방침에 명시된 기타 목적을 위해 GitHub 계열사(Microsoft 포함)와 공유될 수 있습니다. 당사가 계열사와 데이터를 공유할 경우, 해당 계열사는 관련 법률 및 자체 개인 정보 보호 약속에 따라 이를 처리합니다.
...
사용자의 GitHub 계정에 비공개 저장소가 있는 경우, 비공개 저장소 정보에 대한 당사의 접근 가능성과 권리는 GitHub 서비스 약관의 섹션 E(비공개 저장소)에 규정되어 있습니다.
...
* 정당한 이익: 당사는 서비스 보안 유지, 사용자와의 소통, 그리고 인공지능 및 머신러닝 기술을 포함한 서비스 개발 및 개선과 같은 당사의 정당한 이익을 위한 목적을 위해 데이터를 처리합니다. 이는 데이터 보호 권한 또는 기본 권한과 자유에 의해 이러한 이해가 재정의되지 않는 경우에만 수행됩니다.
...
개인은 특정 조건에서 다른 DPF 메커니즘을 통해 해결하지 못한 DPF 준수에 관한 불만 사항에 대해 구속력 있는 중재를 요청할 수 있습니다. 자세한 내용은 <https://www.dataprivacyframework.gov/framework-article/ANNEX-I-introduction>를 참조하십시오.
...
1. **GitHub Enterprise 마케팅 페이지 특정**
   ...
   필수적이지 않은 쿠키를 제공하는 모든 GitHub 페이지에는 페이지 바닥글에 쿠키 설정에 대한 링크가 있습니다. 사용자는 언제든지 해당 링크를 클릭하여 설정을 업데이트함으로써 자신의 선호를 표시할 수 있습니다.
