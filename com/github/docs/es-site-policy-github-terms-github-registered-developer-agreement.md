Acuerdo de desarrollador registrado de GitHub - Documentación de GitHub(function(){
...
3. [Acuerdo de desarrollador registrado de GitHub](/es/site-policy/github-terms/github-registered-developer-agreement)
