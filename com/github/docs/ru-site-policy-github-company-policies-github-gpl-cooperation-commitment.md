Обязательство сотрудничества с #REF! GPL - Документация по GitHub
...
Обязательство сотрудничества с #REF! GPL
==========

Просмотр страницы как Markdown

Это обязательство относится к вкладу #REF! в Git, ядро Linux и другие программы под защищенными лицензиями (прокрутите до конца определения).
...
\#REF! предполагает, что это Обязательство будет безотзывным, обязательным и подлежащим исполнению в отношении #REF! и правопреемников или правопреемников авторских прав #REF!.

\#REF! может изменить это обязательство, опубликовав новую редакцию на этой странице или в другом месте.
...
«Защитное действие» означает судебное разбирательство или претензию, которую #REF! предъявляет вам в ответ на предыдущую судебную процедуру или претензию, инициированную вами или вашим аффилированным лицом.

«#REF!» означает #REF!, Inc. и ее дочерние компании.
