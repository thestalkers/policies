...
* [J. 付款](#j-payment)
* [K. 期限；终止；暂停](#1-term)
* [L. 与 GitHub 的通信](#1-electronic-communication-required)
* [M. 有限保证；免责声明](#n-limitations-of-liability)
* [N. 责任限制](#o-defense-of-claims-release)
* [O. 索赔辩护；免除责任](#1-by-github)
* [P. 保密性](#q-expert-services)
* [Q. 专业服务](#r-changes-to-the-service-or-terms)
* [R. 服务或条款的更改](#s-support)
* [S. 支持](#t-miscellaneous)
* [T. 其他](#1-governing-law)
...
### [4.授权](#k-term-termination-suspension) ###
...
### [1.期限](#2-termination-for-convenience-account-cancellation) ###

本协议从“生效日期”开始生效，并将继续有效，直至一方根据第 K 节终止协议。

### [2.根据需要终止；帐户注销](#3-termination-for-material-breach) ###
...
### [3.因严重违约而终止](#4-effect-of-termination) ###
...
### [6.效力存续](#l-communications-with-github) ###
...
### [1.电子通信要求](#2-legal-notice-to-github-must-be-in-writing) ###
...
### [2.向 GitHub 发出的法律声明必须采用书面形式](#m-limited-warranty-disclaimer) ###
...
### [2.客户方](#3-disputes-with-other-users) ###
