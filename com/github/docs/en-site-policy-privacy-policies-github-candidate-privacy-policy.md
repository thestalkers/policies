GitHub Global Data Privacy Notice for Candidates - GitHub Docs(function(){
...
3. [GitHub Global Data Privacy Notice for Candidates](/en/site-policy/privacy-policies/github-candidate-privacy-policy)
...
If you have a privacy concern or question related to this privacy notice, please contact [dpo@github.com](mailto:dpo@github.com).
...
To make a request to exercise one of the above rights, please contact [dpo@github.com](mailto:dpo@github.com) by email or by letter to one of the following address:
...
For candidates, the controller of your personal data is the GitHub entity to which you have applied for a role. GitHub is also a controller of certain personal data of the above-mentioned data subjects. Any privacy-related queries for your data controller should be directed to [dpo@github.com](mailto:dpo@github.com) or by letter to one of the following address:
