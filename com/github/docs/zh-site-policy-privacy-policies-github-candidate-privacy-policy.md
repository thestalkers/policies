...
本声明不适用于您作为消费者使用 GitHub 消费者产品的情况，亦不适用于您在 GitHub 候选人身份之外的活动。 GitHub 消费者产品可能包含服务、网站、应用、软件、服务器以及设备。 如果要详细了解 GitHub 针对您以消费者身份使用其产品时的数据收集情况，请参阅我们的 [GitHub 隐私声明](/zh/site-policy/privacy-policies/github-general-privacy-statement)。
...
* 第三方或公共来源（例如，出于招聘目的，从 领英 个人资料等公共求职社交来源获取的信息）。
