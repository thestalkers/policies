...
* [K. 付款](#3-development-and-improvement-using-your-input-and-output)
* [L. 取消和终止](#3-feedback)
* [M. 与 GitHub 的通信](#4-authorization)
* [N. 免责声明](#2-upon-cancellation)
* [O. 责任限制](#3-github-may-terminate)
* [P. 免除和赔偿](#4-survival)
* [Q. 条款的变更](#n-communications-with-github)
* [R. 其他](#1-electronic-communication-required)
...
### [3.内容所有权、发布权利和许可授予](#3-ownership-and-license-grants) ###
...
### [8.访问互惠](#8-public-repositories-and-lawful-access) ###
...
本 D.8 节条款不适用于仅出于学术研究目的的访问，也不适用于在您访问内容时，您提供的产品或服务在前一日历月的每月活跃用户数少于 7 亿的情况。 针对本节的目的，“您”是指您及任何直接或间接控制您、受您控制或与您共同受控的实体（关联方）。
...
### [2.升级、降级和更改](#5-your-responsibility-and-indemnity) ###
...
### [3.GitHub 可能终止](#2-upgrades-downgrades-and-changes) ###

GitHub 有权随时暂停或终止您对网站全部或任何部分的访问，无论有无理由或有无通知，均立即生效。 GitHub 保留随时以任何理由向任何人拒绝提供服务的权利。

### [4.效力存续](#3-billing-schedule-no-refunds) ###
...
### [1.电子通信要求](#5-responsibility-for-payment) ###
...
### [2.向 GitHub 发出的法律声明必须采用书面形式](#m-cancellation-and-termination) ###
...
### [3.无电话支持](#1-account-cancellation) ###
...
### [1.管辖法律](#2-legal-notice-to-github-must-be-in-writing) ###

除非适用法律另有规定，否则您与 GitHub 之间达成的本协议，以及对网站或服务的任何访问或使用均受美国联邦法律及加利福尼亚州法律管辖，而不考虑法律冲突条款。 您和 GitHub 同意接受将位于加利福尼亚州旧金山市/县的法院作为唯一管辖地和审判地。 但是，对于违反第 D.8 节的行为，任何寻求禁令救济的诉讼均可在任何司法管辖区提起。

### [2.不可转让](#3-no-phone-support) ###
