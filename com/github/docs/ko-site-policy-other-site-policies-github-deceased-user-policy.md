GitHub 사망 사용자 정책 - GitHub 문서(function(){
...
4. [GitHub 사망 사용자 정책](/ko/site-policy/other-site-policies/github-deceased-user-policy)
...
귀하가 요청서에 제공한 정보는 [개인정보취급방침](/ko/site-policy/privacy-policies/github-general-privacy-statement)에 따라 수집되며 당사는 법적 의무를 준수하고 분쟁을 해결하는 데 필요한 경우에만 해당 정보를 보유합니다.
