Declaración contra el soborno de GitHub - Documentación de GitHub(function(){
...
3. [Declaración contra el soborno de GitHub](/es/site-policy/github-company-policies/github-anti-bribery-statement)
