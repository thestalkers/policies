...
* [**Страницы.**](/ru/pages/getting-started-with-github-pages/what-is-github-pages) Страницы GitHub – это общедоступные веб-страницы, бесплатно размещенные на GitHub, которые пользователи могут легко публиковать с помощью кода, хранящегося в их репозиториях.
...
* <a name="private-account-data"></a>**Частные сведения учетной записи.** GitHub также собирает и хранит определенные частные сведения о пользователях, как указано в нашей [Политике конфиденциальности](/ru/site-policy/privacy-policies/github-general-privacy-statement).
...
Есть ли у вас есть еще вопросы, комментарии или предложения? Обратитесь в us через [портал](https://support.github.com) поддержки GitHub.
