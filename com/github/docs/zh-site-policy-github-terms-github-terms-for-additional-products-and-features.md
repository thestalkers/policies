GitHub 附加产品和功能条款 - GitHub 文档(function(){
...
3. [GitHub 附加产品和功能条款](/zh/site-policy/github-terms/github-terms-for-additional-products-and-features)
...
对 Actions 以及任何 Actions 产品或服务元素的使用不得违反协议、[GitHub 可接受的使用政策](/zh/site-policy/acceptable-use-policies/github-acceptable-use-policies)或 [Actions 文档](/zh/actions/concepts/billing-and-usage)规定的 GitHub Actions 服务限制。 此外，无论操作是否使用自托管运行器，Actions 都不应用于：
...
若要使用 GitHub Advanced Security 或 GitHub Secret Protection 进行机密扫描，如果选择自动验证合作伙伴模式，可能会与相关合作伙伴共享公开的第三方令牌，以便提供有关令牌有效性的详细信息。 并非所有合作伙伴都位于美国。 [机密扫描模式文档](/zh/enterprise-cloud@latest/code-security/reference/secret-security/supported-secret-scanning-patterns)提供了更多详细信息，介绍哪些合作伙伴支持有效性检查。
...
Codespaces 的通用版本当前不适用于美国政府客户。 美国政府客户可以在单独条款下继续使用 Codespaces Beta 预览版。 请参阅 [Beta 预览版条款](/zh/site-policy/github-terms/github-terms-of-service#k-beta-previews)。
...
每个帐户都可以访问 [GitHub Pages 静态托管服务](/zh/pages/getting-started-with-github-pages/what-is-github-pages)。 GitHub Pages 旨在托管静态网页，但主要用作个人和组织项目的展示。
...
GitHub Pages 受某些特定带宽和使用限制的约束，可能不适用于某些高带宽用途。 请参阅我们的 [GitHub Pages 限制](/zh/pages/getting-started-with-github-pages/github-pages-limits)，了解更多信息。

*禁止的使用情形*

对 GitHub Pages 的使用不得违反协议、GitHub [可接受使用政策](/zh/site-policy/acceptable-use-policies/github-acceptable-use-policies)或 [Pages 文档](/zh/pages/getting-started-with-github-pages/github-pages-limits#usage-limits)规定的 GitHub Pages 服务限制。
