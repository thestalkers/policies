Политика удаления личной информации #REF! - Документация по GitHub
...
Политика удаления личной информации #REF!
==========
...
Мы предлагаем этот процесс удаления личных сведений в качестве исключительной услуги только для содержимого с высоким риском, нарушающего [условия предоставления услуг #REF!](/ru/site-policy/acceptable-use-policies/github-acceptable-use-policies#3-conduct-restrictions), например, когда безопасность подвергается риску в связи с раскрытием учетных данных для доступа. В этом руководстве описана информация, которая нужна #REF! от вас для обработки запроса на удаление личной информации из репозитория.
...
1. **Заявитель проводит расследование.** Именно запрашивающая сторона проводит собственное расследование и предоставляет нам необходимые [сведения](#your-request-must-include) и, что самое главное, объяснение того, каким образом данные представляют угрозу безопасности. #REF! не имеет права искать или принимать первоначальные решения в отношении личной информации от имени какого-либо лица или организации.

2. **Заявитель отправляет запрос на удаление личных сведений.** После проведения расследования заявитель готовит и [отправляет запрос на удаление личных сведений](#sending-a-private-information-removal-request) в #REF!. Если запрос недостаточно подробен, чтобы продемонстрировать угрозу безопасности и чтобы #REF! мог найти данные, мы ответим и запросим дополнительную информацию.

3. **\#REF! просит пользователя внести изменения.** В большинстве случаев мы свяжемся с пользователем, создавшим репозиторий, и предоставим ему возможность удалить или изменить личную информацию, указанную в запросе, либо оспорить претензию.
...
\#REF! не будет автоматически отключать вилки при отключении родительского репозитория. Это связано с тем, что вилки принадлежат разным пользователям и могут быть существенно изменены. #REF! не проводит никаких независимых расследований вилок. Мы ожидаем, что те, кто отправляет запросы на удаление личной информации, проведут это расследование и, если они сочтут, что вилки также содержат личную информацию, прямо включат вилки в свой запрос.
...
Из-за типа содержимого, размещенного на #REF! (в основном программный код), и способа управления этим содержимым (с помощью Git) нам нужно, чтобы жалобы были как можно более конкретными. Чтобы мы могли убедиться, что пользователь полностью удалил сообщенную личную информацию, нам нужно точно знать, где искать.
