Политика имени пользователя #REF! - Документация по GitHub
...
* [Политика имени пользователя #REF!](/ru/site-policy/other-site-policies/github-username-policy)

Политика имени пользователя #REF!
==========
...
Имена учетных записей #REF! доступны в порядке очереди и предназначены для немедленного и активного использования.

[Что делать, если нужное мне имя пользователя уже занято?](#what-if-the-username-i-want-is-already-taken)
----------

Имейте в виду, что не все действия на #REF! видны всем; учетные записи без видимой активности могут активно использоваться.
