GitHub 用户名政策 - GitHub 文档(function(){
...
3. [GitHub 用户名政策](/zh/site-policy/other-site-policies/github-username-policy)
...
我们不受理对于因用户名看似不活跃或未被使用而提出的释放、转让或收回请求。 如果您想要的用户名已被占用，除非您正在按下文所述提交商标投诉，否则您需要选择其他可用的用户名。
...
如果您认为某个用户的帐户侵犯了您的商标权，您可以在我们的 [GitHub 商标政策](/zh/site-policy/content-removal-policies/github-trademark-policy) 页面上找到有关提出商标投诉的更多信息。 我们仅审查有效的商标相关投诉，以考虑是否释放已被占用的用户名。
