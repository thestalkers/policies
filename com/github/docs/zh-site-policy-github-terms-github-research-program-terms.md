GitHub 研究计划条款 - GitHub 文档(function(){
...
您可以随时撤回此项同意，并请求访问或删除我们持有的关于您的个人信息。 如需进一步了解您如何访问、更新、更改或删除 GitHub 通过计划收集的个人信息，请参阅 [GitHub 隐私声明](/zh/site-policy/privacy-policies/github-general-privacy-statement)，或通过我们的[隐私联系人表单](https://github.com/contact/privacy) 与我们联系。
