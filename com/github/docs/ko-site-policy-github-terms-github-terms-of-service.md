...
* [E. 개인 리포지토리](#9-access-reciprocity)
...
* [K. 지급](#3-development-and-improvement-using-your-input-and-output)
* [L. 취소 및 해지](#3-feedback)
* [M. GitHub와의 통신](#4-authorization)
* [N. 보증의 부인](#2-upon-cancellation)
* [O. 책임의 제한](#3-github-may-terminate)
* [P. 면제 및 면책](#4-survival)
* [Q. 본 약관의 변경](#n-communications-with-github)
* [R. 기타](#1-electronic-communication-required)
...
### [3. 콘텐츠 소유권, 게시물에 대한 권한 및 라이선스 허여](#3-ownership-and-license-grants) ###
...
귀하가 콘텐츠에 대한 소유권과 책임을 보유하므로, 당사는 귀하가 당사와 다른 GitHub 사용자에게 섹션 D.4 - D.7에 나열된 특정 법적 권한을 부여해야 합니다. 이러한 라이선스 부여는 귀하의 콘텐츠에 적용됩니다. 이미 라이선스와 함께 제공되어 GitHub가 서비스를 실행하는 데 필요한 권한을 부여하는 콘텐츠를 업로드하는 경우, 추가 라이선스가 필요하지 않습니다. 귀하는 섹션 D.4 - D.7에 부여된 권리에 대해 어떠한 대가도 받지 않음을 이해합니다. 귀하가 당사에 부여하는 라이선스는 다른 사용자가 콘텐츠를 포크하지 않는 한 귀하가 당사 서버에서 귀하의 콘텐츠를 제거하면 종료됩니다.
...
### [8. 액세스 상호 호환 관계](#8-public-repositories-and-lawful-access) ###
...
이 섹션 D.8은 학술 연구 목적으로만 액세스하거나 콘텐츠에 액세스한 날짜에 귀하가 제공한 제품 또는 서비스의 전월 월간 활성 사용자 수가 7억 명 미만인 경우에는 적용되지 않습니다. 본 섹션의 목적을 위해 "귀하"는 귀하와 귀하(계열사)를 직간접적으로 제어하거나, 귀하(계열사)에 의해 제어되거나, 귀하(계열사)와 공동 통제하에 있는 모든 엔터티를 의미합니다.
...
### [1. 변경 가능](#j-ai-features-training-and-your-data) ###
...
### [2. 업그레이드, 다운그레이드, 변경](#5-your-responsibility-and-indemnity) ###
...
### [3. 청구 일정표, 환불 없음](#k-beta-previews) ###
...
### [3. GitHub의 종료 권한](#2-upgrades-downgrades-and-changes) ###
...
### [4. 존속](#3-billing-schedule-no-refunds) ###
...
### [1. 전자 통신 필요](#5-responsibility-for-payment) ###
...
### [2. GitHub에 대한 법적 고지는 서면으로 이루어져야 함](#m-cancellation-and-termination) ###
...
### [3. 전화 지원 없음](#1-account-cancellation) ###
...
### [1. 준거법](#2-legal-notice-to-github-must-be-in-writing) ###

관련 법률이 달리 규정하는 경우를 제외하고 귀하와 GitHub 간의 본 계약과 웹 사이트 또는 서비스 액세스 또는 사용에는 국제 사법 조항에 대한 고려 없이 미국의 연방 법률과 캘리포니아 주의 법률이 적용됩니다. 귀하와 GitHub는 캘리포니아 주 샌프란시스코 시 및 카운티에 위치한 법원의 전속 관할과 재판지에 따를 것에 동의합니다. 하지만 섹션 D.8 위반과 관련하여 금지명령구제에 대한 모든 청구는 모든 관할권에 제기될 수 있습니다.

### [2. 양도 금지](#3-no-phone-support) ###
...
### [3. 섹션 제목 및 요약](#o-disclaimer-of-warranties) ###

본 계약 전체에서 각 섹션에는 다음과 같은 계약조건의 제목과 짧은 요약이 포함됩니다. 이들 섹션 제목과 짧은 요약은 법적 구속력이 없습니다.

### [4. 조항의 독립성, 권한 불포기, 존속](#p-limitation-of-liability) ###
...
### [5. 수정, 완전 합의](#q-release-and-indemnification) ###
