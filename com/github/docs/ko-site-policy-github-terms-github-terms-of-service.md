...
귀하의 콘텐츠에 대한 소유권과 책임을 유지하므로 Microsoft는 D.4 섹션 - D.1 섹션에 나열된 특정 법적 권한 및 기타 GitHub 사용자에게 권한을 부여해야 합니다. 이 라이선스 허여는 귀하의 콘텐츠에 적용됩니다. GitHub 서비스 실행에 필요한 권한을 GitHub에 부여하는 라이선스가 함께 제공되는 콘텐츠를 업로드하는 경우, 추가 라이선스는 필요하지 않습니다. 섹션 D.4 - D.1에 부여된 권한에 대한 지불은 받지 않습니다. 귀하가 GitHub에 허여하는 라이선스는 다른 사용자가 귀하의 콘텐츠를 포크하지 않는 한 귀하가 GitHub 서버에서 귀하의 콘텐츠를 제거할 때 종료됩니다.
...
**사용량 기준 결제** 일부 서비스 기능은 사용량에 따라 과금됩니다. 이러한 서비스 기능의 한정된 수량은 추가 비용 없이 제한된 기간 동안 귀하의 요금에 포함될 수 있습니다. 요금제에 포함된 수량을 초과하여 유료 서비스 기능을 사용하도록 선택하는 경우 이전 달의 실제 사용량에 따라 해당 서비스 기능에 대한 요금을 지불합니다. 이러한 구매에 대한 월 결제는 정기적으로 연체되어 청구됩니다. 자세한 내용은 [GitHub 추가 제품 약관](/ko/site-policy/github-terms/github-terms-for-additional-products-and-features)을 참조하십시오.
...
본질상 해지 후에도 존속해야 하는 본 계약의 모든 조항은 해지 후에도 \_존속\_하며, 여기에는 소유권 조항, 보증 부인, 면책, 책임의 제한이 포함되나 이에 국한되지 않습니다.
