GitHub 서비스 약관 - GitHub 문서(function(){
...
3. [GitHub 서비스 약관](/ko/site-policy/github-terms/github-terms-of-service)
...
* [J. AI 기능, 학습 및 사용자의 데이터](#j-ai-features-training-and-your-data)
* [k. 베타 미리 보기](#k-beta-previews)
* [L. 지급](#l-payment)
* [M. 취소 및 해지](#m-cancellation-and-termination)
* [N. GitHub와의 통신](#n-communications-with-github)
* [O. 보증의 부인](#o-disclaimer-of-warranties)
* [P. 책임의 제한](#p-limitation-of-liability)
* [Q. 면제 및 면책](#q-release-and-indemnification)
* [R. 본 약관의 변경](#r-changes-to-these-terms)
* [S. 기타](#s-miscellaneous)
...
|[J. AI 기능, 학습 및 귀하의 데이터](#j-ai-features-training-and-your-data)|        이 약관은 GitHub Copilot 및 기타 AI 기능에 적용되며, 인공지능 및 머신러닝 모델의 개발과 개선을 위해 귀하의 데이터가 어떻게 사용될 수 있는지, 그리고 귀하에게 제공되는 제어 기능을 포함합니다.         |
|                 [K. 베타 프리뷰](#k-beta-previews)                 |                                               아직 개발 중인 GitHub의 기능에 적용되는 몇 가지 추가 약관입니다.                                               |
|                      [L. 결제](#l-payment)                      |                                             결제는 귀하의 책임입니다. GitHub는 정확한 청구에 대한 책임이 있습니다.                                              |
|         [M. 취소 및 해지](#m-cancellation-and-termination)         |                                                  귀하는 언제든지 본 계약을 취소하고 계정을 닫을 수 있습니다.                                                  |
|        [N. GitHub와의 통신](#n-communications-with-github)        |                                 GitHub는 이메일 및 기타 전자적 수단만을 사용하여 GitHub 사용자와 연락합니다. 전화 지원은 제공하지 않습니다.                                  |
|           [O. 보증의 부인](#o-disclaimer-of-warranties)            |          GitHub는 GitHub의 서비스를 있는 그대로 제공하며, 이 서비스에 대한 어떠한 약속이나 보증도 하지 않습니다. **이 섹션을 꼼꼼히 읽으시기 바랍니다. 무엇을 예상해야 하는지 이해해야 합니다.**           |
|            [P. 책임의 제한](#p-limitation-of-liability)            |GitHub는 본 계약에 따른 서비스 사용 또는 사용 불능으로 인해 발생하거나 기타 방식으로 발생하는 손해나 손실에 대해 책임이 없습니다. **이 섹션을 꼼꼼히 읽으시기 바랍니다. 이 섹션은 귀하에 대한 GitHub의 의무를 제한합니다.**|
|         [Q. 면제 및 면책](#q-release-and-indemnification)          |                                                  귀하의 서비스 사용에 대한 책임은 전적으로 귀하에게 있습니다.                                                  |
|          [R. 서비스 약관의 변경](#r-changes-to-these-terms)           |                                            GitHub는 본 계약을 수정할 수 있지만 중대한 변경은 30일 전에 통지합니다.                                             |
|                   [S. 기타](#s-miscellaneous)                   |                                              GitHub의 법 선택을 비롯한 법적 세부 사항은 이 섹션을 참조하십시오.                                               |
...
3. “AI 기능”이란 GitHub 또는 그 계열사가 제공하는 기능 중 머신러닝 또는 인공지능을 사용하여 결과물을 생성하는 모든 기능을 의미하며, GitHub Copilot, Copilot Autofix 및 문서에서 머신러닝 또는 인공지능을 사용하는 것으로 명시된 기타 모든 기능을 포함합니다.

4. “계열사”란 한 당사자를 직접 또는 간접적으로 지배하거나, 그 당사자에 의해 지배되거나, 또는 동일한 지배하에 있는 모든 법인을 의미하며, 여기서 “지배”란 해당 법인의 지분을 50% 초과하여 보유하거나 해당 법인의 경영을 지시할 권리를 갖는 것을 의미합니다. 혼동을 방지하기 위해, Microsoft는 GitHub의 계열사입니다.

5. "베타 미리 보기"란 알파, 베타, 미리 보기, 사전 체험판, 평가판 또는 유사한 의미의 단어나 문구로 명시된 소프트웨어, 서비스 또는 기능을 의미합니다.

6. “콘텐츠”란 서비스에서 제공되는 코드, 텍스트, 데이터, 문서, 이미지, 그래픽, 소프트웨어, 패키지 및 기타 자료를 의미합니다.

7. “GitHub”, “우리”, “당사”는 GitHub, Inc.를 의미하며, 또한 당사의 이사, 자회사, 계약자, 라이선스 하여자, 임원, 에이전트 및 직원을 포함합니다.

8. “입력”이란 AI 기능에 제공되는 모든 콘텐츠 또는 맥락을 의미하며, 프롬프트, 첨부 파일, 작업 공간의 코드 및 대화 기록을 포함합니다.

9. “출력”이란 AI 기능에 의해 생성된 응답 및 제안을 의미하며, 코드 또는 기타 자료를 포함합니다.

10. “서비스”란 웹사이트 및 모든 베타 프리뷰를 통해 제공되는 것을 포함하여 GitHub이 제공하는 애플리케이션, 소프트웨어, 제품 및 서비스를 의미합니다.

11. “사용자”, “귀하”, “당신”은 웹사이트 또는 서비스를 방문하거나 이용하는 개인, 회사 또는 조직, 계정의 일부에 접근하거나 이를 사용하는 자, 또는 계정의 기능 수행을 위해 계정 사용을 지시하는 자를 의미합니다. 사용자는 만 13세 이상이어야 합니다. 비즈니스 계정 또는 정부 계정에는 특별한 약관이 적용될 수 있습니다([섹션 B(5): 추가 조건](#5-additional-terms) 참조).

12. “사용자 생성 콘텐츠”란 귀하 또는 다른 사용자가 서비스를 통해 업로드, 제출 또는 생성한 콘텐츠를 의미합니다.

13. "웹 사이트"란 [github.com](https://github.com/)에 있는 GitHub의 웹 사이트와 GitHub가 이 웹 사이트에서 또는 이 웹 사이트를 통해 제공하는 모든 콘텐츠, 서비스, 제품을 말합니다. [education.github.com](https://education.github.com/)과 [pages.github.com](https://pages.github.com/) 등 GitHub가 소유한 github.com의 하위 도메인도 가리킵니다. 이 약관은 [githubuniverse.com](https://githubuniverse.com/) 같은 GitHub의 컨퍼런스 웹 사이트와 [electronjs.org](https://www.electronjs.org/) 같은 제품 웹 사이트에도 적용됩니다. 경우에 따라 GitHub가 소유한 웹 사이트에서 다른 서비스 약관이나 추가 서비스 약관을 규정할 수 있습니다. 이러한 추가 약관이 본 계약과 충돌하는 경우, 보다 구체적인 약관이 관련 페이지 또는 서비스에 적용됩니다.

14. “귀하의 콘텐츠”란 귀하가 업로드, 제출 또는 생성한 사용자 생성 콘텐츠를 의미하며, 귀하가 포크하거나 복제한 콘텐츠에 대한 수정 사항을 포함합니다. 다른 사람이 생성한 기본 콘텐츠는 포함되지 않습니다.
...
가입 프로세스를 완료하려면 유효한 이메일 주소를 제공해야 합니다. 귀하가 법인을 대신하여 본 약관을 수락하거나(이 경우 해당 법인에 대한 추가 정보 필요) [유료 계정](#l-payment)을 선택(이 경우 과금을 위해 추가 정보 필요)하지 않는 한 본명 등 요청되는 그 밖의 정보는 선택 사항입니다.

### [3. 계정 요구 사항](#3-account-requirements) ###

GitHub 서비스의 계정에는 몇 가지 간단한 규칙이 있습니다.
...
* 만 13세 이상이어야 합니다. 뛰어난 어린 코더들이 프로그래밍을 배우면서 신이 나는 것을 보면 정말 기쁘지만 GitHub는 미국 법률을 준수해야 합니다. GitHub의 서비스는 만 13세 미만 아동을 대상으로 하지 않으며, GitHub는 GitHub 서비스에서 만 13세 미만의 사용자를 허용하지 않습니다. GitHub는 사용자가 만 13세 미만의 어린이임을 인지하면 [그 사용자의 계정을 즉시 종료](#m-cancellation-and-termination)합니다. 미국 이외의 국가에 거주하는 경우 해당 국가의 최저 연령 기준이 이보다 높을 수 있습니다. 이 경우 귀하는 해당 국가의 법률을 준수할 책임이 있습니다.
...
귀하는 귀하의 콘텐츠와 그로 인해 발생하는 모든 피해에 대해 책임이 있습니다. 여기에는 귀하가 서비스를 통해 게시, 업로드 또는 제공하는 콘텐츠가 포함됩니다. 당사는 귀하의 콘텐츠가 공개적으로 표시되거나 오용되는 것에 대해 책임지지 않습니다.

### [2. GitHub가 콘텐츠 제거 가능](#2-github-may-remove-content) ###

관련 법률이나 당사의 약관 및 정책을 위반하는 사용자 생성 콘텐츠는 거부하거나 삭제할 수 있습니다. 우리는 섹션 E에 명시된 방식으로만 비공개 저장소에 접근합니다. GitHub 모바일에 표시되는 콘텐츠는 앱 스토어의 약관을 적용받을 수 있습니다.

### [3. 소유권 및 라이선스 하여](#3-ownership-and-license-grants) ###

사용자는 자신의 콘텐츠에 대한 소유권을 가집니다. 사용자가 직접 생성하지 않은 콘텐츠를 게시하는 경우, 해당 콘텐츠를 게시할 권리가 있는지 확인하고 적용 가능한 모든 라이선스를 준수할 책임이 있습니다.

사용자는 섹션 D.4\~D.8에 따라 당사 및 다른 사용자에게 라이선스를 부여합니다. 이 라이선스는 사용자의 콘텐츠에 적용됩니다. 귀하의 콘텐츠에 이미 당사가 필요한 권한을 부여하는 라이선스가 포함되어 있다면, 추가 라이선스는 필요하지 않습니다. 이러한 권리에 대해 보상을 받지 않습니다. 이 라이선스는 사용자가 자신의 콘텐츠를 삭제하면 종료되지만, 다른 사용자가 해당 콘텐츠를 포크한 경우에는 예외입니다.

### [4. GitHub에 대한 라이선스 허여](#4-license-grant-to-us) ###

사용자는 GitHub 및 그 계열사에 서비스 제공, 개발 및 개선을 위해 필요한 범위에서 사용자의 콘텐츠를 저장, 호스팅, 보관, 분석, 표시하고 복제할 수 있는 권리를 부여하며, 여기에는 AI 기능을 학습시키는 것과 계열사의 인공지능 및 머신러닝 모델과 기술을 훈련, 개발 및 개선하기 위한 목적이 포함됩니다. 이 라이선스에는 다음과 같은 권리가 포함됩니다. 이를 당사 데이터베이스에 복사하고 백업을 만드는 것, 사용자 본인과 다른 사용자에게 이를 보여주는 것, 검색 인덱스로 변환하거나 서버에서 분석하는 것, 다른 사용자와 공유하는 것, 그리고 콘텐츠가 음악이나 영상과 같은 경우 이를 공연하는 것 등이 포함됩니다. 오해의 여지를 없애기 위해 명확히 하자면, GitHub 및 그 계열사의 인공지능 및 머신러닝 모델과 기술을 개발, 학습 및 개선하기 위해 귀하의 콘텐츠를 사용하는 것은 이 라이선스의 범위에 포함되며, 귀하의 콘텐츠를 판매하거나 기타 제한된 방식으로 이전하는 것에 해당하지 않습니다.

### [5. 다른 사용자에 대한 라이선스 허여](#5-license-grant-to-other-users) ###

사용자가 공개적으로 게시한 콘텐츠(이슈, 댓글, 다른 사용자의 저장소에 대한 기여 포함)는 다른 사람들이 열람할 수 있습니다. 저장소를 공개로 설정함으로써, 사용자는 다른 사람들이 해당 저장소를 열람하고 “포크”할 수 있도록 허용하는 데 동의하는 것입니다(이는 다른 사람들이 서비스를 통해 자신이 관리하는 저장소에 해당 저장소의 사본을 만들어 사용할 수 있음을 의미합니다).

저장소를 공개로 설정하면, 사용자는 다른 사용자에게 GitHub의 기능이 허용하는 범위 내에서 서비스를 통해 사용자의 콘텐츠를 사용, 표시, 실행하고(포크를 통한) 복제할 수 있는 비독점적이고 전 세계적인 라이선스를 부여합니다. 사용자는 [라이선스를 채택함으로써](/ko/communities/setting-up-your-project-for-healthy-contributions/adding-a-license-to-a-repository#including-an-open-source-license-in-your-repository) 추가적인 권리를 부여할 수 있습니다. 사용자가 직접 생성하거나 소유하지 않은 콘텐츠를 게시하는 경우, 해당 콘텐츠가 이러한 사용을 허용하는 조건으로 라이선스되어 있는지 확인할 책임이 있습니다.
...
귀하는 무결성 및 저작권 표시의 권리를 포함하여 서비스의 일부에 업로드, 게시 또는 제출하는 귀하의 콘텐츠에 대한 모든 저작인격권을 보유합니다. 그러나 사용자는 이러한 권리를 포기하고, GitHub 및 그 계열사가 섹션 D.4에서 부여된 권리를 합리적으로 행사할 수 있도록 하기 위해 해당 권리를 당사 또는 계열사에 대해 주장하지 않기로 동의합니다. 단, 그 외의 경우에는 해당되지 않습니다.
...
### [8. 공개 저장소 및 합법적 접근](#8-public-repositories-and-lawful-access) ###

공개 저장소에 콘텐츠를 기여하기로 선택함으로써, 사용자는 해당 콘텐츠가 인터넷상의 모든 사람이 접근할 수 있도록 하도록 당사에 지시하고 그렇게 하는 것에 동의하는 것입니다. 여기에 명시적으로 규정된 경우를 제외하고, 이 약관은 제3자 또는 GitHub 및 그 계열사가 공개 저장소의 콘텐츠에 합법적으로 접근하거나 사용하는 것을 제한하지 않습니다.

### [9. 액세스 상호 호환 관계](#9-access-reciprocity) ###

상업적으로 사용 가능한 인공 지능 모델, 기계 학습 시스템 또는 유사한 기술("상업용 AI 시스템")을 개발하거나 교육하기 위해 서비스에서 공개적으로 액세스할 수 있는 콘텐츠를 액세스, 수집 또는 달리 사용("액세스")하는 자동화된 수단을 사용하면, 귀하는 본 약관에 따라 귀하가 소유하거나 운영하는 제품, 서비스, 웹 사이트 또는 데이터 세트에 적용되어 상업용 AI 시스템을 개발하거나 교육하기 위한 목적을 포함하여 제품 또는 서비스와 관련된 공개적으로 액세스 가능한 데이터, 정보 또는 콘텐츠에 대한 GitHub의 액세스를 금지 또는 제한하거나 조건을 부과하는 모든 정책, 약관, 조건 또는 계약 조항을 포기합니다. 귀하는 또한 이러한 액세스를 제한하거나 보복하기 위해 기술적 조치 또는 기타 타겟 조치를 부과하지 않을 것에 동의합니다.

이 섹션 D.9는 학술 연구 목적의 접근에는 적용되지 않으며, 또한 사용자가 콘텐츠에 접근하는 시점 기준으로 직전 달 동안 사용자가 제공하는 제품 또는 서비스의 월간 활성 사용자가 7억 명 미만인 경우에도 적용되지 않습니다. 본 섹션의 목적을 위해 "귀하"는 귀하와 귀하(계열사)를 직간접적으로 제어하거나, 귀하(계열사)에 의해 제어되거나, 귀하(계열사)와 공동 통제하에 있는 모든 엔터티를 의미합니다.

[E. 개인 리포지토리](#e-private-repositories)
----------

**짧은 버전:***비공개 저장소의 내용은 기밀로 취급되며, 아래 섹션 E.3에 명시된 경우에만 접근합니다. 즉, 보안 목적, 저장소 소유자의 지원 요청 처리, 서비스의 무결성 유지, 법적 의무 준수, 콘텐츠가 법을 위반한다고 판단할 이유가 있는 경우, 또는 사용자의 동의가 있는 경우에만 접근합니다.*
...
사용자는 자신의 비공개 저장소 콘텐츠에 대한 접근을 통제합니다. GitHub는 섹션 E.2에 명시된 바와 같이 비공개 저장소의 내용을 사용자의 기밀로 간주하며, GitHub 직원은 사용자의 동의 없이 다음과 같은 경우를 제외하고는 비공개 저장소의 내용에 접근하지 않습니다.

* 보안을 목적으로 하는 경우.
* 알려진 취약점, 활성 악성 코드 또는 서비스 약관을 위반하는 것으로 알려진 기타 콘텐츠를 탐지하기 위한 자동 스캔 또는 수동 검토의 경우;
* 저장소 소유자의 지원 요청을 처리하기 위한 경우;
* 서비스의 무결성을 유지하기 위한 경우; 또는
...
GitHub는 이 정책의 [반복 침해자](/ko/site-policy/content-removal-policies/dmca-takedown-policy#f-repeated-infringement)의 계정을 해지할 것입니다.
...
### [1. 적용 가능성](#1-applicability) ###

이 섹션은 특정 기능에 이를 명시적으로 수정하는 추가 약관이 있는 경우를 제외하고 모든 AI 기능에 적용됩니다. 섹션 J.3의 학습 및 데이터 사용 조항은 개인 라이선스에만 적용됩니다. 사용자의 서비스 이용이 GitHub 고객 계약 또는 대량 라이선스 계약의 적용을 받는 경우, 해당 계약이 AI 기능과 관련된 데이터 사용을 규율하며 섹션 J.3은 적용되지 않습니다.

### [2. 소유권](#2-ownership) ###

GitHub는 사용자의 입력 또는 출력에 대한 소유권을 주장하지 않습니다.

출력에는 모델의 학습 데이터에 있는 코드나 콘텐츠와 유사한 내용이 포함되거나, 제3자의 저작권 또는 오픈 소스 라이선스 조건의 적용을 받는 자료가 포함될 수 있습니다. 출력의 사용에 제3자 라이선스가 필요한지 판단하고, 해당 라이선스를 준수할 책임은 사용자에게 있습니다.

### [3. 사용자의 입력 및 출력에 기반한 개발 및 개선](#3-development-and-improvement-using-your-input-and-output) ###

당사는 사용자의 입력을 사용하여 출력을 생성하고 AI 기능을 제공합니다. 사용자는 또한 GitHub 및 그 계열사에 인공지능 및 머신러닝 모델과 기술(이 중에는 Power AI 기능을 구동하는 기술 포함)을 개발, 학습 및 개선하기 위해 사용자의 입력과 출력을 수집하고 사용할 수 있는 라이선스를 부여하며, 다만 (a) 계정 설정을 통해 이를 거부(opt-out)한 경우 또는 (b) 서비스 이용이 GitHub 고객 계약 또는 대량 라이선스 계약의 적용을 받는 경우에는 해당되지 않습니다. 사용자가 선택적으로 거부(opt-out)하는 경우, GitHub는 해당 거부의 적용 날짜 이후부터 이 문단에 설명된 목적을 위해 사용자의 입력과 출력을 수집하거나 사용하지 않습니다.

사용자가 선택적으로 거부하지 않는 한, GitHub의 계열사는 해당 라이선스에 따라 적용되는 개인 정보 및 계약상 의무에 따라 사용자의 입력과 출력을 사용할 수 있습니다. 그러나 이 라이선스는 GitHub 또는 그 계열사가 사용자의 입력이나 출력을 제3의 AI 모델 제공자에게 제공하여 해당 제공자의 독립적인 모델 학습 목적으로 사용하는 것을 허용하지 않습니다.

섹션 J.3의 라이선스는 섹션 D.4 및 D.8에 따라 GitHub 및 그 계열사에 부여된 권리에 추가되는 것이며, 이를 제한하지 않습니다. 이 라이선스는 AI 기능의 입력으로 제공되지 않은 저장소에 저장된 사용자의 콘텐츠에는 적용되지 않습니다.

이 섹션에 설명된 선택적 거부 권리는 이 섹션에서 설명된 사용자의 입력과 출력의 사용에만 적용되며, 섹션 D.4\~D.8에 따라 부여된 라이선스나 입력 또는 출력에 해당하지 않는 모든 콘텐츠(공개 저장소에 저장된 콘텐츠 포함)에는 적용되지 않습니다.

### [4. 고지 사항](#4-disclaimers) ###

출력은 “있는 그대로” 제공되며 섹션 O의 면책 조항의 적용을 받습니다. 섹션 O를 제한하지 않는 범위에서, 출력은 부정확하거나 불완전하거나 작동하지 않을 수 있습니다. 출력은 오픈 소스 라이선스 하의 코드를 포함하여 제3자의 코드와 유사할 수 있습니다. 당사는 출력이 오류, 취약점 또는 지적 재산권 주장으로부터 자유롭다는 것을 보장하지 않습니다.

사용자는 사용 전에 모든 출력을 검토, 테스트 및 검증할 책임이 있습니다.

### [5. 사용자의 책임 및 면책 보상 의무](#5-your-responsibility-and-indemnity) ###

사용자는 출력의 사용에 대한 책임이 있으며, 여기에는 해당 사용이 관련 법률을 준수하고 제3자의 권리를 침해하지 않도록 하는 것이 포함됩니다.

섹션 Q에 따른 사용자의 면책 보상 의무는 AI 기능 및 출력의 사용에도 적용되며, 여기에는 사용자가 자신의 제품 또는 서비스에 포함한 출력에서 발생하는 청구도 포함됩니다.
...
* [요금제 옵션을 선택](https://github.com/pricing)하거나 [청구 설정](https://github.com/settings/billing)에서 언제든지 서비스 수준을 변경할 수 있습니다. 계정을 다운로드하기로 선택하는 경우, 계정의 콘텐츠에 대한 액세스, 기능 또는 용량을 상실할 수 있습니다. 해당 콘텐츠의 복사본을 얻는 방법에 대한 자세한 내용은 [취소](#m-cancellation-and-termination) 섹션을 참조하십시오.
...
관련 법률이 달리 규정하는 경우를 제외하고 귀하와 GitHub 간의 본 계약과 웹 사이트 또는 서비스 액세스 또는 사용에는 국제 사법 조항에 대한 고려 없이 미국의 연방 법률과 캘리포니아 주의 법률이 적용됩니다. 귀하와 GitHub는 캘리포니아 주 샌프란시스코 시 및 카운티에 위치한 법원의 전속 관할과 재판지에 따를 것에 동의합니다. 다만 섹션 D.9 위반과 관련된 금지 명령 구제 청구는 어느 관할에서도 제기할 수 있습니다.
...
이 계약은 GitHub의 권한 있는 대표자가 서명한 서면 개정에 의해서만, 또는 [섹션 R. 본 약관의 변경](#r-changes-to-these-terms)에 따라 GitHub가 개정된 버전을 게시하는 경우에만 수정될 수 있습니다. 본 서비스 약관은 GitHub 개인정보취급방침과 함께 귀하와 GitHub 사이에 체결된 계약의 완전하고 배타적인 문서에 해당합니다. 본 계약은 기밀 또는 비공개 계약을 포함하여 본 약관의 주제와 관련된 귀하와 GitHub 간의 모든 제안이나 사전 구두 또는 서면 합의 및 기타 모든 전언을 대체합니다.
