...
* [Bullying and Harassment](/fr/site-policy/acceptable-use-policies/github-bullying-and-harassment)
...
* Piling on to or orchestrating [disruptive](/fr/site-policy/acceptable-use-policies/github-disrupting-the-experience-of-other-users) activity in a way that amounts to abuse
