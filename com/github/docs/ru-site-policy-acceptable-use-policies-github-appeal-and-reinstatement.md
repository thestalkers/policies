Апелляция GitHub и восстановление - Документация GitHub(function(){
...
* Блокирование публикации содержимого на npm
...
Если вы требуете восстановления или хотите обжаловать принудительное действие на GitHub или npm, заполните соответствующую форму:

* [форма апелляции GitHub и восстановления](https://support.github.com/contact/reinstatement)
* [форма апелляции npm и восстановления](https://support.github.com/support/contact/product-selection/reinstatement-requests/npm-reinstatement-request)

На GitHib вы можете потребовать восстановление или подать апелляцию на решение модератора до шести месяцев после принятия решения. GitHub может, по своему усмотрению, отказаться от рассмотрения каких-либо запросов, поданных позже, чем шесть месяцев после принятия решения.
