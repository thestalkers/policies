GitHub 政府下架政策 - GitHub 文档(function(){
...
4. [GitHub 政府下架政策](/zh/site-policy/other-site-policies/github-government-takedown-policy)
...
* [这是什么？](#what-is-this)
* [如何提交政府内容移除请求](#how-to-submit-a-government-takedown-request)
...
如果您是政府官员，并希望依据本政策申请移除内容，则可以使用我们的 [政府内容移除请求表](https://support.github.com/contact/government-takedown) 提交您的请求。
...
这意味着我们在指定日期收到了通知， 但\_不\_意味着内容是非法或错误的， 也\_不\_意味着通知中所指的用户犯了任何错误。 我们并不对政府要求的正误做出或暗示任何判断。 我们发布这些通知和要求只是为了提供信息。
