Правила поведения на мероприятиях GitHub - GitHub Docs(function(){
...
3. [Правила поведения на мероприятиях GitHub](/ru/site-policy/github-terms/github-event-code-of-conduct)
