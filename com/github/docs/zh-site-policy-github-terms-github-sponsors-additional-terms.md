...
如果您选择申请加入计划，则只有在完成注册过程并由 GitHub 准许加入计划后，您才有可能加入计划。 此外，您可能需要在 GitHub 选择的付款服务提供商（例如 Stripe）处注册帐户，才能访问和使用计划的某些功能。 您必须使用您的真实身份进行注册，并且您同意根据计划注册表的要求，提供并维护关于您本人的真实、准确、最新且完整的信息。 注册数据及关于您的某些其他信息受我们的[隐私声明](/zh/site-policy/privacy-policies/github-general-privacy-statement)以及我们的付款处理机构提供的任何隐私声明的约束。 GitHub 有权拒绝准许对计划的加入。
...
向受赞助开发人员支付的所有款项均由 Stripe 处理和发放，而非 GitHub。 GitHub 不向受赞助开发人员划转或转账资金。 所有支付的时间、方式和流程均由 Stripe 根据 Stripe 条款进行把控。 GitHub 对 Stripe 的款项发放时间及方式均无法控制。
...
GitHub 拟遵守 GitHub 根据自己的判断合理确定适用于此类付款的所有适用税务信息申报和预扣税法。 如果必须对 GitHub 支付给您的任何金额预扣税款，或者从根据适用法律需要进行税务信息申报的金额中预扣税款，GitHub 将从应付给您的金额里扣除此类税款，并将其支付给相应的税收机构，也会根据需要取得并为您提供根据适用法律要求预扣的任何此类税款的正式收据。 GitHub 将采取合理的措施，在适用法律允许的范围内尽可能减少此类税款，并且各方将根据适用所得税法或条约，合理地与另一方展开合作，以获得最低税率或取消此类税款。 这包括您向 GitHub 提供适用法律要求的适当信息，例如 IRS 表单 W-8、W-9 或其他信息，以争取预扣税豁免。 如适用，您还应遵守第三方支付处理商关于税费预扣和申报的条款和条件。 此外，GitHub 有权暂停向您的帐户付款，直至您向 GitHub 提供适用法律要求的适当文档或信息，以便 GitHub 确定适用于本附加条款或协议项下付款的任何适用预扣税或申报义务。

#### [3.2.3. 因违规而扣留受赞助开发人员付款。](#323-withholding-of-sponsored-developer-payment-for-breach) ####

如果受赞助开发人员违反或涉嫌违反本附加条款或协议，GitHub 有权根据本附加条款或以其他方式扣留受赞助开发人员付款，直至 GitHub 对其进行合理调查。 如果 GitHub 自行酌情认定受赞助开发人员违反本附加条款或协议，GitHub 可永久扣留应支付给该受赞助开发人员的任何款项，且赞助商可选择将该等款项重新分配给其他受赞助开发人员。

### [3.3. 付款时间。](#33-payment-timing) ###

在协议有效期内，Stripe 将通过您的 Stripe Connect 账户，在每月结束后的 30 天内，处理并汇付所有受赞助开发人员款项，但须受以下可变因素的约束。 付款通过 Stripe Connect 发送至您在申请 GitHub 赞助商计划时提供的银行帐户。 对于因您或银行提供的信息不准确或不完整，导致受赞助开发人员款项延迟或错误入账，或因银行未能将款项计入您的账户的，GitHub 和 Stripe 均不承担责任。 GitHub 不对 Stripe 在处理或发放款项过程中出现的任何延迟、故障或错误承担责任。 所有相关事宜均以 Stripe 条款为准。

* 首次付款时，Stripe 将在首次赞助启动 60 天后通过 Stripe Connect 处理并向您汇付所有受赞助开发人员款项，但须受以下可变因素的约束。 此试用期适用于所有受赞助开发人员帐户，有助于确保计划的完整性。 此后的付款将按照本节规定，在该月结束后的 30 天内汇出。
...
* 如果您通过 ACH 转帐或电汇接收付款，您将在每月的第三个周四收到付款。 如果您当月账户余额达到 100 美元，Stripe 将向您发放款项。 来自 GitHub 赞助商匹配资金的捐款不计入此阈值。 如果您的月底余额低于 100 美元，则余额将进行累积，直至下一次您的月底余额高于阈值为止。 如果您退出 GitHub 赞助商计划，即使余额低于 100 美元，Stripe 也会发放您的剩余余额。

* 来自共用资金的付款。 对于参与 SOSS 基金或类似共用资金机制的受赞助开发人员，付款时间和流程仍按上述规定执行。 当一笔赞助资金从基金账户分配给您时：该分配将从由 Stripe 持有并管控的共用资金中支取；经 GitHub 确认赞助分配后，Stripe 将立即将资金转入您的 Stripe Connect 账户，但须遵守 Stripe 根据 Stripe 条款确定的 Stripe Connect 标准结算时间；相同的付款时间、付款方式和银行账户要求适用于非共用资金，并由 Stripe 根据 Stripe 条款确定。 GitHub 不控制 Stripe 向受赞助开发人员付款的时间、方式或执行。 所有支付处理都受 Stripe 条款的约束。

* 终止后，Stripe 将在确认终止当月的日历月结束后约 90 天内，通过 Stripe Connect 处理并向您支付所有已收到但未支付的受赞助开发人员款项。

### [3.4. 付款方式。](#34-payment-method) ###

Stripe 将通过 ACH/SEPA 转账或电汇方式，向您指定的账户汇付受赞助开发人员款项，具体须遵守 GitHub 当时有效的支付政策中规定的限额、方式和期限，GitHub 可不定期对该政策进行更新。 付款方式和阈值可能因国家/地区和您提供的帐户信息而异。 Stripe 可自行酌情将应支付给您的受赞助开发人员款项与本计划下的其他受赞助开发人员款项合并。
...
要接收受赞助开发人员款项，您必须向我们提供我们要求的完整且准确的财务、税务和银行信息（例如，通过帐户创建、设置或其他方式）。 我们将通过任何通信方式，就所需信息发生的变化通知您。 如果您未能准确提供（或准确维护）此类信息，(a) 我们可以从您的受赞助开发人员款项中扣除任何相关的银行费用，并且 (b) 我们可以终止本附加条款，且您可能会丧失本计划下应支付给您的任何受赞助开发人员款项。
...
### [3.9. GitHub 不对支付处理承担责任。](#39-no-github-liability-for-payment-processing) ###

#### [3.9.1 Stripe 承担全部责任。](#391-stripes-sole-responsibility) ####
...
(e) GitHub 不对 Stripe 支付处理服务的运行情况或 Stripe 所持资金的安全作任何声明或保证。

#### [3.9.2 GitHub 角色的限制。](#392-limitation-of-githubs-role) ####
...
如果任何一方根据第 5.3 条终止协议，Stripe 唯一的义务是处理并向受赞助开发人员汇付截至终止日累积的受赞助开发人员款项，除非法律禁止该等付款。
...
GitHub 将根据赞助商的依赖关系，在[探索 GitHub 赞助商](https://github.com/sponsors/explore)上确定可供投资的项目。 赞助商应自行斟酌决定对项目进行投资，包括赞助哪些项目以及赞助金额。
...
赞助商可以创建一张发票，以将资金存入由 Stripe 管理和控制的 Stripe 账户，用于对项目进行投资。 GitHub 将在发票创建表单完成后向赞助商开具发票。 赞助商将在 GitHub 发票日期后的三十 (30) 天内全额支付每张发票开具的费用，没有任何形式的扣除或抵销。 每张发票所列金额以及根据本协议应支付的金额均不可退还，但 Stripe 条款另有规定的除外。 付款后，资金将直接转入由 Stripe 持有的 Stripe 账户。 GitHub 不接收、持有或拥有赞助商资金。 所有资金的托管、保管和发放均由 Stripe 根据 Stripe 条款执行。

### [2.2. 费用。](#22-fees) ###

每笔交易将从赞助商账户中扣除 3% 的额外服务费（“服务费”），以支付 GitHub 为提供本计划所产生的管理成本。 如果通过信用卡付款，将额外收取 3% 的手续费。
...
如果没有未结清的有效发票，任何一方均可提前三十 (30) 天书面通知终止本协议。
...
GitHub 按“AS IS”和“AS AVAILABLE”提供赞助商计划，且 GitHub 明确声明不承担关于服务的所有担保，无论该担保是明示、默示还是法律规定的，包括但不限于适销性、特定目的的适用性、所有权、安全性、准确性或不侵权的任何默示保证。

### [4.1A. 支付处理免责声明。](#41a-payment-processing-disclaimer) ###
...
(g) Stripe 作出的任何行为、不作为、声明或保证。

所有与支付处理和资金转账相关的事宜均仅受 Stripe 条款约束。 赞助商和受赞助开发人员确认，其所有支付处理服务均依赖 Stripe，而非 GitHub。

### [4.2. 责任限制。](#42-limitation-of-liability) ###

#### [4.2.1. 间接损害的排除。](#421-exclusion-of-indirect-damages) ####
...
#### [4.2.2. 全部责任的限制。](#422-limitation-of-total-liability) ####
...
本协议的条款和条件属于双方的机密信息。 除本协议允许的情况外，任何一方均不得使用另一方根据本协议提供的机密信息。

[B. 公开性。](#b-publicity)
----------

GitHub 可发布与赞助商（经赞助商许可）或受赞助开发人员参与本计划相关的新闻稿、博客文章、社交媒体文章和/或其他公开通讯。 除非该等使用为必须，否则 GitHub 不得根据本协议使用或提及该赞助商的徽标、名称或姓名，或对其享有权益。
