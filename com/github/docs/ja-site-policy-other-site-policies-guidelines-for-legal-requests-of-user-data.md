...
* <a name="private-account-data"></a>**非公開アカウント データ**: GitHub は、当社の[プライバシー ポリシー](/ja/site-policy/privacy-policies/github-privacy-statement)に記載されているように、ユーザーに関する特定の個人情報も収集し、維持します。
  これには以下が含まれます。
