...
GitHub Copilot は、EAR 第 740 部補足 No.1 に記載されている国グループ E:1 に記載されている国、 またはウクライナのクリミア半島とドネツク州、ルガンスク州の分離地域に、無許可で販売、輸出、再輸出することはできません。 リストに現在記載されている国には、キューバ、イラン、北朝鮮、シリア、ロシア、およびベラルーシが含まれていますが、このリストは変更される場合があります。
