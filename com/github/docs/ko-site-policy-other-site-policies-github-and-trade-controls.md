...
이들 지역을 여행할 경우 귀하의 계정 상태에 영향을 미칠 수 있으며 다만 제재 지역을 벗어나 [개인 계정 이의 요청서](https://airtable.com/shrGBcceazKIoz6pY) 또는 [조직 계정 이의 요청서](https://airtable.com/shrB2je5RBkqLEt5D)를 성공적으로 제출하면 가용성을 복원할 수 있습니다.
