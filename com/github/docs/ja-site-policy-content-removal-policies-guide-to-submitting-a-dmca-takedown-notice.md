DMCA 削除通知提出ガイド - GitHubドキュメント(function(){
...
3. [DMCA 削除通知提出ガイド](/ja/site-policy/content-removal-policies/guide-to-submitting-a-dmca-takedown-notice)
...
コードが他のクリエイティブ コンテンツと異なる理由はいくつもあります。 次に例を示します。
...
***お客様の苦情は公開されます。*** [DMCA 削除ポリシー](/ja/site-policy/content-removal-policies/dmca-takedown-policy#e-transparency)に記載されているように、当社は、完全かつ法的に有効なすべての削除通知を、個人情報を編集したうえで <https://github.com/github/dmca> に公開します。
...
5. **お客様の連絡先情報を提供しなければなりません。** 電子メール アドレス、氏名、電話番号と住所を記載してください。
...
著作権法では、著作権で保護された著作物へのアクセスを効果的に制御する技術的措置の回避も禁止しています。 GitHub 上でホストされているコンテンツが本禁止事項に違反していると思われる場合は、当社の [著作権侵害申し立てフォーム](https://github.com/contact/dmca)を通じてご報告ください。 回避申し立てには、実施されている技術的措置に関する以下の詳細および告発されたプロジェクトが回避している方法を記載する必要があります。 特に、GitHub への通知には、以下に関する詳細な説明を含める必要があります。
