GitHub 注册开发人员协议 - GitHub 文档(function(){
...
3. [GitHub 注册开发人员协议](/zh/site-policy/github-terms/github-registered-developer-agreement)
...
2. **计划条款**
   ...
   我们发布了[计划权益和指南](/zh/integrations/concepts/github-developer-program)（以下简称“计划概述”）。 可以预见，计划概述会不时更改。 这些更改将适用于计划参与者，因此我们鼓励您定期查看计划概述，以随时了解任何更改。 出于各种原因，我们可能需要更改、暂停或终止计划，或者我们提供的某些权益。 您同意，我们可以在不对您承担任何责任的情况下采取上述行动，除非第 9 节另有规定。
