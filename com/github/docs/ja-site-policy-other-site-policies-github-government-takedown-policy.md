GitHub の行政機関による削除のポリシー - GitHubドキュメント(function(){
...
政府関係者が、このポリシーに基づいてコンテンツの削除を要求する場合は、[行政機関による削除要求フォーム](https://support.github.com/contact/government-takedown)を使用して要求を送信できます。

要求が完全であると見なされるには、以下の条件を満たしている必要があります。
