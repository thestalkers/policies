...
* [E. プライベート リポジトリ](#9-access-reciprocity)
...
* [K. 支払い](#3-development-and-improvement-using-your-input-and-output)
* [L. 解約および終了](#3-feedback)
* [M. GitHub との連絡](#4-authorization)
* [N. 保証の免責事項](#2-upon-cancellation)
* [O. 責任制限](#3-github-may-terminate)
* [P. 免責および補償](#4-survival)
* [Q. 本条件の変更](#n-communications-with-github)
* [R. 雑則](#1-electronic-communication-required)
...
### [3.コンテンツの所有権、投稿権、ライセンスの付与](#3-ownership-and-license-grants) ###
...
### [8.アクセスの相互性](#8-public-repositories-and-lawful-access) ###
...
本セクション D.8 は、学術研究のみを目的とするアクセスには適用されず、また、お客様がコンテンツにアクセスした日に、お客様が提供している製品/サービスの前暦月の月間アクティブ ユーザー数が 7 億人を超えない場合には適用されません。 本条において「お客様」とは、お客様と、直接的または間接的にお客様を支配し、お客様によって支配され、またはお客様と共通の支配下にある法主体 (関連会社) を指します。
...
### [1.変更の対象](#j-ai-features-training-and-your-data) ###
...
### [2.アップグレード、ダウングレード、および変更](#5-your-responsibility-and-indemnity) ###
...
### [3.請求スケジュール、払戻なし](#k-beta-previews) ###
...
### [1.必要な電子通信](#5-responsibility-for-payment) ###
...
### [2.GitHub への法的通知は書面で行わなければなりません](#m-cancellation-and-termination) ###
...
### [3.電話サポートなし](#1-account-cancellation) ###
...
### [1.準拠法](#2-legal-notice-to-github-must-be-in-writing) ###

適用法が別途規定する場合を除き、お客様と GitHub 間の本契約、および Web サイトあるいは本サービスへのアクセスまたは使用には、抵触法の規定にかかわらず、アメリカ合衆国憲法およびカリフォルニア州法が適用されます。 お客様と GitHub は、カリフォルニア州サンフランシスコ市郡にある裁判所が専属的裁判管轄地および裁判地に提出することに同意するものとします。 ただし、第 D.8 条の違反に関する差し止め命令による救済の請求は、いかなる法域でも提起できます。

### [2.譲渡不可](#3-no-phone-support) ###
...
### [3.セクションの見出しと要約](#o-disclaimer-of-warranties) ###

本契約全体を通じて各セクションにはタイトルと、契約条件に続く要約が含まれています。 これらのセクションのタイトルおよび概要に法的拘束力はありません。

### [4.可分性、権利の不放棄、および存続](#p-limitation-of-liability) ###
...
### [5.修正、完全なる合意](#q-release-and-indemnification) ###
...
### [6.お問い合わせ](#r-changes-to-these-terms) ###
