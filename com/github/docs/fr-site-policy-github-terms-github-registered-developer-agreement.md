Contrat de développeur enregistré GitHub - Documentation GitHub(function(){
...
3. [Contrat de développeur enregistré GitHub](/fr/site-policy/github-terms/github-registered-developer-agreement)
