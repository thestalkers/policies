...
후원 대상 개발자에 대한 모든 결제는 GitHub가 아닌 Stripe에서 처리 및 배포됩니다. GitHub는 후원 대상 개발자에게 자금을 전송하거나 이체하지 않습니다. 모든 결제 타이밍, 방법 및 프로세스는 Stripe 약관에 따라 Stripe에 의해 제어됩니다. GitHub는 Stripe의 결제 배포 시기 또는 방법을 제어할 수 없습니다.
...
후원 대상 개발자가 본 추가 약관 또는 계약을 위반하거나 위반한 것으로 의심되는 경우, GitHub는 GitHub가 해당 사안을 합리적으로 조사하는 동안 본 추가 약관 또는 기타에 따른 후원 대상 개발자에 대한 지급을 공제할 권리를 보유합니다. GitHub가 재량으로 후원 대상 개발자가 본 추가 약관 또는 계약을 위반했다고 결정하는 경우, GitHub는 후원 대상 개발자에 지급해야 하는 금액을 영구적으로 지급 공제할 수 있으며, 스폰서는 자금을 또 다른 후원 대상 개발자에게 재할당하도록 선택할 수 있습니다.

### [3.3. 지급 시기.](#33-payment-timing) ###

기간 중에 Stripe는 귀하의 Stripe Connect 계정을 통해 아래 변수를 조건으로 임의의 달 마감 후 30일 이내에 해당 달에 수취한 모든 후원 대상 개발자 지급금을 처리하고 귀하에게 송금합니다. 지급금은 Stripe Connect를 통해 귀하가 GitHub Sponsors 신청 시 제공한 은행 계좌로 송금됩니다. GitHub 및 Stripe는 귀하나 은행이 제공한 잘못되거나 불완전한 정보로 인한 후원 대상 개발자 지급금의 지급 지연 또는 오용이나 귀하의 계정에 대한 은행의 입금 실패에 대해 책임을 지지 않습니다. GitHub는 Stripe의 결제 처리 또는 배포에서 지연, 실패 또는 오류에 대해 책임을 지지 않습니다. 이러한 모든 문제는 Stripe 약관의 적용을 받습니다.

* 첫 번째 결제의 경우 Stripe는 아래 변수에 따라 첫 번째 후원이 시작된 후 60일 후에 Stripe Connect를 통해 모든 후원 대상 개발자 결제를 처리하고 송금합니다. 이 테스트 기간은 모든 스폰서 개발자 계정에 적용되며 프로그램의 무결성을 보장하는 데 도움이 됩니다. 그 이후의 지급금은 본 조에 따라 해당 달 마감 후 30일 이내에 송금됩니다.
...
* ACH 송금 또는 전신 송금을 통해 지급되는 경우, 해당 달의 세 번째 목요일에 지급금을 수령하게 됩니다. Stripe는 귀하의 잔고가 미화 100달러에 도달하는 달의 지급금을 귀하에게 지급합니다. GitHub Sponsors 매칭 펀드의 기여금은 이 임계값에 합산되지 않습니다. 월말에 잔고가 100달러 미만인 경우, 다음에 월말 잔고가 이 임계값 이상이 될 때까지 잔고가 누적됩니다. GitHub Sponsors에서 나가는 경우, Stripe는 잔고가 100달러 미만인 경우에도 남은 잔고에 대한 지급금을 지급합니다.

* 풀링된 자금의 지불. SOSS 기금 또는 이와 유사한 풀링된 자금 조달 메커니즘에 참여하는 후원 대상 개발자의 경우 위에서 설명한 대로 지불 시기 및 프로세스가 유지됩니다. 기금 프로필에서 후원이 할당되는 경우: 할당은 Stripe가 보유하고 제어하는 풀링된 기금에서 가져옵니다. GitHub의 후원 할당이 확인되면 Stripe가 Stripe 약관에 따라 Stripe에 의해 결정된 표준 Stripe Connect 합의 타이밍에 따라 Stripe Connect 계정으로 즉시 자금을 이체합니다. 동일한 지급 일정, 결제 방법 및 은행 계좌 요구 사항은 풀링되지 않은 후원에 적용되며 Stripe 약관에 따라 Stripe에 의해 결정됩니다. GitHub는 Stripe에서 후원 대상 개발자로의 지불 시기, 방법 또는 실행을 제어하지 않습니다. 모든 결제 처리에는 Stripe 약관이 적용됩니다.

* 종료 후 Stripe는 수취하고 지급되지 않은 모든 후원 대상 개발자 지급금을 본 추가 약관이 종료되었다고 GitHub가 인정하는 역월말 후 약 90일 이내에 Stripe Connect를 통해 처리하고 송금합니다.

### [3.4. 지급 방법.](#34-payment-method) ###

Stripe는 GitHub가 수시로 업데이트할 수 있는 GitHub의 유효한 지급 정책에 규정된 임계값, 방법, 기간을 적용하여 ACH/SEPA 또는 전신을 통해 귀하가 지정하는 계좌로 후원 대상 개발자 지급금을 송금합니다. 지급 방법과 임계값은 국가 및 귀하가 제공하는 계정 정보에 따라 달라질 수 있습니다. Stripe는 재량에 따라 후원 대상 개발자 지급금과 프로그램과 관련하여 귀하에게 지급해야 하는 다른 지급금을 합칠 수 있습니다.
...
후원 대상 개발자 지급금을 받으려면 귀하는 GitHub가 요청하는 완전하고 정확한 금융, 세금, 은행 정보를 GitHub에 제공해야 합니다(예를 들어 계정 생성이나 설정 또는 기타 방법을 통해). GitHub는 어떤 통신 수단이든 사용하여 필요한 정보의 변경 사항을 귀하에게 통지합니다. 귀하가 이러한 정보를 정확하게 제공하지(또는 정확하게 유지하지) 않는 경우, (a) GitHub는 귀하의 후원 대상 개발자 지급금에서 관련 은행 수수료를 공제할 수 있고, (b) 본 추가 약관을 해지할 수 있으며, 프로그램과 관련하여 귀하에게 지급해야 하는 후원 대상 개발자 지급금이 박탈될 수 있습니다.
...
GitHub Sponsors의 후원 대상 개발자 계정의 결제 처리 서비스는 Stripe가 제공하며, [Stripe 서비스 약관](https://stripe.com/legal)을 포함하는 [Stripe Connected Account 계약](https://stripe.com/connect-account/legal/full)(통칭하여 "Stripe Services" 계약)이 적용됩니다. 본 약관에 동의하거나 GitHub Sponsors에서 후원 대상 개발자 계정으로 계속 운영하면 Stripe가 수시로 수정할 수 있는 Stripe Services 계약에 구속되는 데 동의하는 것입니다. GitHub가 Stripe를 통해 결제 처리 서비스를 제공할 수 있는 조건으로 귀하는 귀하와 귀하의 비즈니스에 대한 정확하고 완전한 정보를 GitHub에 제공하는 데 동의하며, 귀하는 이 정보와 Stripe가 제공하는 결제 처리 서비스 이용과 관련된 거래 정보를 공유할 권한을 GitHub에게 부여합니다.
...
### [3.9. 결제 처리에 대한 GitHub 책임이 없습니다.](#39-no-github-liability-for-payment-processing) ###

#### [3.9.1 Stripe의 단독 책임.](#391-stripes-sole-responsibility) ####
...
(e) GitHub는 Stripe의 결제 처리 서비스 성능 또는 Stripe가 보유한 자금의 안전성과 관련하여 어떠한 진술이나 보증도 하지 않습니다.

#### [3.9.2 GitHub 역할의 제한 사항.](#392-limitation-of-githubs-role) ####
...
* Stripe에서 보유한 자금에 대한 보험, 본딩 또는 기타 보호 제공
...
일방 당사자가 5.3절에 따라 해지하는 경우, Stripe의 유일한 의무는 법률이 금지하지 않는 한 해지 날짜까지 누적된 후원 대상 개발자 지급금 금액을 처리하고 후원 대상 개발자에게 송금하는 것입니다.
...
GitHub는 [GitHub 스폰서 탐색](https://github.com/sponsors/explore)에서 투자를 사용할 수 있는 스폰서의 종속성을 기반으로 프로젝트를 식별합니다. 스폰서는 스폰서가 후원하는 프로젝트와 후원 금액을 포함하여 단독 재량에 따라 프로젝트에 투자해야 합니다.
...
스폰서는 프로젝트에 투자하기 위해 Stripe에서 관리하고 제어하는 Stripe 계정에 예금 자금을 추가하는 청구서를 만들 수 있습니다. GitHub는 청구서 생성 양식이 완료되면 스폰서에게 청구서를 발행합니다. 스폰서는 GitHub 청구서 날짜의 30일 이내에 모든 종류의 공제 또는 상계 없이 각 청구서에 명시된 수수료를 전액 지불합니다. 각 청구서에 반영된 금액과 이 계약에 따라 지불해야 하는 금액은 Stripe 약관에 제공된 경우를 제외하고는 환불되지 않습니다. 지불 시, 자금은 Stripe 계정의 Stripe에 의해 직접 이체되고 보유됩니다. GitHub는 스폰서 자금을 받거나 보유하거나 소유하지 않습니다. 모든 기금 관리, 보호 및 배포는 Stripe 약관에 따라 Stripe에 의해 수행됩니다.
...
### [4.1. 면책 조항.](#41-disclaimer) ###

GitHub는 스폰서 프로그램을 "AS IS" 및 "AS AVAILABLE" 상태로 제공하며, Github는 상업성, 특정 목적에 대한 적합성, 소유권, 보안, 정확성 또는 비침해성에 대한 보증을 포함하되 이에 국한되지 않는 서비스에 관한 명시적, 묵시적 또는 법적인 모든 보증을 명시적으로 부인합니다.

### [4.1A. 결제 처리 고지 사항.](#41a-payment-processing-disclaimer) ###
...
(g) Stripe에서 수행한 모든 행위, 누락, 표현 또는 보증.

지불 처리 및 자금 이체와 관련된 모든 문제는 Stripe 약관에 의해서만 규제됩니다. 스폰서 및 후원 대상 개발자는 모든 결제 처리 서비스에 GitHub가 아닌 Stripe를 사용한다는 사실을 인정합니다.
...
본 계약의 사용 약관은 양 당사자의 기밀 정보입니다. 본 계약에서 허용하는 경우를 제외하면 어떤 당사자도 본 계약에 따라 상대 당사자가 제공한 비밀 정보를 사용하지 않습니다.
