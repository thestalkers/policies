GitHub 커뮤니티 지침 - GitHub 문서(function(){
...
당사는 관리자가 각자 프로젝트를 관리하도록 최대한 지원하고 있지만, 상황 처리에 추가 지원이 필요한 경우 사이트 관리자가 [GitHub 지원 포털](https://support.github.com)에 문의하시기 바랍니다.
