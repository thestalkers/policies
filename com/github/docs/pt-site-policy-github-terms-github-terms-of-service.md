...
* [E. Repositórios Privados](#9-access-reciprocity)
* [F. Política de violação de direitos autorais e DMCA](#3-access)
* [G. Notificação de Propriedade Intelectual](#f-copyright-infringement-and-dmca-policy)
* [H. Termos do API](#3-license-to-github-policies)
* [I. Termos Adicionais do Produto GitHub](#h-api-terms)
* [J. Pré-visualizações Beta](#i-github-additional-product-terms)
* [K. Pagamento](#3-development-and-improvement-using-your-input-and-output)
* [L. Cancelamento e Rescisão.](#3-feedback)
* [m. Comunicações com o GitHub](#4-authorization)
* [N. Isenção de garantias](#2-upon-cancellation)
* [O. Limitação de responsabilidade.](#3-github-may-terminate)
* [P. Liberação e Indenização](#4-survival)
* [P. Alterações nestes Termos](#n-communications-with-github)
* [R. Disposições Gerais](#1-electronic-communication-required)
...
|                             [K. Pagamento](#k-payment)                             |                                                                     Você é responsável pelo pagamento. Somos responsáveis por faturar você com precisão.                                                                      |
...
### [3. Propriedade do Conteúdo, Direito de Postagem e Outorgas de Licença](#3-ownership-and-license-grants) ###
...
### [8. Recíproca de acesso](#8-public-repositories-and-lawful-access) ###
...
### [1. Controle de Repositórios Privados](#e-private-repositories) ###

Algumas Contas podem ter repositórios privados, que permitem ao Usuário controlar o acesso ao Conteúdo.

### [2. Confidencialidade de Repositórios Privados](#1-control-of-private-repositories) ###
...
### [3. Acesso](#2-confidentiality-of-private-repositories) ###
...
### [1. Direitos do GitHub ao Conteúdo](#g-intellectual-property-notice) ###
...
### [2. Marcas e Logotipos do GitHub](#1-githubs-rights-to-content) ###
...
### [3. Políticas de Licença do GitHub](#2-github-trademarks-and-logos) ###
...
### [1. Sujeito a alterações](#j-ai-features-training-and-your-data) ###
...
### [2. Confidencialidade](#1-applicability) ###
...
### [2. Atualizações, Downgrades e Alterações](#5-your-responsibility-and-indemnity) ###
...
### [3. Cronograma de Cobrança; Sem Reembolsos](#k-beta-previews) ###
...
### [4. Autorização.](#1-subject-to-change) ###
...
### [5. Responsabilidade pelo Pagamento](#2-confidentiality) ###
...
### [1. Cancelamento da Conta](#l-payment) ###
...
### [2. Após o Cancelamento](#1-pricing) ###
...
### [3. Possibilidade de Encerramento pelo GitHub](#2-upgrades-downgrades-and-changes) ###
...
### [4. Subsistência](#3-billing-schedule-no-refunds) ###
...
### [1. Comunicação Eletrônica Obrigatória](#5-responsibility-for-payment) ###
...
### [2. A notificação legal para o GitHub deve ser por escrito](#m-cancellation-and-termination) ###
...
### [3. Inexistência de suporte por telefone](#1-account-cancellation) ###
...
### [3. Títulos e Resumos das Seções](#o-disclaimer-of-warranties) ###
...
### [4. Autonomia das Cláusulas, Impossibilidade de Renúncia e Sobrevivência](#p-limitation-of-liability) ###
...
### [5. Aditamentos; Acordo Integral](#q-release-and-indemnification) ###
...
### [6. Dúvidas](#r-changes-to-these-terms) ###
