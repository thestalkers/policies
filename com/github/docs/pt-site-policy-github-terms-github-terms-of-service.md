...
### [8. Recíproca de acesso](#8-access-reciprocity) ###
...
Todas as disposições deste Contrato que, por sua natureza, devem sobreviver à rescisão\_subsistirão\_ à rescisão, incluindo, entre outras: disposições de propriedade, isenções de garantia, indenização e limitações de responsabilidade.
