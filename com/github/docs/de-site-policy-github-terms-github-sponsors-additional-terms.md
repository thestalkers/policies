...
Alle Zahlungen an gesponserte Entwickler werden von Stripe verarbeitet und verteilt, nicht von GitHub. GitHub überträgt oder transferiert keine Gelder an gesponserte Entwickler. Alle Zahlungsfristen, -methoden und -prozesse werden entsprechend den Stripe-Bedingungen durch Stripe kontrolliert. GitHub hat keine Kontrolle über den Zeitpunkt oder die Methode der Zahlungsverteilung durch Stripe.

### [3.2. Zahlungsausschlüsse für gesponserte Entwickler.](#32-sponsored-developer-payment-exclusions) ###
...
Im Falle eines Verstoßes oder mutmaßlichen Verstoßes eines gesponserten Entwicklers gegen diese zusätzlichen Bedingungen oder die Vereinbarung behält sich GitHub das Recht vor, die Zahlung an den gesponserten Entwickler gemäß diesen zusätzlichen Bedingungen oder anderweitig zurückzuhalten, bis GitHub eine angemessene Untersuchung diesbezüglich durchgeführt hat. Wenn GitHub nach eigenem Ermessen feststellt, dass ein gesponserter Entwickler gegen diese zusätzlichen Bedingungen oder die Vereinbarung verstößt, kann GitHub alle dem gesponserten Entwickler zustehenden Beträge dauerhaft zurückhalten, und dem Sponsor steht es frei, diese Mittel einem anderen gesponserten Entwickler zuzuteilen.

### [3.3. Zahlungszeitpunkt.](#33-payment-timing) ###

Während der Laufzeit verarbeitet und überweist Stripe Ihnen über Ihr Stripe Connect-Konto alle in einem bestimmten Monat erhaltenen Sponsored Developer-Zahlungen innerhalb von 30 Tagen nach Ende dieses Monats, vorbehaltlich der folgenden Variablen. Auszahlungen werden über Stripe Connect auf das Bankkonto gesendet, das Sie bei der Bewerbung für GitHub Sponsors angegeben haben. Weder GitHub noch Stripe ist für Verzögerungen oder die fehlerhafte Anwendung von Sponsored Developer-Zahlungen infolge falscher oder unvollständiger Informationen verantwortlich, die von Ihnen oder einer Bank bereitgestellt worden sind, oder für Fehler einer Bank bei der Gutschrift auf Ihr Konto. GitHub ist nicht verantwortlich für Verzögerungen, Ausfälle oder Fehler bei der Zahlungsabwicklung oder -verteilung durch Stripe. Alle diese Angelegenheiten unterliegen den Stripe-Bedingungen.

* Bei den ersten Zahlungen verarbeitet und überweist Stripe Ihnen über Stripe Connect alle Sponsored Developer-Zahlungen innerhalb von 60 Tagen nach Veranlassen des ersten Sponsorings, vorbehaltlich der folgenden Variablen. Dieser Probezeitraum gilt für alle Sponsored Developer-Konten und trägt dazu bei, die Integrität des Programms zu gewährleisten. Zahlungen danach werden gemäß diesem Abschnitt innerhalb von 30 Tagen nach Ende des Monats überwiesen.
...
### [3.9. Keine GitHub-Haftung für die Zahlungsabwicklung.](#39-no-github-liability-for-payment-processing) ###

#### [3.9.1 Alleinige Verantwortung von Stripe.](#391-stripes-sole-responsibility) ####
...
(e) GitHub keine Zusicherungen oder Garantien hinsichtlich der Leistung der Zahlungsabwicklungsdienste von Stripe oder der Sicherheit von Geldern, die von Stripe verwahrt werden, übernimmt.

#### [3.9.2 Einschränkung der Rolle von GitHub.](#392-limitation-of-githubs-role) ####
...
* Versicherungen, Anleihen oder anderen Schutz für Geldmittel bereitstellen, die von Stripe verwahrt werden
...
SIE STIMMEN AUSDRÜCKLICH ZU, DASS DIE ABSCHNITTE O (HAFTUNGSAUSSCHLUSS), P (HAFTUNGSBESCHRÄNKUNG) UND Q (FREIGABE UND FREISTELLUNG) DER VEREINBARUNG FÜR DIESE ZUSÄTZLICHEN BEDINGUNGEN GELTEN.
...
GitHub identifiziert Projekte auf der Grundlage der Abhängigkeiten des Sponsors, für die Investitionen verfügbar sind, unter [Explore GitHub Sponsors](https://github.com/sponsors/explore). Der Sponsor investiert nach eigenem Ermessen in Projekte. Dies schließt die Auswahl der zu fördernden Projekte und die Höhe der Förderung ein.
...
GitHub stellt dem Sponsor ein Dashboard zur Verfügung, das den Gesamtbetrag und das Guthaben des Sponsors anzeigt.
...
Der Sponsor kann eine Rechnung erstellen, um Geldmittel auf das von Stripe verwaltete und kontrollierte Stripe-Konto einzuzahlen, um in Projekte zu investieren. GitHub stellt dem Sponsor eine Rechnung aus, sobald das Formular zur Rechnungserstellung ausgefüllt ist. Der Sponsor zahlt die in jeder Rechnung aufgeführten Gebühren innerhalb von dreißig (30) Tagen nach dem Rechnungsdatum von GitHub in voller Höhe, ohne Abzug oder Aufrechnung. Die auf jeder Rechnung ausgewiesenen und gemäß dieser Vereinbarung zu zahlenden Beträge sind nicht erstattungsfähig, sofern in den Stripe-Bedingungen nichts anderes vorgesehen ist. Bei der Zahlung werden Geldmittel direkt an Stripe übertragen und im Stripe-Konto verwahrt. GitHub erhält, verwahrt oder besitzt keine Sponsorenmittel. Sämtliche Verwahrung, Sicherung und Verteilung von Geldmitteln erfolgt gemäß den Stripe-Bedingungen durch Stripe.

### [2.2. Gebühren.](#22-fees) ###

Eine zusätzliche Servicegebühr („Servicegebühr“) von 3 % pro Transaktion wird vom Konto des Sponsors abgezogen, um die Verwaltungskosten von GitHub im Zusammenhang mit dem Angebot des Programms zu decken. Wird die Zahlung per Kredit Karte erfolgt, wird eine zusätzliche Gebühr von 3% erhoben.
...
### [4.1. Gewährleistungsausschluss.](#41-disclaimer) ###
...
### [4.1A. Haftungsausschluss für die Zahlungsabwicklung.](#41a-payment-processing-disclaimer) ###
...
(g) jegliche Handlungen, Unterlassungen, Zusicherungen oder Garantien von Stripe.

Alle Angelegenheiten im Zusammenhang mit Zahlungsabwicklung und Geldtransfer unterliegen ausschließlich den Stripe-Bedingungen. Sponsoren und gesponserte Entwickler erkennen an, dass sie sich bei allen Zahlungsabwicklungsdiensten auf Stripe, nicht auf GitHub, verlassen.

### [4.2. Haftungsbeschränkung.](#42-limitation-of-liability) ###
...
Die Bestimmungen und Bedingungen dieses Vertrags sind vertrauliche Informationen der beiden Parteien. Keine der Parteien wird die von der anderen Partei im Rahmen dieses Vertrags zur Verfügung gestellten vertraulichen Informationen verwenden, es sei denn, dies wird durch diesen Vertrag gestattet.
