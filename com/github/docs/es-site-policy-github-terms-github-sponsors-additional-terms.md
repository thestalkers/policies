...
Stripe procesa y distribuye todos los pagos para Desarrolladores patrocinados, no lo hace GitHub. GitHub no transmite ni transfiere fondos a los Desarrolladores patrocinados. Stripe controla todos los calendarios, métodos y procesos de pago en virtud de los Términos de Stripe. GitHub no tiene ningún control sobre los calendarios o los métodos de distribución de los pagos de Stripe.

### [3.2. Exclusiones de pagos de desarrolladores patrocinados.](#32-sponsored-developer-payment-exclusions) ###
...
### [3.9. Ninguna responsabilidad de GitHub en el procesamiento de pagos.](#39-no-github-liability-for-payment-processing) ###

#### [3.9.1 Responsabilidad exclusiva de Stripe.](#391-stripes-sole-responsibility) ####
...
(e) GitHub no realiza ninguna manifestación ni garantía relativa al rendimiento de los servicios de procesamiento de pagos de Stripe o la seguridad de los fondos mantenidos por Stripe.

#### [3.9.2 Limitación del rol de GitHub.](#392-limitation-of-githubs-role) ####
...
* Proporcionar seguros, bonos u otras formas de protección de los fondos mantenidos por Stripe
...
USTED ACEPTA EXPLÍCITAMENTE QUE LAS SECCIONES O (RENUNCIA DE GARANTÍAS), P (LIMITACIÓN DE RESPONSABILIDAD) Y Q (RENUNCIA E INDEMNIZACIÓN) DEL ACUERDO SE APLICAN A ESTOS TÉRMINOS ADICIONALES.
...
Si cualquiera de las Partes rescinde el acuerdo conforme a la Sección 5.3, la única obligación de Stripe será procesar y remitir al Desarrollador patrocinado el importe del Pago para desarrollador patrocinado acumulado hasta la fecha de rescisión a menos que dichos pagos estén prohibidos por ley.
...
GitHub identificará proyectos basados en las dependencias del Patrocinador para las que haya inversión disponible en [Explorar patrocinadores de GitHub](https://github.com/sponsors/explore). El Patrocinador debe invertir en Proyectos según su discreción exclusiva, lo que incluye la elección de los Proyectos que patrocina y el importe de su patrocinio.
...
GitHub proporcionará al Patrocinador un panel que reflejará el importe total de su patrocinio y su saldo.
...
### [4.1A. Declinación de responsabilidades sobre el procesamiento de pagos.](#41a-payment-processing-disclaimer) ###
...
(g) Cualquier acción, omisión, manifestación o garantía realizada por Stripe.

Todos los asuntos relacionados con el procesamiento de pagos y las transferencias de fondos se rigen exclusivamente según los Términos de Stripe. Los Patrocinadores y los Desarrolladores patrocinados reconocen y aceptan que se basan en Stripe, y no en GitHub, para todos los servicios de procesamiento de pagos.
...
Los términos y condiciones de este Acuerdo son Información Confidencial de ambas partes. Ninguna de las partes utilizará la Información Confidencial proporcionada por la otra parte en virtud del presente Acuerdo, salvo en los casos permitidos en este Acuerdo.
