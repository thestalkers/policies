Política de remoção governamental do GitHub - Documentos do GitHub(function(){
...
3. [Política de remoção governamental do GitHub](/pt/site-policy/other-site-policies/github-government-takedown-policy)
...
Se você for um funcionário do governo e desejar solicitar a remoção de conteúdo sob esta política, poderá enviar sua solicitação usando nosso [Formulário de solicitações de remoção governamental](https://support.github.com/contact/government-takedown).

Para ser considerada completa, uma solicitação deve
