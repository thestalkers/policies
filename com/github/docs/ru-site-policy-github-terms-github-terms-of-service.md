...
* [Е. Частные репозитории](#8-access-reciprocity)
...
* [K. Оплата](#3-feedback)
* [L. Отмена и прекращение](#5-responsibility-for-payment)
* [M. Взаимодействие с GitHub](#4-survival)
* [N. Отказ от предоставления гарантий](#3-no-phone-support)
* [O. Ограничение ответственности](#n-disclaimer-of-warranties)
* [P. Освобождение и компенсация](#o-limitation-of-liability)
* [Вопрос. Изменение этих условий](#p-release-and-indemnification)
* [R. Прочие условия](#q-changes-to-these-terms)
...
### [1. Возможность изменений](#j-beta-previews) ###
...
### [2. Конфиденциальность](#1-subject-to-change) ###
...
### [2. Обновления, понижения и изменения](#1-pricing) ###
...
### [3. График выставления счетов; отсутствие возмещения](#2-upgrades-downgrades-and-changes) ###
...
### [4. Авторизация](#3-billing-schedule-no-refunds) ###
...
### [5. Ответственность за платежи](#4-authorization) ###
...
### [1. Аннулирование учетной записи](#l-cancellation-and-termination) ###
...
### [2. В случае аннулирования](#1-account-cancellation) ###
...
### [3. GitHub может прекратить доступ](#2-upon-cancellation) ###
...
### [4. Сохранение юридической силы](#3-github-may-terminate) ###
...
### [1. Требуется связь в электронной форме](#m-communications-with-github) ###
...
### [2. Официальное уведомление в адрес GitHub оформляется письменно](#1-electronic-communication-required) ###
...
### [3. Отсутствие поддержки по телефону](#2-legal-notice-to-github-must-be-in-writing) ###
...
### [1. Регулирующее законодательство](#r-miscellaneous) ###
...
### [2. Отсутствие переуступки](#1-governing-law) ###
...
### [3. Заголовки разделов и сводки](#2-non-assignability) ###
...
### [4. Ограничение недействительности, отсутствие отказа и сохранение юридической силы](#3-section-headings-and-summaries) ###
...
### [5. Изменения; полнота договора](#4-severability-no-waiver-and-survival) ###
...
### [6. Вопросы](#5-amendments-complete-agreement) ###
