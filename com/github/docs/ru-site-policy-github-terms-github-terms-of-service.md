...
* [Е. Частные репозитории](#9-access-reciprocity)
* [F. Нарушение авторских прав и политика DMCA](#3-access)
* [G. Уведомление об интеллектуальной собственности](#f-copyright-infringement-and-dmca-policy)
* [H. Условия API](#3-license-to-github-policies)
* [I. Дополнительные условия для продуктов GitHub](#h-api-terms)
* [J. Бета-превью](#i-github-additional-product-terms)
* [K. Оплата](#3-development-and-improvement-using-your-input-and-output)
* [L. Отмена и прекращение](#3-feedback)
* [M. Взаимодействие с GitHub](#4-authorization)
* [N. Отказ от предоставления гарантий](#2-upon-cancellation)
* [O. Ограничение ответственности](#3-github-may-terminate)
* [P. Освобождение и компенсация](#4-survival)
* [Вопрос. Изменение этих условий](#n-communications-with-github)
* [R. Прочие условия](#1-electronic-communication-required)
...
### [3. Право собственности на Содержимое, Право на публикацию и Предоставление лицензий](#3-ownership-and-license-grants) ###
...
### [8. Взаимный доступ](#8-public-repositories-and-lawful-access) ###
...
### [1. Контроль частных репозиториев](#e-private-repositories) ###

Некоторые Учетные записи могут иметь частные репозитории, которые позволяют Пользователю контролировать доступ к Контенту.

### [2. Конфиденциальность частных репозиториев](#1-control-of-private-repositories) ###
...
### [3. Доступ](#2-confidentiality-of-private-repositories) ###
...
### [1. Права GitHub на содержимое](#g-intellectual-property-notice) ###
...
### [2. Товарные знаки и логотипы GitHub](#1-githubs-rights-to-content) ###
...
### [3. Лицензия на политики GitHub](#2-github-trademarks-and-logos) ###
...
### [1. Возможность изменений](#j-ai-features-training-and-your-data) ###
...
### [2. Конфиденциальность](#1-applicability) ###
...
### [2. Обновления, понижения и изменения](#5-your-responsibility-and-indemnity) ###
...
### [3. График выставления счетов; отсутствие возмещения](#k-beta-previews) ###
...
### [4. Авторизация](#1-subject-to-change) ###
...
### [5. Ответственность за платежи](#2-confidentiality) ###
...
### [1. Аннулирование учетной записи](#l-payment) ###
...
### [2. В случае аннулирования](#1-pricing) ###
...
### [3. GitHub может прекратить доступ](#2-upgrades-downgrades-and-changes) ###
...
### [4. Сохранение юридической силы](#3-billing-schedule-no-refunds) ###
...
### [1. Требуется связь в электронной форме](#5-responsibility-for-payment) ###
...
### [2. Официальное уведомление в адрес GitHub оформляется письменно](#m-cancellation-and-termination) ###
...
### [3. Отсутствие поддержки по телефону](#1-account-cancellation) ###
...
### [1. Регулирующее законодательство](#2-legal-notice-to-github-must-be-in-writing) ###
...
### [2. Отсутствие переуступки](#3-no-phone-support) ###
...
### [3. Заголовки разделов и сводки](#o-disclaimer-of-warranties) ###
...
### [4. Ограничение недействительности, отсутствие отказа и сохранение юридической силы](#p-limitation-of-liability) ###
...
### [5. Изменения; полнота договора](#q-release-and-indemnification) ###
...
### [6. Вопросы](#r-changes-to-these-terms) ###
