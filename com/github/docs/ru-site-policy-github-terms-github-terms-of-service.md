...
Так как вы сохраняете право собственности и ответственность за Ваш Контент, мы должны предоставить нам и другим пользователям GitHub определенные юридические разрешения, перечисленные в разделах D.4 — D.1. Эти лицензионные разрешения применяются к вашему Контенту. Если вы загружаете Контент, который уже поставляется с лицензией, предоставляющей GitHub разрешения, необходимые нам для работы нашего Сервиса, дополнительная лицензия не требуется. Вы понимаете, что не будете получать никаких платежей за какие-либо права, предоставленные в разделах D.4 — D.1. Лицензии, которые вы нам предоставляете, прекращают свое действие, когда вы удаляете свой Контент с наших серверов, если другие Пользователи не разветвили его.
