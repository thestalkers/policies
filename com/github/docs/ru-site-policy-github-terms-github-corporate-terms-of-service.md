Корпоративные условия обслуживания GitHub - Документация GitHub(function(){
...
Персонал GitHub может получить доступ только к Частным репозиториям Клиента в ситуациях, описанных в нашем [Заявлении о конфиденциальности](/ru/site-policy/privacy-policies/github-general-privacy-statement#private-repositories-github-access).
