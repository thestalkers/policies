Дополнительные условия GitHub Sponsors - Документация GitHub(function(){
...
4. [Дополнительные условия GitHub Sponsors](/ru/site-policy/github-terms/github-sponsors-additional-terms)
...
Все платежи спонсируемым разработчикам обрабатываются и распределяются компанией Stripe, а не GitHub. GitHub не переводит или не передает средства спонсируемым разработчикам. Все сроки оплаты, методы и процессы контролируются Stripe согласно условиям Stripe. GitHub не имеет никакого контроля над сроками или способом распределения платежей, осуществляемого Stripe.
...
* Если вам платят через перевод ACH или банковский перевод, вы получите выплаты в третий четверг месяца. Stripe отправит выплату за каждый месяц, когда ваш баланс достигнет $100 USD. Взносы из GitHub Sponsors Matching Fund не учитываются в этом пороговом значении. Если ваш баланс ниже $100 в конце месяца, баланс будет накапливаться до тех пор, пока ваш баланс не превысит пороговое значение в конце месяца. Если вы покинете программу GitHub Sponsors, Stripe произведет выплату вашего оставшегося баланса, даже если баланс ниже $100.

* Платежи из общих средств. Для спонсируемых разработчиков, участвующих в фонде SOSS или аналогичном механизме общего финансирования, сроки и порядок платежей остаются такими, как описано выше. Когда спонсорство выделяется вам из профиля фонда: выделение средств будет производиться из общих фондов, которые хранятся и контролируются Stripe; после подтверждения выделения спонсорства GitHub средства будут переведены Stripe на ваш счет Stripe Connect незамедлительно, с учетом стандартных сроков расчетов Stripe Connect, определяемых Stripe в соответствии с Условиями Stripe; к таким выплатам применяются те же график платежей, способы оплаты и требования к банковскому счету, что и к необъединенным спонсорствам; и все это определяется Stripe в соответствии с Условиями Stripe. GitHub не контролирует сроки, способ или исполнение платежей от Stripe в пользу спонсируемых разработчиков. Все платежи обрабатываются в соответствии с условиями Stripe.

* После прекращения действия Stripe обработает и перечислит вам через Stripe Connect все полученные и невыплаченные платежи спонсируемого разработчика в течение примерно 90 дней после окончания календарного месяца, в котором мы признаем, что действие настоящих Дополнительных условий было прекращено.

### [3.4. Метод оплаты.](#34-payment-method) ###

Stripe будет переводить платежи спонсируемому разработчику через ACH/SEPA или банковским переводом на указанный вами счет в соответствии с пороговыми значениями, методами и сроками, указанными в действующих на тот момент политиках платежей GitHub, которые GitHub может время от времени обновлять. Способ оплаты и порог могут различаться в зависимости от страны и информации об учетной записи, которую вы предоставляете. Stripe может, по своему собственному усмотрению, комбинировать платеж спонсируемому разработчику с любыми другими платежами спонсируемому разработчику, которые могут вам причитаться в связи с участием в программе.
...
### [3.9. GitHub не несет ответственности за обработку платежей.](#39-no-github-liability-for-payment-processing) ###

#### [3.9.1 Единоличная ответственность Stripe.](#391-stripes-sole-responsibility) ####
...
(e) GitHub не дает никаких заверений или гарантий в отношении производительности услуг обработки платежей Stripe или безопасности средств, хранящихся у Stripe.

#### [3.9.2 Ограничение роли GitHub.](#392-limitation-of-githubs-role) ####
...
* Предоставлять страховку, поручительство или иные формы защиты для средств, находящихся на хранении у Stripe.
...
Если какая-либо из Сторон прекращает действие в соответствии с Разделом 5.3, единственным обязательством Stripe является обработка и перечисление спонсируемому разработчику суммы платежей спонсируемого разработчика, накопленных до даты прекращения, если такие платежи не запрещены законом.
...
### [3.2. Прекращение.](#32-termination) ###

Если отсутствует активный неоплаченный счет, любая из сторон вправе расторгнуть настоящее соглашение, направив предварительное письменное уведомление за тридцать (30) дней.
...
### [4.1A. Отказ от ответственности за обработку платежей.](#41a-payment-processing-disclaimer) ###
...
(g) любых действий, бездействий, заявлений или гарантий, сделанных Stripe.

Все вопросы, связанные с обработкой платежей и переводами средств, регулируются исключительно условиями Stripe. Спонсоры и спонсируемые разработчики признают, что они полагаются на Stripe, а не на GitHub, в отношении всех услуг по обработке платежей.

### [4.2. Ограничение ответственности.](#42-limitation-of-liability) ###

#### [4.2.1. Исключение косвенных убытков.](#421-exclusion-of-indirect-damages) ####
...
Условия настоящего Соглашения являются Конфиденциальной информацией обеих сторон. Ни одна из сторон не будет использовать Конфиденциальную информацию другой стороны, за исключением случаев, разрешенных настоящим Соглашением.
