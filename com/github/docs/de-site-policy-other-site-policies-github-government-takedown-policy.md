GitHub Government Takedown-Richtlinie - GitHub Dokumente(function(){
...
Wenn Sie Staatsbedienstete(r) sind und die Entfernung von Inhalten gemäß dieser Richtlinie anfordern möchten, können Sie Ihre Anfrage über unser [Formular für Regierungsanfragen zur Entfernung von Inhalten](https://support.github.com/contact/government-takedown) übermitteln.

Um als vollständig zu gelten, muss eine Anfrage folgende Voraussetzungen erfüllen:
