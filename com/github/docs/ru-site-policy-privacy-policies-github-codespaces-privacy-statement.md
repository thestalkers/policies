Общие заявления о конфиденциальности GitHub - GitHub Docs(function(){
...
3. [Общие заявления о конфиденциальности GitHub](/ru/site-policy/privacy-policies/github-general-privacy-statement)
...
* Пользовательский контент и файлы: при использовании наших служб мы собираем персональные данные, входящие в состав предоставляемых вами сведений, таких как код, входные данные, выходные данные ИИ, текст, документы, изображения или отзывы.
...
* Общедоступные источники: мы можем получить сведения о вас из общедоступных источников.
...
* Разработка и улучшение продуктов: мы используем персональные данные для разработки и улучшения наших продуктов, служб и технологий, включая искусственный интеллект и технологии машинного обучения. Это включает улучшение функций, разработку новых предложений, расширение возможностей безопасности и обучение моделей. Мы применяем соответствующие технические меры безопасности, включая методы агрегирования и деидентификации, где это возможно, для защиты вашей конфиденциальности и одновременного использования этих улучшений.
...
* Аффилированные лица: персональные данные могут передаваться аффилированным лицам GitHub, включая Майкрософт, для облегчения обслуживания клиентов, маркетинга и рекламы, выполнения заказов, выставления счетов, технической поддержки, выполнения юридических и нормативных обязательств, разработки и улучшения продуктов (включая обучение и совершенствование технологий искусственного интеллекта и машинного обучения), а также для других целей, описанных в их соответствующих заявлениях о конфиденциальности. Когда мы передаем данные аффилированным лицам, они обрабатывают их в соответствии с применимы правом и своими обязательствами по обеспечению конфиденциальности.
...
Если в вашей учетной записи GitHub есть частные репозитории, наши возможности и права на доступ к информации о частных репозиториях изложены в разделе E (Частные репозитории) Условий предоставления услуг GitHub.
...
* Законные интересы: мы обрабатываем данные для целей, которые соответствуют нашим законным интересам, например, для обеспечения безопасности наших сервисов, общения с вами, а также разработки и улучшения наших сервисов, которые включают технологии искусственного интеллекта и машинного обучения. Это делается только в том случае, если эти интересы не переопределяются вашими правами на защиту данных или вашими основными правами и свободами.
...
GitHub, Inc. 88 Colin P. Kelly Jr. St. San Francisco, CA 94107 США (США)
...
1. **Отдельно на Корпоративных маркетинговых страницах GitHub**
   ...
   На любой странице GitHub, которая использует необязательные файлы cookie, будет ссылка в нижнем колонтитуле страницы с параметрами файлов cookie. Вы можете в любое время выбрать свои предпочтения, щелкнув эту ссылку и обновив настройки.
